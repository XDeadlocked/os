...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	609040ef          	jal	ra,ffffffffc0204e56 <memset>
...
ffffffffc020005a:	e5a58593          	addi	a1,a1,-422 # ffffffffc0204eb0 <etext>
ffffffffc020005e:	00005517          	auipc	a0,0x5
ffffffffc0200062:	e7250513          	addi	a0,a0,-398 # ffffffffc0204ed0 <etext+0x20>
...
ffffffffc020007a:	1a9030ef          	jal	ra,ffffffffc0203a22 <vmm_init>
    proc_init();                // init process table
ffffffffc020007e:	5e4040ef          	jal	ra,ffffffffc0204662 <proc_init>
...
ffffffffc0200092:	7c4040ef          	jal	ra,ffffffffc0204856 <cpu_idle>
...
ffffffffc02000b2:	e2a50513          	addi	a0,a0,-470 # ffffffffc0204ed8 <etext+0x28>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	0ab040ef          	jal	ra,ffffffffc0204a2c <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	077040ef          	jal	ra,ffffffffc0204a2c <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001dc:	d3850513          	addi	a0,a0,-712 # ffffffffc0204f10 <etext+0x60>
void print_kerninfo(void) {
...
ffffffffc02001f2:	d4250513          	addi	a0,a0,-702 # ffffffffc0204f30 <etext+0x80>
ffffffffc02001f6:	f99ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001fa:	00005597          	auipc	a1,0x5
ffffffffc02001fe:	cb658593          	addi	a1,a1,-842 # ffffffffc0204eb0 <etext>
ffffffffc0200202:	00005517          	auipc	a0,0x5
ffffffffc0200206:	d4e50513          	addi	a0,a0,-690 # ffffffffc0204f50 <etext+0xa0>
...
ffffffffc020021a:	d5a50513          	addi	a0,a0,-678 # ffffffffc0204f70 <etext+0xc0>
...
ffffffffc020022e:	d6650513          	addi	a0,a0,-666 # ffffffffc0204f90 <etext+0xe0>
...
ffffffffc020025c:	d5850513          	addi	a0,a0,-680 # ffffffffc0204fb0 <etext+0x100>
}
...
ffffffffc020026c:	c7860613          	addi	a2,a2,-904 # ffffffffc0204ee0 <etext+0x30>
ffffffffc0200270:	04d00593          	li	a1,77
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	c8450513          	addi	a0,a0,-892 # ffffffffc0204ef8 <etext+0x48>
void print_stackframe(void) {
...
ffffffffc0200288:	e3c60613          	addi	a2,a2,-452 # ffffffffc02050c0 <commands+0xe0>
ffffffffc020028c:	00005597          	auipc	a1,0x5
ffffffffc0200290:	e5458593          	addi	a1,a1,-428 # ffffffffc02050e0 <commands+0x100>
ffffffffc0200294:	00005517          	auipc	a0,0x5
ffffffffc0200298:	e5450513          	addi	a0,a0,-428 # ffffffffc02050e8 <commands+0x108>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002a6:	e5660613          	addi	a2,a2,-426 # ffffffffc02050f8 <commands+0x118>
ffffffffc02002aa:	00005597          	auipc	a1,0x5
ffffffffc02002ae:	e7658593          	addi	a1,a1,-394 # ffffffffc0205120 <commands+0x140>
ffffffffc02002b2:	00005517          	auipc	a0,0x5
ffffffffc02002b6:	e3650513          	addi	a0,a0,-458 # ffffffffc02050e8 <commands+0x108>
ffffffffc02002ba:	ed5ff0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02002be:	00005617          	auipc	a2,0x5
ffffffffc02002c2:	e7260613          	addi	a2,a2,-398 # ffffffffc0205130 <commands+0x150>
ffffffffc02002c6:	00005597          	auipc	a1,0x5
ffffffffc02002ca:	e8a58593          	addi	a1,a1,-374 # ffffffffc0205150 <commands+0x170>
ffffffffc02002ce:	00005517          	auipc	a0,0x5
ffffffffc02002d2:	e1a50513          	addi	a0,a0,-486 # ffffffffc02050e8 <commands+0x108>
...
ffffffffc020030c:	d2050513          	addi	a0,a0,-736 # ffffffffc0205028 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020032e:	d2650513          	addi	a0,a0,-730 # ffffffffc0205050 <commands+0x70>
...
ffffffffc0200350:	c94c8c93          	addi	s9,s9,-876 # ffffffffc0204fe0 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200354:	00005997          	auipc	s3,0x5
ffffffffc0200358:	d2498993          	addi	s3,s3,-732 # ffffffffc0205078 <commands+0x98>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020035c:	00005917          	auipc	s2,0x5
ffffffffc0200360:	d2490913          	addi	s2,s2,-732 # ffffffffc0205080 <commands+0xa0>
        if (argc == MAXARGS - 1) {
ffffffffc0200364:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200366:	00005b17          	auipc	s6,0x5
ffffffffc020036a:	d22b0b13          	addi	s6,s6,-734 # ffffffffc0205088 <commands+0xa8>
    if (argc == 0) {
ffffffffc020036e:	00005a97          	auipc	s5,0x5
ffffffffc0200372:	d72a8a93          	addi	s5,s5,-654 # ffffffffc02050e0 <commands+0x100>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	2ad040ef          	jal	ra,ffffffffc0204e38 <strchr>
...
ffffffffc02003a6:	c3ed0d13          	addi	s10,s10,-962 # ffffffffc0204fe0 <commands>
    if (argc == 0) {
...
ffffffffc02003b0:	25f040ef          	jal	ra,ffffffffc0204e0e <strcmp>
...
ffffffffc02003c4:	24b040ef          	jal	ra,ffffffffc0204e0e <strcmp>
...
ffffffffc020042a:	20f040ef          	jal	ra,ffffffffc0204e38 <strchr>
...
ffffffffc0200446:	c6650513          	addi	a0,a0,-922 # ffffffffc02050a8 <commands+0xc8>
...
ffffffffc0200486:	cde50513          	addi	a0,a0,-802 # ffffffffc0205160 <commands+0x180>
    va_start(ap, fmt);
...
ffffffffc020049c:	c5050513          	addi	a0,a0,-944 # ffffffffc02060e8 <default_pmm_manager+0x500>
...
ffffffffc02004da:	caa50513          	addi	a0,a0,-854 # ffffffffc0205180 <commands+0x1a0>
    ticks = 0;
...
ffffffffc020059e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02005a0:	0c9040ef          	jal	ra,ffffffffc0204e68 <memcpy>
    return 0;
}
...
ffffffffc02005c4:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005c6:	0a3040ef          	jal	ra,ffffffffc0204e68 <memcpy>
    return 0;
}
...
ffffffffc0200614:	e6850513          	addi	a0,a0,-408 # ffffffffc0205478 <commands+0x498>
...
ffffffffc0200634:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200636:	1330306f          	j	ffffffffc0203f68 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020063a:	00005617          	auipc	a2,0x5
ffffffffc020063e:	e5e60613          	addi	a2,a2,-418 # ffffffffc0205498 <commands+0x4b8>
ffffffffc0200642:	06200593          	li	a1,98
ffffffffc0200646:	00005517          	auipc	a0,0x5
ffffffffc020064a:	e6a50513          	addi	a0,a0,-406 # ffffffffc02054b0 <commands+0x4d0>
...
ffffffffc0200678:	e5450513          	addi	a0,a0,-428 # ffffffffc02054c8 <commands+0x4e8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200688:	e5c50513          	addi	a0,a0,-420 # ffffffffc02054e0 <commands+0x500>
...
ffffffffc0200696:	e6650513          	addi	a0,a0,-410 # ffffffffc02054f8 <commands+0x518>
...
ffffffffc02006a4:	e7050513          	addi	a0,a0,-400 # ffffffffc0205510 <commands+0x530>
...
ffffffffc02006b2:	e7a50513          	addi	a0,a0,-390 # ffffffffc0205528 <commands+0x548>
...
ffffffffc02006c0:	e8450513          	addi	a0,a0,-380 # ffffffffc0205540 <commands+0x560>
...
ffffffffc02006ce:	e8e50513          	addi	a0,a0,-370 # ffffffffc0205558 <commands+0x578>
...
ffffffffc02006dc:	e9850513          	addi	a0,a0,-360 # ffffffffc0205570 <commands+0x590>
...
ffffffffc02006ea:	ea250513          	addi	a0,a0,-350 # ffffffffc0205588 <commands+0x5a8>
...
ffffffffc02006f8:	eac50513          	addi	a0,a0,-340 # ffffffffc02055a0 <commands+0x5c0>
...
ffffffffc0200706:	eb650513          	addi	a0,a0,-330 # ffffffffc02055b8 <commands+0x5d8>
...
ffffffffc0200714:	ec050513          	addi	a0,a0,-320 # ffffffffc02055d0 <commands+0x5f0>
...
ffffffffc0200722:	eca50513          	addi	a0,a0,-310 # ffffffffc02055e8 <commands+0x608>
...
ffffffffc0200730:	ed450513          	addi	a0,a0,-300 # ffffffffc0205600 <commands+0x620>
...
ffffffffc020073e:	ede50513          	addi	a0,a0,-290 # ffffffffc0205618 <commands+0x638>
...
ffffffffc020074c:	ee850513          	addi	a0,a0,-280 # ffffffffc0205630 <commands+0x650>
...
ffffffffc020075a:	ef250513          	addi	a0,a0,-270 # ffffffffc0205648 <commands+0x668>
...
ffffffffc0200768:	efc50513          	addi	a0,a0,-260 # ffffffffc0205660 <commands+0x680>
...
ffffffffc0200776:	f0650513          	addi	a0,a0,-250 # ffffffffc0205678 <commands+0x698>
...
ffffffffc0200784:	f1050513          	addi	a0,a0,-240 # ffffffffc0205690 <commands+0x6b0>
...
ffffffffc0200792:	f1a50513          	addi	a0,a0,-230 # ffffffffc02056a8 <commands+0x6c8>
...
ffffffffc02007a0:	f2450513          	addi	a0,a0,-220 # ffffffffc02056c0 <commands+0x6e0>
...
ffffffffc02007ae:	f2e50513          	addi	a0,a0,-210 # ffffffffc02056d8 <commands+0x6f8>
...
ffffffffc02007bc:	f3850513          	addi	a0,a0,-200 # ffffffffc02056f0 <commands+0x710>
...
ffffffffc02007ca:	f4250513          	addi	a0,a0,-190 # ffffffffc0205708 <commands+0x728>
...
ffffffffc02007d8:	f4c50513          	addi	a0,a0,-180 # ffffffffc0205720 <commands+0x740>
...
ffffffffc02007e6:	f5650513          	addi	a0,a0,-170 # ffffffffc0205738 <commands+0x758>
...
ffffffffc02007f4:	f6050513          	addi	a0,a0,-160 # ffffffffc0205750 <commands+0x770>
...
ffffffffc0200802:	f6a50513          	addi	a0,a0,-150 # ffffffffc0205768 <commands+0x788>
...
ffffffffc0200810:	f7450513          	addi	a0,a0,-140 # ffffffffc0205780 <commands+0x7a0>
...
ffffffffc020081e:	f7e50513          	addi	a0,a0,-130 # ffffffffc0205798 <commands+0x7b8>
...
ffffffffc0200830:	f8450513          	addi	a0,a0,-124 # ffffffffc02057b0 <commands+0x7d0>
}
...
ffffffffc0200846:	f8650513          	addi	a0,a0,-122 # ffffffffc02057c8 <commands+0x7e8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc020085e:	f8650513          	addi	a0,a0,-122 # ffffffffc02057e0 <commands+0x800>
...
ffffffffc020086e:	f8e50513          	addi	a0,a0,-114 # ffffffffc02057f8 <commands+0x818>
...
ffffffffc020087e:	f9650513          	addi	a0,a0,-106 # ffffffffc0205810 <commands+0x830>
...
ffffffffc0200892:	f9a50513          	addi	a0,a0,-102 # ffffffffc0205828 <commands+0x848>
}
...
ffffffffc02008b0:	8f070713          	addi	a4,a4,-1808 # ffffffffc020519c <commands+0x1bc>
...
ffffffffc02008c2:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0205428 <commands+0x448>
ffffffffc02008c6:	8c9ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ca:	00005517          	auipc	a0,0x5
ffffffffc02008ce:	b3e50513          	addi	a0,a0,-1218 # ffffffffc0205408 <commands+0x428>
ffffffffc02008d2:	8bdff06f          	j	ffffffffc020018e <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008d6:	00005517          	auipc	a0,0x5
ffffffffc02008da:	af250513          	addi	a0,a0,-1294 # ffffffffc02053c8 <commands+0x3e8>
ffffffffc02008de:	8b1ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008e2:	00005517          	auipc	a0,0x5
ffffffffc02008e6:	b0650513          	addi	a0,a0,-1274 # ffffffffc02053e8 <commands+0x408>
...
ffffffffc02008f2:	b6a50513          	addi	a0,a0,-1174 # ffffffffc0205458 <commands+0x478>
...
ffffffffc0200934:	b1850513          	addi	a0,a0,-1256 # ffffffffc0205448 <commands+0x468>
}
...
ffffffffc020094c:	88470713          	addi	a4,a4,-1916 # ffffffffc02051cc <commands+0x1ec>
...
ffffffffc0200968:	a4c50513          	addi	a0,a0,-1460 # ffffffffc02053b0 <commands+0x3d0>
...
ffffffffc020098a:	88a50513          	addi	a0,a0,-1910 # ffffffffc0205210 <commands+0x230>
}
...
ffffffffc02009e4:	8d060613          	addi	a2,a2,-1840 # ffffffffc02052b0 <commands+0x2d0>
ffffffffc02009e8:	0b300593          	li	a1,179
ffffffffc02009ec:	00005517          	auipc	a0,0x5
ffffffffc02009f0:	ac450513          	addi	a0,a0,-1340 # ffffffffc02054b0 <commands+0x4d0>
ffffffffc02009f4:	a5dff0ef          	jal	ra,ffffffffc0200450 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009f8:	00005517          	auipc	a0,0x5
ffffffffc02009fc:	8d850513          	addi	a0,a0,-1832 # ffffffffc02052d0 <commands+0x2f0>
ffffffffc0200a00:	b779                	j	ffffffffc020098e <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200a02:	00005517          	auipc	a0,0x5
ffffffffc0200a06:	8e650513          	addi	a0,a0,-1818 # ffffffffc02052e8 <commands+0x308>
...
ffffffffc0200a8e:	82660613          	addi	a2,a2,-2010 # ffffffffc02052b0 <commands+0x2d0>
ffffffffc0200a92:	0d300593          	li	a1,211
ffffffffc0200a96:	00005517          	auipc	a0,0x5
ffffffffc0200a9a:	a1a50513          	addi	a0,a0,-1510 # ffffffffc02054b0 <commands+0x4d0>
...
ffffffffc0200abe:	7f660613          	addi	a2,a2,2038 # ffffffffc02052b0 <commands+0x2d0>
ffffffffc0200ac2:	0da00593          	li	a1,218
ffffffffc0200ac6:	00005517          	auipc	a0,0x5
ffffffffc0200aca:	9ea50513          	addi	a0,a0,-1558 # ffffffffc02054b0 <commands+0x4d0>
...
ffffffffc0200ef0:	95468693          	addi	a3,a3,-1708 # ffffffffc0205840 <commands+0x860>
ffffffffc0200ef4:	00005617          	auipc	a2,0x5
ffffffffc0200ef8:	95c60613          	addi	a2,a2,-1700 # ffffffffc0205850 <commands+0x870>
ffffffffc0200efc:	0f000593          	li	a1,240
ffffffffc0200f00:	00005517          	auipc	a0,0x5
ffffffffc0200f04:	96850513          	addi	a0,a0,-1688 # ffffffffc0205868 <commands+0x888>
ffffffffc0200f08:	d48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200f0c:	00005697          	auipc	a3,0x5
ffffffffc0200f10:	9f468693          	addi	a3,a3,-1548 # ffffffffc0205900 <commands+0x920>
ffffffffc0200f14:	00005617          	auipc	a2,0x5
ffffffffc0200f18:	93c60613          	addi	a2,a2,-1732 # ffffffffc0205850 <commands+0x870>
ffffffffc0200f1c:	0bd00593          	li	a1,189
ffffffffc0200f20:	00005517          	auipc	a0,0x5
ffffffffc0200f24:	94850513          	addi	a0,a0,-1720 # ffffffffc0205868 <commands+0x888>
ffffffffc0200f28:	d28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200f2c:	00005697          	auipc	a3,0x5
ffffffffc0200f30:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0205928 <commands+0x948>
ffffffffc0200f34:	00005617          	auipc	a2,0x5
ffffffffc0200f38:	91c60613          	addi	a2,a2,-1764 # ffffffffc0205850 <commands+0x870>
ffffffffc0200f3c:	0be00593          	li	a1,190
ffffffffc0200f40:	00005517          	auipc	a0,0x5
ffffffffc0200f44:	92850513          	addi	a0,a0,-1752 # ffffffffc0205868 <commands+0x888>
ffffffffc0200f48:	d08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200f4c:	00005697          	auipc	a3,0x5
ffffffffc0200f50:	a1c68693          	addi	a3,a3,-1508 # ffffffffc0205968 <commands+0x988>
ffffffffc0200f54:	00005617          	auipc	a2,0x5
ffffffffc0200f58:	8fc60613          	addi	a2,a2,-1796 # ffffffffc0205850 <commands+0x870>
ffffffffc0200f5c:	0c000593          	li	a1,192
ffffffffc0200f60:	00005517          	auipc	a0,0x5
ffffffffc0200f64:	90850513          	addi	a0,a0,-1784 # ffffffffc0205868 <commands+0x888>
ffffffffc0200f68:	ce8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200f6c:	00005697          	auipc	a3,0x5
ffffffffc0200f70:	a8468693          	addi	a3,a3,-1404 # ffffffffc02059f0 <commands+0xa10>
ffffffffc0200f74:	00005617          	auipc	a2,0x5
ffffffffc0200f78:	8dc60613          	addi	a2,a2,-1828 # ffffffffc0205850 <commands+0x870>
ffffffffc0200f7c:	0d900593          	li	a1,217
ffffffffc0200f80:	00005517          	auipc	a0,0x5
ffffffffc0200f84:	8e850513          	addi	a0,a0,-1816 # ffffffffc0205868 <commands+0x888>
ffffffffc0200f88:	cc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f8c:	00005697          	auipc	a3,0x5
ffffffffc0200f90:	91468693          	addi	a3,a3,-1772 # ffffffffc02058a0 <commands+0x8c0>
ffffffffc0200f94:	00005617          	auipc	a2,0x5
ffffffffc0200f98:	8bc60613          	addi	a2,a2,-1860 # ffffffffc0205850 <commands+0x870>
ffffffffc0200f9c:	0d200593          	li	a1,210
ffffffffc0200fa0:	00005517          	auipc	a0,0x5
ffffffffc0200fa4:	8c850513          	addi	a0,a0,-1848 # ffffffffc0205868 <commands+0x888>
ffffffffc0200fa8:	ca8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 3);
ffffffffc0200fac:	00005697          	auipc	a3,0x5
ffffffffc0200fb0:	a3468693          	addi	a3,a3,-1484 # ffffffffc02059e0 <commands+0xa00>
ffffffffc0200fb4:	00005617          	auipc	a2,0x5
ffffffffc0200fb8:	89c60613          	addi	a2,a2,-1892 # ffffffffc0205850 <commands+0x870>
ffffffffc0200fbc:	0d000593          	li	a1,208
ffffffffc0200fc0:	00005517          	auipc	a0,0x5
ffffffffc0200fc4:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205868 <commands+0x888>
ffffffffc0200fc8:	c88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fcc:	00005697          	auipc	a3,0x5
ffffffffc0200fd0:	9fc68693          	addi	a3,a3,-1540 # ffffffffc02059c8 <commands+0x9e8>
ffffffffc0200fd4:	00005617          	auipc	a2,0x5
ffffffffc0200fd8:	87c60613          	addi	a2,a2,-1924 # ffffffffc0205850 <commands+0x870>
ffffffffc0200fdc:	0cb00593          	li	a1,203
ffffffffc0200fe0:	00005517          	auipc	a0,0x5
ffffffffc0200fe4:	88850513          	addi	a0,a0,-1912 # ffffffffc0205868 <commands+0x888>
ffffffffc0200fe8:	c68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200fec:	00005697          	auipc	a3,0x5
ffffffffc0200ff0:	9bc68693          	addi	a3,a3,-1604 # ffffffffc02059a8 <commands+0x9c8>
ffffffffc0200ff4:	00005617          	auipc	a2,0x5
ffffffffc0200ff8:	85c60613          	addi	a2,a2,-1956 # ffffffffc0205850 <commands+0x870>
ffffffffc0200ffc:	0c200593          	li	a1,194
ffffffffc0201000:	00005517          	auipc	a0,0x5
ffffffffc0201004:	86850513          	addi	a0,a0,-1944 # ffffffffc0205868 <commands+0x888>
ffffffffc0201008:	c48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 != NULL);
ffffffffc020100c:	00005697          	auipc	a3,0x5
ffffffffc0201010:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0205a38 <commands+0xa58>
ffffffffc0201014:	00005617          	auipc	a2,0x5
ffffffffc0201018:	83c60613          	addi	a2,a2,-1988 # ffffffffc0205850 <commands+0x870>
ffffffffc020101c:	0f800593          	li	a1,248
ffffffffc0201020:	00005517          	auipc	a0,0x5
ffffffffc0201024:	84850513          	addi	a0,a0,-1976 # ffffffffc0205868 <commands+0x888>
ffffffffc0201028:	c28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020102c:	00005697          	auipc	a3,0x5
ffffffffc0201030:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0205a28 <commands+0xa48>
ffffffffc0201034:	00005617          	auipc	a2,0x5
ffffffffc0201038:	81c60613          	addi	a2,a2,-2020 # ffffffffc0205850 <commands+0x870>
ffffffffc020103c:	0df00593          	li	a1,223
ffffffffc0201040:	00005517          	auipc	a0,0x5
ffffffffc0201044:	82850513          	addi	a0,a0,-2008 # ffffffffc0205868 <commands+0x888>
ffffffffc0201048:	c08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020104c:	00005697          	auipc	a3,0x5
ffffffffc0201050:	97c68693          	addi	a3,a3,-1668 # ffffffffc02059c8 <commands+0x9e8>
ffffffffc0201054:	00004617          	auipc	a2,0x4
ffffffffc0201058:	7fc60613          	addi	a2,a2,2044 # ffffffffc0205850 <commands+0x870>
ffffffffc020105c:	0dd00593          	li	a1,221
ffffffffc0201060:	00005517          	auipc	a0,0x5
ffffffffc0201064:	80850513          	addi	a0,a0,-2040 # ffffffffc0205868 <commands+0x888>
ffffffffc0201068:	be8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc020106c:	00005697          	auipc	a3,0x5
ffffffffc0201070:	99c68693          	addi	a3,a3,-1636 # ffffffffc0205a08 <commands+0xa28>
ffffffffc0201074:	00004617          	auipc	a2,0x4
ffffffffc0201078:	7dc60613          	addi	a2,a2,2012 # ffffffffc0205850 <commands+0x870>
ffffffffc020107c:	0dc00593          	li	a1,220
ffffffffc0201080:	00004517          	auipc	a0,0x4
ffffffffc0201084:	7e850513          	addi	a0,a0,2024 # ffffffffc0205868 <commands+0x888>
ffffffffc0201088:	bc8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc020108c:	00005697          	auipc	a3,0x5
ffffffffc0201090:	81468693          	addi	a3,a3,-2028 # ffffffffc02058a0 <commands+0x8c0>
ffffffffc0201094:	00004617          	auipc	a2,0x4
ffffffffc0201098:	7bc60613          	addi	a2,a2,1980 # ffffffffc0205850 <commands+0x870>
ffffffffc020109c:	0b900593          	li	a1,185
ffffffffc02010a0:	00004517          	auipc	a0,0x4
ffffffffc02010a4:	7c850513          	addi	a0,a0,1992 # ffffffffc0205868 <commands+0x888>
ffffffffc02010a8:	ba8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010ac:	00005697          	auipc	a3,0x5
ffffffffc02010b0:	91c68693          	addi	a3,a3,-1764 # ffffffffc02059c8 <commands+0x9e8>
ffffffffc02010b4:	00004617          	auipc	a2,0x4
ffffffffc02010b8:	79c60613          	addi	a2,a2,1948 # ffffffffc0205850 <commands+0x870>
ffffffffc02010bc:	0d600593          	li	a1,214
ffffffffc02010c0:	00004517          	auipc	a0,0x4
ffffffffc02010c4:	7a850513          	addi	a0,a0,1960 # ffffffffc0205868 <commands+0x888>
ffffffffc02010c8:	b88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02010cc:	00005697          	auipc	a3,0x5
ffffffffc02010d0:	81468693          	addi	a3,a3,-2028 # ffffffffc02058e0 <commands+0x900>
ffffffffc02010d4:	00004617          	auipc	a2,0x4
ffffffffc02010d8:	77c60613          	addi	a2,a2,1916 # ffffffffc0205850 <commands+0x870>
ffffffffc02010dc:	0d400593          	li	a1,212
ffffffffc02010e0:	00004517          	auipc	a0,0x4
ffffffffc02010e4:	78850513          	addi	a0,a0,1928 # ffffffffc0205868 <commands+0x888>
ffffffffc02010e8:	b68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02010ec:	00004697          	auipc	a3,0x4
ffffffffc02010f0:	7d468693          	addi	a3,a3,2004 # ffffffffc02058c0 <commands+0x8e0>
ffffffffc02010f4:	00004617          	auipc	a2,0x4
ffffffffc02010f8:	75c60613          	addi	a2,a2,1884 # ffffffffc0205850 <commands+0x870>
ffffffffc02010fc:	0d300593          	li	a1,211
ffffffffc0201100:	00004517          	auipc	a0,0x4
ffffffffc0201104:	76850513          	addi	a0,a0,1896 # ffffffffc0205868 <commands+0x888>
ffffffffc0201108:	b48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc020110c:	00004697          	auipc	a3,0x4
ffffffffc0201110:	7d468693          	addi	a3,a3,2004 # ffffffffc02058e0 <commands+0x900>
ffffffffc0201114:	00004617          	auipc	a2,0x4
ffffffffc0201118:	73c60613          	addi	a2,a2,1852 # ffffffffc0205850 <commands+0x870>
ffffffffc020111c:	0bb00593          	li	a1,187
ffffffffc0201120:	00004517          	auipc	a0,0x4
ffffffffc0201124:	74850513          	addi	a0,a0,1864 # ffffffffc0205868 <commands+0x888>
ffffffffc0201128:	b28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(count == 0);
ffffffffc020112c:	00005697          	auipc	a3,0x5
ffffffffc0201130:	a5c68693          	addi	a3,a3,-1444 # ffffffffc0205b88 <commands+0xba8>
ffffffffc0201134:	00004617          	auipc	a2,0x4
ffffffffc0201138:	71c60613          	addi	a2,a2,1820 # ffffffffc0205850 <commands+0x870>
ffffffffc020113c:	12500593          	li	a1,293
ffffffffc0201140:	00004517          	auipc	a0,0x4
ffffffffc0201144:	72850513          	addi	a0,a0,1832 # ffffffffc0205868 <commands+0x888>
ffffffffc0201148:	b08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free == 0);
ffffffffc020114c:	00005697          	auipc	a3,0x5
ffffffffc0201150:	8dc68693          	addi	a3,a3,-1828 # ffffffffc0205a28 <commands+0xa48>
ffffffffc0201154:	00004617          	auipc	a2,0x4
ffffffffc0201158:	6fc60613          	addi	a2,a2,1788 # ffffffffc0205850 <commands+0x870>
ffffffffc020115c:	11a00593          	li	a1,282
ffffffffc0201160:	00004517          	auipc	a0,0x4
ffffffffc0201164:	70850513          	addi	a0,a0,1800 # ffffffffc0205868 <commands+0x888>
...
ffffffffc0201178:	6dc60613          	addi	a2,a2,1756 # ffffffffc0205850 <commands+0x870>
ffffffffc020117c:	11800593          	li	a1,280
ffffffffc0201180:	00004517          	auipc	a0,0x4
ffffffffc0201184:	6e850513          	addi	a0,a0,1768 # ffffffffc0205868 <commands+0x888>
ffffffffc0201188:	ac8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc020118c:	00004697          	auipc	a3,0x4
ffffffffc0201190:	7fc68693          	addi	a3,a3,2044 # ffffffffc0205988 <commands+0x9a8>
ffffffffc0201194:	00004617          	auipc	a2,0x4
ffffffffc0201198:	6bc60613          	addi	a2,a2,1724 # ffffffffc0205850 <commands+0x870>
ffffffffc020119c:	0c100593          	li	a1,193
ffffffffc02011a0:	00004517          	auipc	a0,0x4
ffffffffc02011a4:	6c850513          	addi	a0,a0,1736 # ffffffffc0205868 <commands+0x888>
ffffffffc02011a8:	aa8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02011ac:	00005697          	auipc	a3,0x5
ffffffffc02011b0:	99c68693          	addi	a3,a3,-1636 # ffffffffc0205b48 <commands+0xb68>
ffffffffc02011b4:	00004617          	auipc	a2,0x4
ffffffffc02011b8:	69c60613          	addi	a2,a2,1692 # ffffffffc0205850 <commands+0x870>
ffffffffc02011bc:	11200593          	li	a1,274
ffffffffc02011c0:	00004517          	auipc	a0,0x4
ffffffffc02011c4:	6a850513          	addi	a0,a0,1704 # ffffffffc0205868 <commands+0x888>
ffffffffc02011c8:	a88ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02011cc:	00005697          	auipc	a3,0x5
ffffffffc02011d0:	95c68693          	addi	a3,a3,-1700 # ffffffffc0205b28 <commands+0xb48>
ffffffffc02011d4:	00004617          	auipc	a2,0x4
ffffffffc02011d8:	67c60613          	addi	a2,a2,1660 # ffffffffc0205850 <commands+0x870>
ffffffffc02011dc:	11000593          	li	a1,272
ffffffffc02011e0:	00004517          	auipc	a0,0x4
ffffffffc02011e4:	68850513          	addi	a0,a0,1672 # ffffffffc0205868 <commands+0x888>
ffffffffc02011e8:	a68ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02011ec:	00005697          	auipc	a3,0x5
ffffffffc02011f0:	91468693          	addi	a3,a3,-1772 # ffffffffc0205b00 <commands+0xb20>
ffffffffc02011f4:	00004617          	auipc	a2,0x4
ffffffffc02011f8:	65c60613          	addi	a2,a2,1628 # ffffffffc0205850 <commands+0x870>
ffffffffc02011fc:	10e00593          	li	a1,270
ffffffffc0201200:	00004517          	auipc	a0,0x4
ffffffffc0201204:	66850513          	addi	a0,a0,1640 # ffffffffc0205868 <commands+0x888>
ffffffffc0201208:	a48ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc020120c:	00005697          	auipc	a3,0x5
ffffffffc0201210:	8cc68693          	addi	a3,a3,-1844 # ffffffffc0205ad8 <commands+0xaf8>
ffffffffc0201214:	00004617          	auipc	a2,0x4
ffffffffc0201218:	63c60613          	addi	a2,a2,1596 # ffffffffc0205850 <commands+0x870>
ffffffffc020121c:	10d00593          	li	a1,269
ffffffffc0201220:	00004517          	auipc	a0,0x4
ffffffffc0201224:	64850513          	addi	a0,a0,1608 # ffffffffc0205868 <commands+0x888>
ffffffffc0201228:	a28ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(p0 + 2 == p1);
ffffffffc020122c:	00005697          	auipc	a3,0x5
ffffffffc0201230:	89c68693          	addi	a3,a3,-1892 # ffffffffc0205ac8 <commands+0xae8>
ffffffffc0201234:	00004617          	auipc	a2,0x4
ffffffffc0201238:	61c60613          	addi	a2,a2,1564 # ffffffffc0205850 <commands+0x870>
ffffffffc020123c:	10800593          	li	a1,264
ffffffffc0201240:	00004517          	auipc	a0,0x4
ffffffffc0201244:	62850513          	addi	a0,a0,1576 # ffffffffc0205868 <commands+0x888>
ffffffffc0201248:	a08ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc020124c:	00004697          	auipc	a3,0x4
ffffffffc0201250:	77c68693          	addi	a3,a3,1916 # ffffffffc02059c8 <commands+0x9e8>
ffffffffc0201254:	00004617          	auipc	a2,0x4
ffffffffc0201258:	5fc60613          	addi	a2,a2,1532 # ffffffffc0205850 <commands+0x870>
ffffffffc020125c:	10700593          	li	a1,263
ffffffffc0201260:	00004517          	auipc	a0,0x4
ffffffffc0201264:	60850513          	addi	a0,a0,1544 # ffffffffc0205868 <commands+0x888>
ffffffffc0201268:	9e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc020126c:	00005697          	auipc	a3,0x5
ffffffffc0201270:	83c68693          	addi	a3,a3,-1988 # ffffffffc0205aa8 <commands+0xac8>
ffffffffc0201274:	00004617          	auipc	a2,0x4
ffffffffc0201278:	5dc60613          	addi	a2,a2,1500 # ffffffffc0205850 <commands+0x870>
ffffffffc020127c:	10600593          	li	a1,262
ffffffffc0201280:	00004517          	auipc	a0,0x4
ffffffffc0201284:	5e850513          	addi	a0,a0,1512 # ffffffffc0205868 <commands+0x888>
ffffffffc0201288:	9c8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc020128c:	00004697          	auipc	a3,0x4
ffffffffc0201290:	7ec68693          	addi	a3,a3,2028 # ffffffffc0205a78 <commands+0xa98>
ffffffffc0201294:	00004617          	auipc	a2,0x4
ffffffffc0201298:	5bc60613          	addi	a2,a2,1468 # ffffffffc0205850 <commands+0x870>
ffffffffc020129c:	10500593          	li	a1,261
ffffffffc02012a0:	00004517          	auipc	a0,0x4
ffffffffc02012a4:	5c850513          	addi	a0,a0,1480 # ffffffffc0205868 <commands+0x888>
ffffffffc02012a8:	9a8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02012ac:	00004697          	auipc	a3,0x4
ffffffffc02012b0:	7b468693          	addi	a3,a3,1972 # ffffffffc0205a60 <commands+0xa80>
ffffffffc02012b4:	00004617          	auipc	a2,0x4
ffffffffc02012b8:	59c60613          	addi	a2,a2,1436 # ffffffffc0205850 <commands+0x870>
ffffffffc02012bc:	10400593          	li	a1,260
ffffffffc02012c0:	00004517          	auipc	a0,0x4
ffffffffc02012c4:	5a850513          	addi	a0,a0,1448 # ffffffffc0205868 <commands+0x888>
ffffffffc02012c8:	988ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02012cc:	00004697          	auipc	a3,0x4
ffffffffc02012d0:	6fc68693          	addi	a3,a3,1788 # ffffffffc02059c8 <commands+0x9e8>
ffffffffc02012d4:	00004617          	auipc	a2,0x4
ffffffffc02012d8:	57c60613          	addi	a2,a2,1404 # ffffffffc0205850 <commands+0x870>
ffffffffc02012dc:	0fe00593          	li	a1,254
ffffffffc02012e0:	00004517          	auipc	a0,0x4
ffffffffc02012e4:	58850513          	addi	a0,a0,1416 # ffffffffc0205868 <commands+0x888>
ffffffffc02012e8:	968ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(!PageProperty(p0));
ffffffffc02012ec:	00004697          	auipc	a3,0x4
ffffffffc02012f0:	75c68693          	addi	a3,a3,1884 # ffffffffc0205a48 <commands+0xa68>
ffffffffc02012f4:	00004617          	auipc	a2,0x4
ffffffffc02012f8:	55c60613          	addi	a2,a2,1372 # ffffffffc0205850 <commands+0x870>
ffffffffc02012fc:	0f900593          	li	a1,249
ffffffffc0201300:	00004517          	auipc	a0,0x4
ffffffffc0201304:	56850513          	addi	a0,a0,1384 # ffffffffc0205868 <commands+0x888>
ffffffffc0201308:	948ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc020130c:	00005697          	auipc	a3,0x5
ffffffffc0201310:	85c68693          	addi	a3,a3,-1956 # ffffffffc0205b68 <commands+0xb88>
ffffffffc0201314:	00004617          	auipc	a2,0x4
ffffffffc0201318:	53c60613          	addi	a2,a2,1340 # ffffffffc0205850 <commands+0x870>
ffffffffc020131c:	11700593          	li	a1,279
ffffffffc0201320:	00004517          	auipc	a0,0x4
ffffffffc0201324:	54850513          	addi	a0,a0,1352 # ffffffffc0205868 <commands+0x888>
ffffffffc0201328:	928ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == 0);
ffffffffc020132c:	00005697          	auipc	a3,0x5
ffffffffc0201330:	86c68693          	addi	a3,a3,-1940 # ffffffffc0205b98 <commands+0xbb8>
ffffffffc0201334:	00004617          	auipc	a2,0x4
ffffffffc0201338:	51c60613          	addi	a2,a2,1308 # ffffffffc0205850 <commands+0x870>
ffffffffc020133c:	12600593          	li	a1,294
ffffffffc0201340:	00004517          	auipc	a0,0x4
ffffffffc0201344:	52850513          	addi	a0,a0,1320 # ffffffffc0205868 <commands+0x888>
ffffffffc0201348:	908ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(total == nr_free_pages());
ffffffffc020134c:	00004697          	auipc	a3,0x4
ffffffffc0201350:	53468693          	addi	a3,a3,1332 # ffffffffc0205880 <commands+0x8a0>
ffffffffc0201354:	00004617          	auipc	a2,0x4
ffffffffc0201358:	4fc60613          	addi	a2,a2,1276 # ffffffffc0205850 <commands+0x870>
ffffffffc020135c:	0f300593          	li	a1,243
ffffffffc0201360:	00004517          	auipc	a0,0x4
ffffffffc0201364:	50850513          	addi	a0,a0,1288 # ffffffffc0205868 <commands+0x888>
ffffffffc0201368:	8e8ff0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc020136c:	00004697          	auipc	a3,0x4
ffffffffc0201370:	55468693          	addi	a3,a3,1364 # ffffffffc02058c0 <commands+0x8e0>
ffffffffc0201374:	00004617          	auipc	a2,0x4
ffffffffc0201378:	4dc60613          	addi	a2,a2,1244 # ffffffffc0205850 <commands+0x870>
ffffffffc020137c:	0ba00593          	li	a1,186
ffffffffc0201380:	00004517          	auipc	a0,0x4
ffffffffc0201384:	4e850513          	addi	a0,a0,1256 # ffffffffc0205868 <commands+0x888>
...
ffffffffc02014f0:	6bc68693          	addi	a3,a3,1724 # ffffffffc0205ba8 <commands+0xbc8>
ffffffffc02014f4:	00004617          	auipc	a2,0x4
ffffffffc02014f8:	35c60613          	addi	a2,a2,860 # ffffffffc0205850 <commands+0x870>
ffffffffc02014fc:	08300593          	li	a1,131
ffffffffc0201500:	00004517          	auipc	a0,0x4
ffffffffc0201504:	36850513          	addi	a0,a0,872 # ffffffffc0205868 <commands+0x888>
ffffffffc0201508:	f49fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc020150c:	00004697          	auipc	a3,0x4
ffffffffc0201510:	6c468693          	addi	a3,a3,1732 # ffffffffc0205bd0 <commands+0xbf0>
ffffffffc0201514:	00004617          	auipc	a2,0x4
ffffffffc0201518:	33c60613          	addi	a2,a2,828 # ffffffffc0205850 <commands+0x870>
ffffffffc020151c:	08000593          	li	a1,128
ffffffffc0201520:	00004517          	auipc	a0,0x4
ffffffffc0201524:	34850513          	addi	a0,a0,840 # ffffffffc0205868 <commands+0x888>
...
ffffffffc02015c8:	60c68693          	addi	a3,a3,1548 # ffffffffc0205bd0 <commands+0xbf0>
ffffffffc02015cc:	00004617          	auipc	a2,0x4
ffffffffc02015d0:	28460613          	addi	a2,a2,644 # ffffffffc0205850 <commands+0x870>
ffffffffc02015d4:	06200593          	li	a1,98
ffffffffc02015d8:	00004517          	auipc	a0,0x4
ffffffffc02015dc:	29050513          	addi	a0,a0,656 # ffffffffc0205868 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc02016b0:	52c68693          	addi	a3,a3,1324 # ffffffffc0205bd8 <commands+0xbf8>
ffffffffc02016b4:	00004617          	auipc	a2,0x4
ffffffffc02016b8:	19c60613          	addi	a2,a2,412 # ffffffffc0205850 <commands+0x870>
ffffffffc02016bc:	04900593          	li	a1,73
ffffffffc02016c0:	00004517          	auipc	a0,0x4
ffffffffc02016c4:	1a850513          	addi	a0,a0,424 # ffffffffc0205868 <commands+0x888>
ffffffffc02016c8:	d89fe0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(n > 0);
ffffffffc02016cc:	00004697          	auipc	a3,0x4
ffffffffc02016d0:	50468693          	addi	a3,a3,1284 # ffffffffc0205bd0 <commands+0xbf0>
ffffffffc02016d4:	00004617          	auipc	a2,0x4
ffffffffc02016d8:	17c60613          	addi	a2,a2,380 # ffffffffc0205850 <commands+0x870>
ffffffffc02016dc:	04600593          	li	a1,70
ffffffffc02016e0:	00004517          	auipc	a0,0x4
ffffffffc02016e4:	18850513          	addi	a0,a0,392 # ffffffffc0205868 <commands+0x888>
...
ffffffffc0201862:	3da60613          	addi	a2,a2,986 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0201866:	06800593          	li	a1,104
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	3f650513          	addi	a0,a0,1014 # ffffffffc0205c60 <default_pmm_manager+0x78>
...
ffffffffc020195e:	37e68693          	addi	a3,a3,894 # ffffffffc0205cd8 <default_pmm_manager+0xf0>
ffffffffc0201962:	00004617          	auipc	a2,0x4
ffffffffc0201966:	eee60613          	addi	a2,a2,-274 # ffffffffc0205850 <commands+0x870>
ffffffffc020196a:	06300593          	li	a1,99
ffffffffc020196e:	00004517          	auipc	a0,0x4
ffffffffc0201972:	38a50513          	addi	a0,a0,906 # ffffffffc0205cf8 <default_pmm_manager+0x110>
...
ffffffffc0201980:	39450513          	addi	a0,a0,916 # ffffffffc0205d10 <default_pmm_manager+0x128>
kmalloc_init(void) {
...
ffffffffc0201990:	32c50513          	addi	a0,a0,812 # ffffffffc0205cb8 <default_pmm_manager+0xd0>
}
...
ffffffffc0201b4e:	12660613          	addi	a2,a2,294 # ffffffffc0205c70 <default_pmm_manager+0x88>
ffffffffc0201b52:	06d00593          	li	a1,109
ffffffffc0201b56:	00004517          	auipc	a0,0x4
ffffffffc0201b5a:	10a50513          	addi	a0,a0,266 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc0201b5e:	8f3fe0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201b62:	00004617          	auipc	a2,0x4
ffffffffc0201b66:	13660613          	addi	a2,a2,310 # ffffffffc0205c98 <default_pmm_manager+0xb0>
ffffffffc0201b6a:	06100593          	li	a1,97
ffffffffc0201b6e:	00004517          	auipc	a0,0x4
ffffffffc0201b72:	0f250513          	addi	a0,a0,242 # ffffffffc0205c60 <default_pmm_manager+0x78>
...
ffffffffc0201b80:	11c60613          	addi	a2,a2,284 # ffffffffc0205c98 <default_pmm_manager+0xb0>
ffffffffc0201b84:	06100593          	li	a1,97
ffffffffc0201b88:	00004517          	auipc	a0,0x4
ffffffffc0201b8c:	0d850513          	addi	a0,a0,216 # ffffffffc0205c60 <default_pmm_manager+0x78>
pa2page(uintptr_t pa) {
...
ffffffffc0201d2a:	12c030ef          	jal	ra,ffffffffc0204e56 <memset>
    return page - pages + nbase;
...
ffffffffc0201dbc:	09a030ef          	jal	ra,ffffffffc0204e56 <memset>
    return page - pages + nbase;
...
ffffffffc0201e16:	e2660613          	addi	a2,a2,-474 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0201e1a:	0e400593          	li	a1,228
ffffffffc0201e1e:	00004517          	auipc	a0,0x4
ffffffffc0201e22:	f0a50513          	addi	a0,a0,-246 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0201e26:	e2afe0ef          	jal	ra,ffffffffc0200450 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201e2a:	00004617          	auipc	a2,0x4
ffffffffc0201e2e:	e0e60613          	addi	a2,a2,-498 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0201e32:	0ef00593          	li	a1,239
ffffffffc0201e36:	00004517          	auipc	a0,0x4
ffffffffc0201e3a:	ef250513          	addi	a0,a0,-270 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc0201e48:	df460613          	addi	a2,a2,-524 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0201e4c:	0ec00593          	li	a1,236
ffffffffc0201e50:	00004517          	auipc	a0,0x4
ffffffffc0201e54:	ed850513          	addi	a0,a0,-296 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc0201e62:	dda60613          	addi	a2,a2,-550 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0201e66:	0e100593          	li	a1,225
ffffffffc0201e6a:	00004517          	auipc	a0,0x4
ffffffffc0201e6e:	ebe50513          	addi	a0,a0,-322 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc020200e:	bde78793          	addi	a5,a5,-1058 # ffffffffc0205be8 <default_pmm_manager>
...
ffffffffc020201a:	d3a50513          	addi	a0,a0,-710 # ffffffffc0205d50 <default_pmm_manager+0x168>
void pmm_init(void) {
...
ffffffffc0202064:	d0850513          	addi	a0,a0,-760 # ffffffffc0205d68 <default_pmm_manager+0x180>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0202088:	cfc50513          	addi	a0,a0,-772 # ffffffffc0205d80 <default_pmm_manager+0x198>
...
ffffffffc0202132:	c7a50513          	addi	a0,a0,-902 # ffffffffc0205da8 <default_pmm_manager+0x1c0>
...
ffffffffc020214c:	c7850513          	addi	a0,a0,-904 # ffffffffc0205dc0 <default_pmm_manager+0x1d8>
...
ffffffffc02023a2:	d3250513          	addi	a0,a0,-718 # ffffffffc02060d0 <default_pmm_manager+0x4e8>
...
ffffffffc020244e:	dbe58593          	addi	a1,a1,-578 # ffffffffc0206208 <default_pmm_manager+0x620>
ffffffffc0202452:	10000513          	li	a0,256
ffffffffc0202456:	1a7020ef          	jal	ra,ffffffffc0204dfc <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020245a:	100b0593          	addi	a1,s6,256
ffffffffc020245e:	10000513          	li	a0,256
ffffffffc0202462:	1ad020ef          	jal	ra,ffffffffc0204e0e <strcmp>
...
ffffffffc0202496:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fde9b08>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020249a:	11f020ef          	jal	ra,ffffffffc0204db8 <strlen>
...
ffffffffc0202522:	d6250513          	addi	a0,a0,-670 # ffffffffc0206280 <default_pmm_manager+0x698>
...
ffffffffc020254c:	ba868693          	addi	a3,a3,-1112 # ffffffffc02060f0 <default_pmm_manager+0x508>
ffffffffc0202550:	00003617          	auipc	a2,0x3
ffffffffc0202554:	30060613          	addi	a2,a2,768 # ffffffffc0205850 <commands+0x870>
ffffffffc0202558:	19d00593          	li	a1,413
ffffffffc020255c:	00003517          	auipc	a0,0x3
ffffffffc0202560:	7cc50513          	addi	a0,a0,1996 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc020256e:	6ce60613          	addi	a2,a2,1742 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0202572:	19d00593          	li	a1,413
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	7b250513          	addi	a0,a0,1970 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc020257e:	ed3fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202582:	00004697          	auipc	a3,0x4
ffffffffc0202586:	bae68693          	addi	a3,a3,-1106 # ffffffffc0206130 <default_pmm_manager+0x548>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	2c660613          	addi	a2,a2,710 # ffffffffc0205850 <commands+0x870>
ffffffffc0202592:	19e00593          	li	a1,414
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	79250513          	addi	a0,a0,1938 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc02025aa:	69260613          	addi	a2,a2,1682 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02025ae:	06800593          	li	a1,104
ffffffffc02025b2:	00003517          	auipc	a0,0x3
ffffffffc02025b6:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02025ba:	e97fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02025be:	00004617          	auipc	a2,0x4
ffffffffc02025c2:	90260613          	addi	a2,a2,-1790 # ffffffffc0205ec0 <default_pmm_manager+0x2d8>
ffffffffc02025c6:	07300593          	li	a1,115
ffffffffc02025ca:	00003517          	auipc	a0,0x3
ffffffffc02025ce:	69650513          	addi	a0,a0,1686 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02025d2:	e7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025d6:	00004697          	auipc	a3,0x4
ffffffffc02025da:	82a68693          	addi	a3,a3,-2006 # ffffffffc0205e00 <default_pmm_manager+0x218>
ffffffffc02025de:	00003617          	auipc	a2,0x3
ffffffffc02025e2:	27260613          	addi	a2,a2,626 # ffffffffc0205850 <commands+0x870>
ffffffffc02025e6:	16100593          	li	a1,353
ffffffffc02025ea:	00003517          	auipc	a0,0x3
ffffffffc02025ee:	73e50513          	addi	a0,a0,1854 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02025f2:	e5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025f6:	00004697          	auipc	a3,0x4
ffffffffc02025fa:	8f268693          	addi	a3,a3,-1806 # ffffffffc0205ee8 <default_pmm_manager+0x300>
ffffffffc02025fe:	00003617          	auipc	a2,0x3
ffffffffc0202602:	25260613          	addi	a2,a2,594 # ffffffffc0205850 <commands+0x870>
ffffffffc0202606:	17d00593          	li	a1,381
ffffffffc020260a:	00003517          	auipc	a0,0x3
ffffffffc020260e:	71e50513          	addi	a0,a0,1822 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202612:	e3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202616:	00004697          	auipc	a3,0x4
ffffffffc020261a:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206160 <default_pmm_manager+0x578>
ffffffffc020261e:	00003617          	auipc	a2,0x3
ffffffffc0202622:	23260613          	addi	a2,a2,562 # ffffffffc0205850 <commands+0x870>
ffffffffc0202626:	1a500593          	li	a1,421
ffffffffc020262a:	00003517          	auipc	a0,0x3
ffffffffc020262e:	6fe50513          	addi	a0,a0,1790 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202632:	e1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202636:	00004697          	auipc	a3,0x4
ffffffffc020263a:	94268693          	addi	a3,a3,-1726 # ffffffffc0205f78 <default_pmm_manager+0x390>
ffffffffc020263e:	00003617          	auipc	a2,0x3
ffffffffc0202642:	21260613          	addi	a2,a2,530 # ffffffffc0205850 <commands+0x870>
ffffffffc0202646:	17c00593          	li	a1,380
ffffffffc020264a:	00003517          	auipc	a0,0x3
ffffffffc020264e:	6de50513          	addi	a0,a0,1758 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202652:	dfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202656:	00004697          	auipc	a3,0x4
ffffffffc020265a:	9ea68693          	addi	a3,a3,-1558 # ffffffffc0206040 <default_pmm_manager+0x458>
ffffffffc020265e:	00003617          	auipc	a2,0x3
ffffffffc0202662:	1f260613          	addi	a2,a2,498 # ffffffffc0205850 <commands+0x870>
ffffffffc0202666:	17b00593          	li	a1,379
ffffffffc020266a:	00003517          	auipc	a0,0x3
ffffffffc020266e:	6be50513          	addi	a0,a0,1726 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202672:	ddffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202676:	00004697          	auipc	a3,0x4
ffffffffc020267a:	9b268693          	addi	a3,a3,-1614 # ffffffffc0206028 <default_pmm_manager+0x440>
ffffffffc020267e:	00003617          	auipc	a2,0x3
ffffffffc0202682:	1d260613          	addi	a2,a2,466 # ffffffffc0205850 <commands+0x870>
ffffffffc0202686:	17a00593          	li	a1,378
ffffffffc020268a:	00003517          	auipc	a0,0x3
ffffffffc020268e:	69e50513          	addi	a0,a0,1694 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202692:	dbffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202696:	00004697          	auipc	a3,0x4
ffffffffc020269a:	96268693          	addi	a3,a3,-1694 # ffffffffc0205ff8 <default_pmm_manager+0x410>
ffffffffc020269e:	00003617          	auipc	a2,0x3
ffffffffc02026a2:	1b260613          	addi	a2,a2,434 # ffffffffc0205850 <commands+0x870>
ffffffffc02026a6:	17900593          	li	a1,377
ffffffffc02026aa:	00003517          	auipc	a0,0x3
ffffffffc02026ae:	67e50513          	addi	a0,a0,1662 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02026b2:	d9ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026b6:	00004697          	auipc	a3,0x4
ffffffffc02026ba:	92a68693          	addi	a3,a3,-1750 # ffffffffc0205fe0 <default_pmm_manager+0x3f8>
ffffffffc02026be:	00003617          	auipc	a2,0x3
ffffffffc02026c2:	19260613          	addi	a2,a2,402 # ffffffffc0205850 <commands+0x870>
ffffffffc02026c6:	17700593          	li	a1,375
ffffffffc02026ca:	00003517          	auipc	a0,0x3
ffffffffc02026ce:	65e50513          	addi	a0,a0,1630 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02026d2:	d7ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02026d6:	00004697          	auipc	a3,0x4
ffffffffc02026da:	8f268693          	addi	a3,a3,-1806 # ffffffffc0205fc8 <default_pmm_manager+0x3e0>
ffffffffc02026de:	00003617          	auipc	a2,0x3
ffffffffc02026e2:	17260613          	addi	a2,a2,370 # ffffffffc0205850 <commands+0x870>
ffffffffc02026e6:	17600593          	li	a1,374
ffffffffc02026ea:	00003517          	auipc	a0,0x3
ffffffffc02026ee:	63e50513          	addi	a0,a0,1598 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02026f2:	d5ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02026f6:	00004697          	auipc	a3,0x4
ffffffffc02026fa:	8c268693          	addi	a3,a3,-1854 # ffffffffc0205fb8 <default_pmm_manager+0x3d0>
ffffffffc02026fe:	00003617          	auipc	a2,0x3
ffffffffc0202702:	15260613          	addi	a2,a2,338 # ffffffffc0205850 <commands+0x870>
ffffffffc0202706:	17500593          	li	a1,373
ffffffffc020270a:	00003517          	auipc	a0,0x3
ffffffffc020270e:	61e50513          	addi	a0,a0,1566 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202712:	d3ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202716:	00004697          	auipc	a3,0x4
ffffffffc020271a:	89268693          	addi	a3,a3,-1902 # ffffffffc0205fa8 <default_pmm_manager+0x3c0>
ffffffffc020271e:	00003617          	auipc	a2,0x3
ffffffffc0202722:	13260613          	addi	a2,a2,306 # ffffffffc0205850 <commands+0x870>
ffffffffc0202726:	17400593          	li	a1,372
ffffffffc020272a:	00003517          	auipc	a0,0x3
ffffffffc020272e:	5fe50513          	addi	a0,a0,1534 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202732:	d1ffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202736:	00004697          	auipc	a3,0x4
ffffffffc020273a:	84268693          	addi	a3,a3,-1982 # ffffffffc0205f78 <default_pmm_manager+0x390>
ffffffffc020273e:	00003617          	auipc	a2,0x3
ffffffffc0202742:	11260613          	addi	a2,a2,274 # ffffffffc0205850 <commands+0x870>
ffffffffc0202746:	17300593          	li	a1,371
ffffffffc020274a:	00003517          	auipc	a0,0x3
ffffffffc020274e:	5de50513          	addi	a0,a0,1502 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202752:	cfffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202756:	00003697          	auipc	a3,0x3
ffffffffc020275a:	7ea68693          	addi	a3,a3,2026 # ffffffffc0205f40 <default_pmm_manager+0x358>
ffffffffc020275e:	00003617          	auipc	a2,0x3
ffffffffc0202762:	0f260613          	addi	a2,a2,242 # ffffffffc0205850 <commands+0x870>
ffffffffc0202766:	17200593          	li	a1,370
ffffffffc020276a:	00003517          	auipc	a0,0x3
ffffffffc020276e:	5be50513          	addi	a0,a0,1470 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202772:	cdffd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202776:	00003697          	auipc	a3,0x3
ffffffffc020277a:	7a268693          	addi	a3,a3,1954 # ffffffffc0205f18 <default_pmm_manager+0x330>
ffffffffc020277e:	00003617          	auipc	a2,0x3
ffffffffc0202782:	0d260613          	addi	a2,a2,210 # ffffffffc0205850 <commands+0x870>
ffffffffc0202786:	16f00593          	li	a1,367
ffffffffc020278a:	00003517          	auipc	a0,0x3
ffffffffc020278e:	59e50513          	addi	a0,a0,1438 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc020279c:	4a060613          	addi	a2,a2,1184 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02027a0:	16e00593          	li	a1,366
ffffffffc02027a4:	00003517          	auipc	a0,0x3
ffffffffc02027a8:	58450513          	addi	a0,a0,1412 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc02027b6:	48660613          	addi	a2,a2,1158 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02027ba:	06800593          	li	a1,104
ffffffffc02027be:	00003517          	auipc	a0,0x3
ffffffffc02027c2:	4a250513          	addi	a0,a0,1186 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02027c6:	c8bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02027ca:	00004697          	auipc	a3,0x4
ffffffffc02027ce:	8be68693          	addi	a3,a3,-1858 # ffffffffc0206088 <default_pmm_manager+0x4a0>
ffffffffc02027d2:	00003617          	auipc	a2,0x3
ffffffffc02027d6:	07e60613          	addi	a2,a2,126 # ffffffffc0205850 <commands+0x870>
ffffffffc02027da:	18800593          	li	a1,392
ffffffffc02027de:	00003517          	auipc	a0,0x3
ffffffffc02027e2:	54a50513          	addi	a0,a0,1354 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02027e6:	c6bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02027ea:	00004697          	auipc	a3,0x4
ffffffffc02027ee:	85668693          	addi	a3,a3,-1962 # ffffffffc0206040 <default_pmm_manager+0x458>
ffffffffc02027f2:	00003617          	auipc	a2,0x3
ffffffffc02027f6:	05e60613          	addi	a2,a2,94 # ffffffffc0205850 <commands+0x870>
ffffffffc02027fa:	18600593          	li	a1,390
ffffffffc02027fe:	00003517          	auipc	a0,0x3
ffffffffc0202802:	52a50513          	addi	a0,a0,1322 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202806:	c4bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc020280a:	00004697          	auipc	a3,0x4
ffffffffc020280e:	86668693          	addi	a3,a3,-1946 # ffffffffc0206070 <default_pmm_manager+0x488>
ffffffffc0202812:	00003617          	auipc	a2,0x3
ffffffffc0202816:	03e60613          	addi	a2,a2,62 # ffffffffc0205850 <commands+0x870>
ffffffffc020281a:	18500593          	li	a1,389
ffffffffc020281e:	00003517          	auipc	a0,0x3
ffffffffc0202822:	50a50513          	addi	a0,a0,1290 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202826:	c2bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020282a:	00004697          	auipc	a3,0x4
ffffffffc020282e:	9c668693          	addi	a3,a3,-1594 # ffffffffc02061f0 <default_pmm_manager+0x608>
ffffffffc0202832:	00003617          	auipc	a2,0x3
ffffffffc0202836:	01e60613          	addi	a2,a2,30 # ffffffffc0205850 <commands+0x870>
ffffffffc020283a:	1a800593          	li	a1,424
ffffffffc020283e:	00003517          	auipc	a0,0x3
ffffffffc0202842:	4ea50513          	addi	a0,a0,1258 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202846:	c0bfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020284a:	00004697          	auipc	a3,0x4
ffffffffc020284e:	96668693          	addi	a3,a3,-1690 # ffffffffc02061b0 <default_pmm_manager+0x5c8>
ffffffffc0202852:	00003617          	auipc	a2,0x3
ffffffffc0202856:	ffe60613          	addi	a2,a2,-2 # ffffffffc0205850 <commands+0x870>
ffffffffc020285a:	1a700593          	li	a1,423
ffffffffc020285e:	00003517          	auipc	a0,0x3
ffffffffc0202862:	4ca50513          	addi	a0,a0,1226 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202866:	bebfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p) == 1);
ffffffffc020286a:	00004697          	auipc	a3,0x4
ffffffffc020286e:	92e68693          	addi	a3,a3,-1746 # ffffffffc0206198 <default_pmm_manager+0x5b0>
ffffffffc0202872:	00003617          	auipc	a2,0x3
ffffffffc0202876:	fde60613          	addi	a2,a2,-34 # ffffffffc0205850 <commands+0x870>
ffffffffc020287a:	1a600593          	li	a1,422
ffffffffc020287e:	00003517          	auipc	a0,0x3
ffffffffc0202882:	4aa50513          	addi	a0,a0,1194 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc0202890:	3ac60613          	addi	a2,a2,940 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0202894:	16d00593          	li	a1,365
ffffffffc0202898:	00003517          	auipc	a0,0x3
ffffffffc020289c:	49050513          	addi	a0,a0,1168 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02028a0:	bb1fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02028a4:	00003617          	auipc	a2,0x3
ffffffffc02028a8:	3cc60613          	addi	a2,a2,972 # ffffffffc0205c70 <default_pmm_manager+0x88>
ffffffffc02028ac:	07e00593          	li	a1,126
ffffffffc02028b0:	00003517          	auipc	a0,0x3
ffffffffc02028b4:	47850513          	addi	a0,a0,1144 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02028b8:	b99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02028bc:	00004697          	auipc	a3,0x4
ffffffffc02028c0:	96468693          	addi	a3,a3,-1692 # ffffffffc0206220 <default_pmm_manager+0x638>
ffffffffc02028c4:	00003617          	auipc	a2,0x3
ffffffffc02028c8:	f8c60613          	addi	a2,a2,-116 # ffffffffc0205850 <commands+0x870>
ffffffffc02028cc:	1ac00593          	li	a1,428
ffffffffc02028d0:	00003517          	auipc	a0,0x3
ffffffffc02028d4:	45850513          	addi	a0,a0,1112 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02028d8:	b79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02028dc:	00003697          	auipc	a3,0x3
ffffffffc02028e0:	7d468693          	addi	a3,a3,2004 # ffffffffc02060b0 <default_pmm_manager+0x4c8>
ffffffffc02028e4:	00003617          	auipc	a2,0x3
ffffffffc02028e8:	f6c60613          	addi	a2,a2,-148 # ffffffffc0205850 <commands+0x870>
ffffffffc02028ec:	1b800593          	li	a1,440
ffffffffc02028f0:	00003517          	auipc	a0,0x3
ffffffffc02028f4:	43850513          	addi	a0,a0,1080 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02028f8:	b59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02028fc:	00003697          	auipc	a3,0x3
ffffffffc0202900:	60468693          	addi	a3,a3,1540 # ffffffffc0205f00 <default_pmm_manager+0x318>
ffffffffc0202904:	00003617          	auipc	a2,0x3
ffffffffc0202908:	f4c60613          	addi	a2,a2,-180 # ffffffffc0205850 <commands+0x870>
ffffffffc020290c:	16b00593          	li	a1,363
ffffffffc0202910:	00003517          	auipc	a0,0x3
ffffffffc0202914:	41850513          	addi	a0,a0,1048 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202918:	b39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020291c:	00003697          	auipc	a3,0x3
ffffffffc0202920:	5cc68693          	addi	a3,a3,1484 # ffffffffc0205ee8 <default_pmm_manager+0x300>
ffffffffc0202924:	00003617          	auipc	a2,0x3
ffffffffc0202928:	f2c60613          	addi	a2,a2,-212 # ffffffffc0205850 <commands+0x870>
ffffffffc020292c:	16a00593          	li	a1,362
ffffffffc0202930:	00003517          	auipc	a0,0x3
ffffffffc0202934:	3f850513          	addi	a0,a0,1016 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202938:	b19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc020293c:	00003697          	auipc	a3,0x3
ffffffffc0202940:	4fc68693          	addi	a3,a3,1276 # ffffffffc0205e38 <default_pmm_manager+0x250>
ffffffffc0202944:	00003617          	auipc	a2,0x3
ffffffffc0202948:	f0c60613          	addi	a2,a2,-244 # ffffffffc0205850 <commands+0x870>
ffffffffc020294c:	16200593          	li	a1,354
ffffffffc0202950:	00003517          	auipc	a0,0x3
ffffffffc0202954:	3d850513          	addi	a0,a0,984 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202958:	af9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc020295c:	00003697          	auipc	a3,0x3
ffffffffc0202960:	53468693          	addi	a3,a3,1332 # ffffffffc0205e90 <default_pmm_manager+0x2a8>
ffffffffc0202964:	00003617          	auipc	a2,0x3
ffffffffc0202968:	eec60613          	addi	a2,a2,-276 # ffffffffc0205850 <commands+0x870>
ffffffffc020296c:	16900593          	li	a1,361
ffffffffc0202970:	00003517          	auipc	a0,0x3
ffffffffc0202974:	3b850513          	addi	a0,a0,952 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202978:	ad9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc020297c:	00003697          	auipc	a3,0x3
ffffffffc0202980:	4e468693          	addi	a3,a3,1252 # ffffffffc0205e60 <default_pmm_manager+0x278>
ffffffffc0202984:	00003617          	auipc	a2,0x3
ffffffffc0202988:	ecc60613          	addi	a2,a2,-308 # ffffffffc0205850 <commands+0x870>
ffffffffc020298c:	16600593          	li	a1,358
ffffffffc0202990:	00003517          	auipc	a0,0x3
ffffffffc0202994:	39850513          	addi	a0,a0,920 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202998:	ab9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020299c:	00003697          	auipc	a3,0x3
ffffffffc02029a0:	6a468693          	addi	a3,a3,1700 # ffffffffc0206040 <default_pmm_manager+0x458>
ffffffffc02029a4:	00003617          	auipc	a2,0x3
ffffffffc02029a8:	eac60613          	addi	a2,a2,-340 # ffffffffc0205850 <commands+0x870>
ffffffffc02029ac:	18200593          	li	a1,386
ffffffffc02029b0:	00003517          	auipc	a0,0x3
ffffffffc02029b4:	37850513          	addi	a0,a0,888 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02029b8:	a99fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029bc:	00003697          	auipc	a3,0x3
ffffffffc02029c0:	54468693          	addi	a3,a3,1348 # ffffffffc0205f00 <default_pmm_manager+0x318>
ffffffffc02029c4:	00003617          	auipc	a2,0x3
ffffffffc02029c8:	e8c60613          	addi	a2,a2,-372 # ffffffffc0205850 <commands+0x870>
ffffffffc02029cc:	18100593          	li	a1,385
ffffffffc02029d0:	00003517          	auipc	a0,0x3
ffffffffc02029d4:	35850513          	addi	a0,a0,856 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02029d8:	a79fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc02029dc:	00003697          	auipc	a3,0x3
ffffffffc02029e0:	67c68693          	addi	a3,a3,1660 # ffffffffc0206058 <default_pmm_manager+0x470>
ffffffffc02029e4:	00003617          	auipc	a2,0x3
ffffffffc02029e8:	e6c60613          	addi	a2,a2,-404 # ffffffffc0205850 <commands+0x870>
ffffffffc02029ec:	17e00593          	li	a1,382
ffffffffc02029f0:	00003517          	auipc	a0,0x3
ffffffffc02029f4:	33850513          	addi	a0,a0,824 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc02029f8:	a59fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02029fc:	00004697          	auipc	a3,0x4
ffffffffc0202a00:	85c68693          	addi	a3,a3,-1956 # ffffffffc0206258 <default_pmm_manager+0x670>
ffffffffc0202a04:	00003617          	auipc	a2,0x3
ffffffffc0202a08:	e4c60613          	addi	a2,a2,-436 # ffffffffc0205850 <commands+0x870>
ffffffffc0202a0c:	1af00593          	li	a1,431
ffffffffc0202a10:	00003517          	auipc	a0,0x3
ffffffffc0202a14:	31850513          	addi	a0,a0,792 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202a18:	a39fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202a1c:	00003697          	auipc	a3,0x3
ffffffffc0202a20:	69468693          	addi	a3,a3,1684 # ffffffffc02060b0 <default_pmm_manager+0x4c8>
ffffffffc0202a24:	00003617          	auipc	a2,0x3
ffffffffc0202a28:	e2c60613          	addi	a2,a2,-468 # ffffffffc0205850 <commands+0x870>
ffffffffc0202a2c:	19000593          	li	a1,400
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	2f850513          	addi	a0,a0,760 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202a38:	a19fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202a3c:	00003697          	auipc	a3,0x3
ffffffffc0202a40:	70c68693          	addi	a3,a3,1804 # ffffffffc0206148 <default_pmm_manager+0x560>
ffffffffc0202a44:	00003617          	auipc	a2,0x3
ffffffffc0202a48:	e0c60613          	addi	a2,a2,-500 # ffffffffc0205850 <commands+0x870>
ffffffffc0202a4c:	1a100593          	li	a1,417
ffffffffc0202a50:	00003517          	auipc	a0,0x3
ffffffffc0202a54:	2d850513          	addi	a0,a0,728 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202a58:	9f9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202a5c:	00003697          	auipc	a3,0x3
ffffffffc0202a60:	38468693          	addi	a3,a3,900 # ffffffffc0205de0 <default_pmm_manager+0x1f8>
ffffffffc0202a64:	00003617          	auipc	a2,0x3
ffffffffc0202a68:	dec60613          	addi	a2,a2,-532 # ffffffffc0205850 <commands+0x870>
ffffffffc0202a6c:	16000593          	li	a1,352
ffffffffc0202a70:	00003517          	auipc	a0,0x3
ffffffffc0202a74:	2b850513          	addi	a0,a0,696 # ffffffffc0205d28 <default_pmm_manager+0x140>
ffffffffc0202a78:	9d9fd0ef          	jal	ra,ffffffffc0200450 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202a7c:	00003617          	auipc	a2,0x3
ffffffffc0202a80:	1f460613          	addi	a2,a2,500 # ffffffffc0205c70 <default_pmm_manager+0x88>
ffffffffc0202a84:	0c200593          	li	a1,194
ffffffffc0202a88:	00003517          	auipc	a0,0x3
ffffffffc0202a8c:	2a050513          	addi	a0,a0,672 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc0202b04:	23868693          	addi	a3,a3,568 # ffffffffc0205d38 <default_pmm_manager+0x150>
ffffffffc0202b08:	00003617          	auipc	a2,0x3
ffffffffc0202b0c:	d4860613          	addi	a2,a2,-696 # ffffffffc0205850 <commands+0x870>
ffffffffc0202b10:	14800593          	li	a1,328
ffffffffc0202b14:	00003517          	auipc	a0,0x3
ffffffffc0202b18:	21450513          	addi	a0,a0,532 # ffffffffc0205d28 <default_pmm_manager+0x140>
...
ffffffffc0202b46:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b48:	528010ef          	jal	ra,ffffffffc0204070 <swapfs_init>
...
ffffffffc0202baa:	77a50513          	addi	a0,a0,1914 # ffffffffc0206320 <default_pmm_manager+0x738>
    return listelm->next;
...
ffffffffc0202c08:	73450513          	addi	a0,a0,1844 # ffffffffc0206338 <default_pmm_manager+0x750>
ffffffffc0202c0c:	d82fd0ef          	jal	ra,ffffffffc020018e <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc0202c10:	45f000ef          	jal	ra,ffffffffc020386e <mm_create>
...
ffffffffc0202c4e:	46d000ef          	jal	ra,ffffffffc02038ba <vma_create>
...
ffffffffc0202c5a:	4cd000ef          	jal	ra,ffffffffc0203926 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202c5e:	00003517          	auipc	a0,0x3
ffffffffc0202c62:	74a50513          	addi	a0,a0,1866 # ffffffffc02063a8 <default_pmm_manager+0x7c0>
...
ffffffffc0202c7e:	77e50513          	addi	a0,a0,1918 # ffffffffc02063f8 <default_pmm_manager+0x810>
...
ffffffffc0202cfe:	78650513          	addi	a0,a0,1926 # ffffffffc0206480 <default_pmm_manager+0x898>
...
ffffffffc0202e3e:	6ee50513          	addi	a0,a0,1774 # ffffffffc0206528 <default_pmm_manager+0x940>
...
ffffffffc0202e88:	36d000ef          	jal	ra,ffffffffc02039f4 <mm_destroy>
...
ffffffffc0202f2e:	64e50513          	addi	a0,a0,1614 # ffffffffc0206578 <default_pmm_manager+0x990>
...
ffffffffc0202f44:	90068693          	addi	a3,a3,-1792 # ffffffffc0205840 <commands+0x860>
ffffffffc0202f48:	00003617          	auipc	a2,0x3
ffffffffc0202f4c:	90860613          	addi	a2,a2,-1784 # ffffffffc0205850 <commands+0x870>
ffffffffc0202f50:	0bd00593          	li	a1,189
ffffffffc0202f54:	00003517          	auipc	a0,0x3
ffffffffc0202f58:	3bc50513          	addi	a0,a0,956 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0202f5c:	cf4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202f60:	00003617          	auipc	a2,0x3
ffffffffc0202f64:	d3860613          	addi	a2,a2,-712 # ffffffffc0205c98 <default_pmm_manager+0xb0>
ffffffffc0202f68:	06100593          	li	a1,97
ffffffffc0202f6c:	00003517          	auipc	a0,0x3
ffffffffc0202f70:	cf450513          	addi	a0,a0,-780 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc0202f74:	cdcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f78:	00003697          	auipc	a3,0x3
ffffffffc0202f7c:	58868693          	addi	a3,a3,1416 # ffffffffc0206500 <default_pmm_manager+0x918>
ffffffffc0202f80:	00003617          	auipc	a2,0x3
ffffffffc0202f84:	8d060613          	addi	a2,a2,-1840 # ffffffffc0205850 <commands+0x870>
ffffffffc0202f88:	0fd00593          	li	a1,253
ffffffffc0202f8c:	00003517          	auipc	a0,0x3
ffffffffc0202f90:	38450513          	addi	a0,a0,900 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0202f94:	cbcfd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202f98:	00003617          	auipc	a2,0x3
ffffffffc0202f9c:	f2860613          	addi	a2,a2,-216 # ffffffffc0205ec0 <default_pmm_manager+0x2d8>
ffffffffc0202fa0:	07300593          	li	a1,115
ffffffffc0202fa4:	00003517          	auipc	a0,0x3
ffffffffc0202fa8:	cbc50513          	addi	a0,a0,-836 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc0202fac:	ca4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202fb0:	00003697          	auipc	a3,0x3
ffffffffc0202fb4:	48868693          	addi	a3,a3,1160 # ffffffffc0206438 <default_pmm_manager+0x850>
ffffffffc0202fb8:	00003617          	auipc	a2,0x3
ffffffffc0202fbc:	89860613          	addi	a2,a2,-1896 # ffffffffc0205850 <commands+0x870>
ffffffffc0202fc0:	0de00593          	li	a1,222
ffffffffc0202fc4:	00003517          	auipc	a0,0x3
ffffffffc0202fc8:	34c50513          	addi	a0,a0,844 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0202fcc:	c84fd0ef          	jal	ra,ffffffffc0200450 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202fd0:	00003697          	auipc	a3,0x3
ffffffffc0202fd4:	45068693          	addi	a3,a3,1104 # ffffffffc0206420 <default_pmm_manager+0x838>
ffffffffc0202fd8:	00003617          	auipc	a2,0x3
ffffffffc0202fdc:	87860613          	addi	a2,a2,-1928 # ffffffffc0205850 <commands+0x870>
ffffffffc0202fe0:	0dd00593          	li	a1,221
ffffffffc0202fe4:	00003517          	auipc	a0,0x3
ffffffffc0202fe8:	32c50513          	addi	a0,a0,812 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0202fec:	c64fd0ef          	jal	ra,ffffffffc0200450 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202ff0:	00003697          	auipc	a3,0x3
ffffffffc0202ff4:	4f868693          	addi	a3,a3,1272 # ffffffffc02064e8 <default_pmm_manager+0x900>
ffffffffc0202ff8:	00003617          	auipc	a2,0x3
ffffffffc0202ffc:	85860613          	addi	a2,a2,-1960 # ffffffffc0205850 <commands+0x870>
ffffffffc0203000:	0fc00593          	li	a1,252
ffffffffc0203004:	00003517          	auipc	a0,0x3
ffffffffc0203008:	30c50513          	addi	a0,a0,780 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc020300c:	c44fd0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203010:	00003617          	auipc	a2,0x3
ffffffffc0203014:	2e060613          	addi	a2,a2,736 # ffffffffc02062f0 <default_pmm_manager+0x708>
ffffffffc0203018:	02a00593          	li	a1,42
ffffffffc020301c:	00003517          	auipc	a0,0x3
ffffffffc0203020:	2f450513          	addi	a0,a0,756 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203024:	c2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203028:	00003697          	auipc	a3,0x3
ffffffffc020302c:	49068693          	addi	a3,a3,1168 # ffffffffc02064b8 <default_pmm_manager+0x8d0>
ffffffffc0203030:	00003617          	auipc	a2,0x3
ffffffffc0203034:	82060613          	addi	a2,a2,-2016 # ffffffffc0205850 <commands+0x870>
ffffffffc0203038:	09800593          	li	a1,152
ffffffffc020303c:	00003517          	auipc	a0,0x3
ffffffffc0203040:	2d450513          	addi	a0,a0,724 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203044:	c0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==2);
ffffffffc0203048:	00003697          	auipc	a3,0x3
ffffffffc020304c:	47068693          	addi	a3,a3,1136 # ffffffffc02064b8 <default_pmm_manager+0x8d0>
ffffffffc0203050:	00003617          	auipc	a2,0x3
ffffffffc0203054:	80060613          	addi	a2,a2,-2048 # ffffffffc0205850 <commands+0x870>
ffffffffc0203058:	09a00593          	li	a1,154
ffffffffc020305c:	00003517          	auipc	a0,0x3
ffffffffc0203060:	2b450513          	addi	a0,a0,692 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203064:	becfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203068:	00003697          	auipc	a3,0x3
ffffffffc020306c:	46068693          	addi	a3,a3,1120 # ffffffffc02064c8 <default_pmm_manager+0x8e0>
ffffffffc0203070:	00002617          	auipc	a2,0x2
ffffffffc0203074:	7e060613          	addi	a2,a2,2016 # ffffffffc0205850 <commands+0x870>
ffffffffc0203078:	09c00593          	li	a1,156
ffffffffc020307c:	00003517          	auipc	a0,0x3
ffffffffc0203080:	29450513          	addi	a0,a0,660 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203084:	bccfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==3);
ffffffffc0203088:	00003697          	auipc	a3,0x3
ffffffffc020308c:	44068693          	addi	a3,a3,1088 # ffffffffc02064c8 <default_pmm_manager+0x8e0>
ffffffffc0203090:	00002617          	auipc	a2,0x2
ffffffffc0203094:	7c060613          	addi	a2,a2,1984 # ffffffffc0205850 <commands+0x870>
ffffffffc0203098:	09e00593          	li	a1,158
ffffffffc020309c:	00003517          	auipc	a0,0x3
ffffffffc02030a0:	27450513          	addi	a0,a0,628 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02030a4:	bacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030a8:	00003697          	auipc	a3,0x3
ffffffffc02030ac:	40068693          	addi	a3,a3,1024 # ffffffffc02064a8 <default_pmm_manager+0x8c0>
ffffffffc02030b0:	00002617          	auipc	a2,0x2
ffffffffc02030b4:	7a060613          	addi	a2,a2,1952 # ffffffffc0205850 <commands+0x870>
ffffffffc02030b8:	09400593          	li	a1,148
ffffffffc02030bc:	00003517          	auipc	a0,0x3
ffffffffc02030c0:	25450513          	addi	a0,a0,596 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02030c4:	b8cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==1);
ffffffffc02030c8:	00003697          	auipc	a3,0x3
ffffffffc02030cc:	3e068693          	addi	a3,a3,992 # ffffffffc02064a8 <default_pmm_manager+0x8c0>
ffffffffc02030d0:	00002617          	auipc	a2,0x2
ffffffffc02030d4:	78060613          	addi	a2,a2,1920 # ffffffffc0205850 <commands+0x870>
ffffffffc02030d8:	09600593          	li	a1,150
ffffffffc02030dc:	00003517          	auipc	a0,0x3
ffffffffc02030e0:	23450513          	addi	a0,a0,564 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02030e4:	b6cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc02030e8:	00003697          	auipc	a3,0x3
ffffffffc02030ec:	3f068693          	addi	a3,a3,1008 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc02030f0:	00002617          	auipc	a2,0x2
ffffffffc02030f4:	76060613          	addi	a2,a2,1888 # ffffffffc0205850 <commands+0x870>
ffffffffc02030f8:	0a000593          	li	a1,160
ffffffffc02030fc:	00003517          	auipc	a0,0x3
ffffffffc0203100:	21450513          	addi	a0,a0,532 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203104:	b4cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgfault_num==4);
ffffffffc0203108:	00003697          	auipc	a3,0x3
ffffffffc020310c:	3d068693          	addi	a3,a3,976 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc0203110:	00002617          	auipc	a2,0x2
ffffffffc0203114:	74060613          	addi	a2,a2,1856 # ffffffffc0205850 <commands+0x870>
ffffffffc0203118:	0a200593          	li	a1,162
ffffffffc020311c:	00003517          	auipc	a0,0x3
ffffffffc0203120:	1f450513          	addi	a0,a0,500 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203124:	b2cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203128:	00003697          	auipc	a3,0x3
ffffffffc020312c:	26068693          	addi	a3,a3,608 # ffffffffc0206388 <default_pmm_manager+0x7a0>
ffffffffc0203130:	00002617          	auipc	a2,0x2
ffffffffc0203134:	72060613          	addi	a2,a2,1824 # ffffffffc0205850 <commands+0x870>
ffffffffc0203138:	0cd00593          	li	a1,205
ffffffffc020313c:	00003517          	auipc	a0,0x3
ffffffffc0203140:	1d450513          	addi	a0,a0,468 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203144:	b0cfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(vma != NULL);
ffffffffc0203148:	00003697          	auipc	a3,0x3
ffffffffc020314c:	25068693          	addi	a3,a3,592 # ffffffffc0206398 <default_pmm_manager+0x7b0>
ffffffffc0203150:	00002617          	auipc	a2,0x2
ffffffffc0203154:	70060613          	addi	a2,a2,1792 # ffffffffc0205850 <commands+0x870>
ffffffffc0203158:	0d000593          	li	a1,208
ffffffffc020315c:	00003517          	auipc	a0,0x3
ffffffffc0203160:	1b450513          	addi	a0,a0,436 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203164:	aecfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203168:	00003697          	auipc	a3,0x3
ffffffffc020316c:	27868693          	addi	a3,a3,632 # ffffffffc02063e0 <default_pmm_manager+0x7f8>
ffffffffc0203170:	00002617          	auipc	a2,0x2
ffffffffc0203174:	6e060613          	addi	a2,a2,1760 # ffffffffc0205850 <commands+0x870>
ffffffffc0203178:	0d800593          	li	a1,216
ffffffffc020317c:	00003517          	auipc	a0,0x3
ffffffffc0203180:	19450513          	addi	a0,a0,404 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc0203184:	accfd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert( nr_free == 0);         
ffffffffc0203188:	00003697          	auipc	a3,0x3
ffffffffc020318c:	8a068693          	addi	a3,a3,-1888 # ffffffffc0205a28 <commands+0xa48>
ffffffffc0203190:	00002617          	auipc	a2,0x2
ffffffffc0203194:	6c060613          	addi	a2,a2,1728 # ffffffffc0205850 <commands+0x870>
ffffffffc0203198:	0f400593          	li	a1,244
ffffffffc020319c:	00003517          	auipc	a0,0x3
ffffffffc02031a0:	17450513          	addi	a0,a0,372 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02031a4:	aacfd0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc02031a8:	00003617          	auipc	a2,0x3
ffffffffc02031ac:	a9060613          	addi	a2,a2,-1392 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02031b0:	06800593          	li	a1,104
ffffffffc02031b4:	00003517          	auipc	a0,0x3
ffffffffc02031b8:	aac50513          	addi	a0,a0,-1364 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02031bc:	a94fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(count==0);
ffffffffc02031c0:	00003697          	auipc	a3,0x3
ffffffffc02031c4:	39868693          	addi	a3,a3,920 # ffffffffc0206558 <default_pmm_manager+0x970>
ffffffffc02031c8:	00002617          	auipc	a2,0x2
ffffffffc02031cc:	68860613          	addi	a2,a2,1672 # ffffffffc0205850 <commands+0x870>
ffffffffc02031d0:	11c00593          	li	a1,284
ffffffffc02031d4:	00003517          	auipc	a0,0x3
ffffffffc02031d8:	13c50513          	addi	a0,a0,316 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02031dc:	a74fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total==0);
ffffffffc02031e0:	00003697          	auipc	a3,0x3
ffffffffc02031e4:	38868693          	addi	a3,a3,904 # ffffffffc0206568 <default_pmm_manager+0x980>
ffffffffc02031e8:	00002617          	auipc	a2,0x2
ffffffffc02031ec:	66860613          	addi	a2,a2,1640 # ffffffffc0205850 <commands+0x870>
ffffffffc02031f0:	11d00593          	li	a1,285
ffffffffc02031f4:	00003517          	auipc	a0,0x3
ffffffffc02031f8:	11c50513          	addi	a0,a0,284 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc02031fc:	a54fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203200:	00003697          	auipc	a3,0x3
ffffffffc0203204:	25868693          	addi	a3,a3,600 # ffffffffc0206458 <default_pmm_manager+0x870>
ffffffffc0203208:	00002617          	auipc	a2,0x2
ffffffffc020320c:	64860613          	addi	a2,a2,1608 # ffffffffc0205850 <commands+0x870>
ffffffffc0203210:	0eb00593          	li	a1,235
ffffffffc0203214:	00003517          	auipc	a0,0x3
ffffffffc0203218:	0fc50513          	addi	a0,a0,252 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc020321c:	a34fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(mm != NULL);
ffffffffc0203220:	00003697          	auipc	a3,0x3
ffffffffc0203224:	14068693          	addi	a3,a3,320 # ffffffffc0206360 <default_pmm_manager+0x778>
ffffffffc0203228:	00002617          	auipc	a2,0x2
ffffffffc020322c:	62860613          	addi	a2,a2,1576 # ffffffffc0205850 <commands+0x870>
ffffffffc0203230:	0c500593          	li	a1,197
ffffffffc0203234:	00003517          	auipc	a0,0x3
ffffffffc0203238:	0dc50513          	addi	a0,a0,220 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc020323c:	a14fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203240:	00003697          	auipc	a3,0x3
ffffffffc0203244:	13068693          	addi	a3,a3,304 # ffffffffc0206370 <default_pmm_manager+0x788>
ffffffffc0203248:	00002617          	auipc	a2,0x2
ffffffffc020324c:	60860613          	addi	a2,a2,1544 # ffffffffc0205850 <commands+0x870>
ffffffffc0203250:	0c800593          	li	a1,200
ffffffffc0203254:	00003517          	auipc	a0,0x3
ffffffffc0203258:	0bc50513          	addi	a0,a0,188 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc020325c:	9f4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(ret==0);
ffffffffc0203260:	00003697          	auipc	a3,0x3
ffffffffc0203264:	2f068693          	addi	a3,a3,752 # ffffffffc0206550 <default_pmm_manager+0x968>
ffffffffc0203268:	00002617          	auipc	a2,0x2
ffffffffc020326c:	5e860613          	addi	a2,a2,1512 # ffffffffc0205850 <commands+0x870>
ffffffffc0203270:	10300593          	li	a1,259
ffffffffc0203274:	00003517          	auipc	a0,0x3
ffffffffc0203278:	09c50513          	addi	a0,a0,156 # ffffffffc0206310 <default_pmm_manager+0x728>
ffffffffc020327c:	9d4fd0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203280:	00002697          	auipc	a3,0x2
ffffffffc0203284:	60068693          	addi	a3,a3,1536 # ffffffffc0205880 <commands+0x8a0>
ffffffffc0203288:	00002617          	auipc	a2,0x2
ffffffffc020328c:	5c860613          	addi	a2,a2,1480 # ffffffffc0205850 <commands+0x870>
ffffffffc0203290:	0c000593          	li	a1,192
ffffffffc0203294:	00003517          	auipc	a0,0x3
ffffffffc0203298:	07c50513          	addi	a0,a0,124 # ffffffffc0206310 <default_pmm_manager+0x728>
...
ffffffffc02032ec:	310b0b13          	addi	s6,s6,784 # ffffffffc02065f8 <default_pmm_manager+0xa10>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032f0:	00003b97          	auipc	s7,0x3
ffffffffc02032f4:	2f0b8b93          	addi	s7,s7,752 # ffffffffc02065e0 <default_pmm_manager+0x9f8>
...
ffffffffc0203364:	5dd000ef          	jal	ra,ffffffffc0204140 <swapfs_write>
...
ffffffffc02033a6:	1f650513          	addi	a0,a0,502 # ffffffffc0206598 <default_pmm_manager+0x9b0>
...
ffffffffc02033b8:	21468693          	addi	a3,a3,532 # ffffffffc02065c8 <default_pmm_manager+0x9e0>
ffffffffc02033bc:	00002617          	auipc	a2,0x2
ffffffffc02033c0:	49460613          	addi	a2,a2,1172 # ffffffffc0205850 <commands+0x870>
ffffffffc02033c4:	06900593          	li	a1,105
ffffffffc02033c8:	00003517          	auipc	a0,0x3
ffffffffc02033cc:	f4850513          	addi	a0,a0,-184 # ffffffffc0206310 <default_pmm_manager+0x728>
...
ffffffffc0203402:	4a7000ef          	jal	ra,ffffffffc02040a8 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203406:	00093583          	ld	a1,0(s2)
ffffffffc020340a:	8626                	mv	a2,s1
ffffffffc020340c:	00003517          	auipc	a0,0x3
ffffffffc0203410:	ea450513          	addi	a0,a0,-348 # ffffffffc02062b0 <default_pmm_manager+0x6c8>
...
ffffffffc0203432:	e7268693          	addi	a3,a3,-398 # ffffffffc02062a0 <default_pmm_manager+0x6b8>
ffffffffc0203436:	00002617          	auipc	a2,0x2
ffffffffc020343a:	41a60613          	addi	a2,a2,1050 # ffffffffc0205850 <commands+0x870>
ffffffffc020343e:	07f00593          	li	a1,127
ffffffffc0203442:	00003517          	auipc	a0,0x3
ffffffffc0203446:	ece50513          	addi	a0,a0,-306 # ffffffffc0206310 <default_pmm_manager+0x728>
...
ffffffffc0203460 <_fifo_set_unswappable>:
...
ffffffffc0203464 <_fifo_tick_event>:
...
ffffffffc0203468 <_fifo_init>:
{
ffffffffc0203468:	1141                	addi	sp,sp,-16
    cprintf("activate _fifo_init.\n\n");
ffffffffc020346a:	00003517          	auipc	a0,0x3
ffffffffc020346e:	34650513          	addi	a0,a0,838 # ffffffffc02067b0 <default_pmm_manager+0xbc8>
{
...
ffffffffc020347a:	4501                	li	a0,0
ffffffffc020347c:	0141                	addi	sp,sp,16
ffffffffc020347e:	8082                	ret

ffffffffc0203480 <_fifo_check_swap>:
_fifo_check_swap(void) {
ffffffffc0203480:	711d                	addi	sp,sp,-96
ffffffffc0203482:	fc4e                	sd	s3,56(sp)
ffffffffc0203484:	f852                	sd	s4,48(sp)
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc0203486:	00003517          	auipc	a0,0x3
ffffffffc020348a:	1b250513          	addi	a0,a0,434 # ffffffffc0206638 <default_pmm_manager+0xa50>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc020348e:	698d                	lui	s3,0x3
ffffffffc0203490:	4a31                	li	s4,12
_fifo_check_swap(void) {
ffffffffc0203492:	e8a2                	sd	s0,80(sp)
ffffffffc0203494:	e4a6                	sd	s1,72(sp)
ffffffffc0203496:	ec86                	sd	ra,88(sp)
ffffffffc0203498:	e0ca                	sd	s2,64(sp)
ffffffffc020349a:	f456                	sd	s5,40(sp)
ffffffffc020349c:	f05a                	sd	s6,32(sp)
ffffffffc020349e:	ec5e                	sd	s7,24(sp)
ffffffffc02034a0:	e862                	sd	s8,16(sp)
ffffffffc02034a2:	e466                	sd	s9,8(sp)
    assert(pgfault_num==4);
ffffffffc02034a4:	00012417          	auipc	s0,0x12
ffffffffc02034a8:	00040413          	mv	s0,s0
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc02034ac:	ce3fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc02034b0:	01498023          	sb	s4,0(s3) # 3000 <BASE_ADDRESS-0xffffffffc01fd000>
    assert(pgfault_num==4);
ffffffffc02034b4:	4004                	lw	s1,0(s0)
ffffffffc02034b6:	4791                	li	a5,4
ffffffffc02034b8:	2481                	sext.w	s1,s1
ffffffffc02034ba:	14f49963          	bne	s1,a5,ffffffffc020360c <_fifo_check_swap+0x18c>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc02034be:	00003517          	auipc	a0,0x3
ffffffffc02034c2:	1ba50513          	addi	a0,a0,442 # ffffffffc0206678 <default_pmm_manager+0xa90>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc02034c6:	6a85                	lui	s5,0x1
ffffffffc02034c8:	4b29                	li	s6,10
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc02034ca:	cc5fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc02034ce:	016a8023          	sb	s6,0(s5) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
    assert(pgfault_num==4);
ffffffffc02034d2:	00042903          	lw	s2,0(s0) # ffffffffc02154a4 <pgfault_num>
ffffffffc02034d6:	2901                	sext.w	s2,s2
ffffffffc02034d8:	2a991a63          	bne	s2,s1,ffffffffc020378c <_fifo_check_swap+0x30c>
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc02034dc:	00003517          	auipc	a0,0x3
ffffffffc02034e0:	1c450513          	addi	a0,a0,452 # ffffffffc02066a0 <default_pmm_manager+0xab8>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02034e4:	6b91                	lui	s7,0x4
ffffffffc02034e6:	4c35                	li	s8,13
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc02034e8:	ca7fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02034ec:	018b8023          	sb	s8,0(s7) # 4000 <BASE_ADDRESS-0xffffffffc01fc000>
    assert(pgfault_num==4);
ffffffffc02034f0:	4004                	lw	s1,0(s0)
ffffffffc02034f2:	2481                	sext.w	s1,s1
ffffffffc02034f4:	27249c63          	bne	s1,s2,ffffffffc020376c <_fifo_check_swap+0x2ec>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc02034f8:	00003517          	auipc	a0,0x3
ffffffffc02034fc:	1d050513          	addi	a0,a0,464 # ffffffffc02066c8 <default_pmm_manager+0xae0>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203500:	6909                	lui	s2,0x2
ffffffffc0203502:	4cad                	li	s9,11
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc0203504:	c8bfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203508:	01990023          	sb	s9,0(s2) # 2000 <BASE_ADDRESS-0xffffffffc01fe000>
    assert(pgfault_num==4);
ffffffffc020350c:	401c                	lw	a5,0(s0)
ffffffffc020350e:	2781                	sext.w	a5,a5
ffffffffc0203510:	22979e63          	bne	a5,s1,ffffffffc020374c <_fifo_check_swap+0x2cc>
    cprintf("write Virt Page e in fifo_check_swap\n");
ffffffffc0203514:	00003517          	auipc	a0,0x3
ffffffffc0203518:	1dc50513          	addi	a0,a0,476 # ffffffffc02066f0 <default_pmm_manager+0xb08>
ffffffffc020351c:	c73fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc0203520:	6795                	lui	a5,0x5
ffffffffc0203522:	4739                	li	a4,14
ffffffffc0203524:	00e78023          	sb	a4,0(a5) # 5000 <BASE_ADDRESS-0xffffffffc01fb000>
    assert(pgfault_num==5);
ffffffffc0203528:	4004                	lw	s1,0(s0)
ffffffffc020352a:	4795                	li	a5,5
ffffffffc020352c:	2481                	sext.w	s1,s1
ffffffffc020352e:	1ef49f63          	bne	s1,a5,ffffffffc020372c <_fifo_check_swap+0x2ac>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc0203532:	00003517          	auipc	a0,0x3
ffffffffc0203536:	19650513          	addi	a0,a0,406 # ffffffffc02066c8 <default_pmm_manager+0xae0>
ffffffffc020353a:	c55fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc020353e:	01990023          	sb	s9,0(s2)
    assert(pgfault_num==5);
ffffffffc0203542:	401c                	lw	a5,0(s0)
ffffffffc0203544:	2781                	sext.w	a5,a5
ffffffffc0203546:	1c979363          	bne	a5,s1,ffffffffc020370c <_fifo_check_swap+0x28c>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc020354a:	00003517          	auipc	a0,0x3
ffffffffc020354e:	12e50513          	addi	a0,a0,302 # ffffffffc0206678 <default_pmm_manager+0xa90>
ffffffffc0203552:	c3dfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203556:	016a8023          	sb	s6,0(s5)
    assert(pgfault_num==6);
ffffffffc020355a:	401c                	lw	a5,0(s0)
ffffffffc020355c:	4719                	li	a4,6
ffffffffc020355e:	2781                	sext.w	a5,a5
ffffffffc0203560:	18e79663          	bne	a5,a4,ffffffffc02036ec <_fifo_check_swap+0x26c>
    cprintf("write Virt Page b in fifo_check_swap\n");
ffffffffc0203564:	00003517          	auipc	a0,0x3
ffffffffc0203568:	16450513          	addi	a0,a0,356 # ffffffffc02066c8 <default_pmm_manager+0xae0>
ffffffffc020356c:	c23fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203570:	01990023          	sb	s9,0(s2)
    assert(pgfault_num==7);
ffffffffc0203574:	401c                	lw	a5,0(s0)
ffffffffc0203576:	471d                	li	a4,7
ffffffffc0203578:	2781                	sext.w	a5,a5
ffffffffc020357a:	14e79963          	bne	a5,a4,ffffffffc02036cc <_fifo_check_swap+0x24c>
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc020357e:	00003517          	auipc	a0,0x3
ffffffffc0203582:	0ba50513          	addi	a0,a0,186 # ffffffffc0206638 <default_pmm_manager+0xa50>
ffffffffc0203586:	c09fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc020358a:	01498023          	sb	s4,0(s3)
    assert(pgfault_num==8);
ffffffffc020358e:	401c                	lw	a5,0(s0)
ffffffffc0203590:	4721                	li	a4,8
ffffffffc0203592:	2781                	sext.w	a5,a5
ffffffffc0203594:	10e79c63          	bne	a5,a4,ffffffffc02036ac <_fifo_check_swap+0x22c>
    cprintf("write Virt Page d in fifo_check_swap\n");
ffffffffc0203598:	00003517          	auipc	a0,0x3
ffffffffc020359c:	10850513          	addi	a0,a0,264 # ffffffffc02066a0 <default_pmm_manager+0xab8>
ffffffffc02035a0:	beffc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc02035a4:	018b8023          	sb	s8,0(s7)
    assert(pgfault_num==9);
ffffffffc02035a8:	401c                	lw	a5,0(s0)
ffffffffc02035aa:	4725                	li	a4,9
ffffffffc02035ac:	2781                	sext.w	a5,a5
ffffffffc02035ae:	0ce79f63          	bne	a5,a4,ffffffffc020368c <_fifo_check_swap+0x20c>
    cprintf("write Virt Page e in fifo_check_swap\n");
ffffffffc02035b2:	00003517          	auipc	a0,0x3
ffffffffc02035b6:	13e50513          	addi	a0,a0,318 # ffffffffc02066f0 <default_pmm_manager+0xb08>
ffffffffc02035ba:	bd5fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc02035be:	6795                	lui	a5,0x5
ffffffffc02035c0:	4739                	li	a4,14
ffffffffc02035c2:	00e78023          	sb	a4,0(a5) # 5000 <BASE_ADDRESS-0xffffffffc01fb000>
    assert(pgfault_num==10);
ffffffffc02035c6:	4004                	lw	s1,0(s0)
ffffffffc02035c8:	47a9                	li	a5,10
ffffffffc02035ca:	2481                	sext.w	s1,s1
ffffffffc02035cc:	0af49063          	bne	s1,a5,ffffffffc020366c <_fifo_check_swap+0x1ec>
    cprintf("write Virt Page a in fifo_check_swap\n");
ffffffffc02035d0:	00003517          	auipc	a0,0x3
ffffffffc02035d4:	0a850513          	addi	a0,a0,168 # ffffffffc0206678 <default_pmm_manager+0xa90>
ffffffffc02035d8:	bb7fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc02035dc:	6785                	lui	a5,0x1
ffffffffc02035de:	0007c783          	lbu	a5,0(a5) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc02035e2:	06979563          	bne	a5,s1,ffffffffc020364c <_fifo_check_swap+0x1cc>
    assert(pgfault_num==11);
ffffffffc02035e6:	401c                	lw	a5,0(s0)
ffffffffc02035e8:	472d                	li	a4,11
ffffffffc02035ea:	2781                	sext.w	a5,a5
ffffffffc02035ec:	04e79063          	bne	a5,a4,ffffffffc020362c <_fifo_check_swap+0x1ac>
}
ffffffffc02035f0:	60e6                	ld	ra,88(sp)
ffffffffc02035f2:	6446                	ld	s0,80(sp)
ffffffffc02035f4:	64a6                	ld	s1,72(sp)
ffffffffc02035f6:	6906                	ld	s2,64(sp)
ffffffffc02035f8:	79e2                	ld	s3,56(sp)
ffffffffc02035fa:	7a42                	ld	s4,48(sp)
ffffffffc02035fc:	7aa2                	ld	s5,40(sp)
ffffffffc02035fe:	7b02                	ld	s6,32(sp)
ffffffffc0203600:	6be2                	ld	s7,24(sp)
ffffffffc0203602:	6c42                	ld	s8,16(sp)
ffffffffc0203604:	6ca2                	ld	s9,8(sp)
ffffffffc0203606:	4501                	li	a0,0
ffffffffc0203608:	6125                	addi	sp,sp,96
ffffffffc020360a:	8082                	ret
    assert(pgfault_num==4);
ffffffffc020360c:	00003697          	auipc	a3,0x3
ffffffffc0203610:	ecc68693          	addi	a3,a3,-308 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc0203614:	00002617          	auipc	a2,0x2
ffffffffc0203618:	23c60613          	addi	a2,a2,572 # ffffffffc0205850 <commands+0x870>
ffffffffc020361c:	05100593          	li	a1,81
ffffffffc0203620:	00003517          	auipc	a0,0x3
ffffffffc0203624:	04050513          	addi	a0,a0,64 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203628:	e29fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==11);
ffffffffc020362c:	00003697          	auipc	a3,0x3
ffffffffc0203630:	17468693          	addi	a3,a3,372 # ffffffffc02067a0 <default_pmm_manager+0xbb8>
ffffffffc0203634:	00002617          	auipc	a2,0x2
ffffffffc0203638:	21c60613          	addi	a2,a2,540 # ffffffffc0205850 <commands+0x870>
ffffffffc020363c:	07300593          	li	a1,115
ffffffffc0203640:	00003517          	auipc	a0,0x3
ffffffffc0203644:	02050513          	addi	a0,a0,32 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203648:	e09fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020364c:	00003697          	auipc	a3,0x3
ffffffffc0203650:	12c68693          	addi	a3,a3,300 # ffffffffc0206778 <default_pmm_manager+0xb90>
ffffffffc0203654:	00002617          	auipc	a2,0x2
ffffffffc0203658:	1fc60613          	addi	a2,a2,508 # ffffffffc0205850 <commands+0x870>
ffffffffc020365c:	07100593          	li	a1,113
ffffffffc0203660:	00003517          	auipc	a0,0x3
ffffffffc0203664:	00050513          	mv	a0,a0
ffffffffc0203668:	de9fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==10);
ffffffffc020366c:	00003697          	auipc	a3,0x3
ffffffffc0203670:	0fc68693          	addi	a3,a3,252 # ffffffffc0206768 <default_pmm_manager+0xb80>
ffffffffc0203674:	00002617          	auipc	a2,0x2
ffffffffc0203678:	1dc60613          	addi	a2,a2,476 # ffffffffc0205850 <commands+0x870>
ffffffffc020367c:	06f00593          	li	a1,111
ffffffffc0203680:	00003517          	auipc	a0,0x3
ffffffffc0203684:	fe050513          	addi	a0,a0,-32 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203688:	dc9fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==9);
ffffffffc020368c:	00003697          	auipc	a3,0x3
ffffffffc0203690:	0cc68693          	addi	a3,a3,204 # ffffffffc0206758 <default_pmm_manager+0xb70>
ffffffffc0203694:	00002617          	auipc	a2,0x2
ffffffffc0203698:	1bc60613          	addi	a2,a2,444 # ffffffffc0205850 <commands+0x870>
ffffffffc020369c:	06c00593          	li	a1,108
ffffffffc02036a0:	00003517          	auipc	a0,0x3
ffffffffc02036a4:	fc050513          	addi	a0,a0,-64 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc02036a8:	da9fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==8);
ffffffffc02036ac:	00003697          	auipc	a3,0x3
ffffffffc02036b0:	09c68693          	addi	a3,a3,156 # ffffffffc0206748 <default_pmm_manager+0xb60>
ffffffffc02036b4:	00002617          	auipc	a2,0x2
ffffffffc02036b8:	19c60613          	addi	a2,a2,412 # ffffffffc0205850 <commands+0x870>
ffffffffc02036bc:	06900593          	li	a1,105
ffffffffc02036c0:	00003517          	auipc	a0,0x3
ffffffffc02036c4:	fa050513          	addi	a0,a0,-96 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc02036c8:	d89fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==7);
ffffffffc02036cc:	00003697          	auipc	a3,0x3
ffffffffc02036d0:	06c68693          	addi	a3,a3,108 # ffffffffc0206738 <default_pmm_manager+0xb50>
ffffffffc02036d4:	00002617          	auipc	a2,0x2
ffffffffc02036d8:	17c60613          	addi	a2,a2,380 # ffffffffc0205850 <commands+0x870>
ffffffffc02036dc:	06600593          	li	a1,102
ffffffffc02036e0:	00003517          	auipc	a0,0x3
ffffffffc02036e4:	f8050513          	addi	a0,a0,-128 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc02036e8:	d69fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==6);
ffffffffc02036ec:	00003697          	auipc	a3,0x3
ffffffffc02036f0:	03c68693          	addi	a3,a3,60 # ffffffffc0206728 <default_pmm_manager+0xb40>
ffffffffc02036f4:	00002617          	auipc	a2,0x2
ffffffffc02036f8:	15c60613          	addi	a2,a2,348 # ffffffffc0205850 <commands+0x870>
ffffffffc02036fc:	06300593          	li	a1,99
ffffffffc0203700:	00003517          	auipc	a0,0x3
ffffffffc0203704:	f6050513          	addi	a0,a0,-160 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203708:	d49fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc020370c:	00003697          	auipc	a3,0x3
ffffffffc0203710:	00c68693          	addi	a3,a3,12 # ffffffffc0206718 <default_pmm_manager+0xb30>
ffffffffc0203714:	00002617          	auipc	a2,0x2
ffffffffc0203718:	13c60613          	addi	a2,a2,316 # ffffffffc0205850 <commands+0x870>
ffffffffc020371c:	06000593          	li	a1,96
ffffffffc0203720:	00003517          	auipc	a0,0x3
ffffffffc0203724:	f4050513          	addi	a0,a0,-192 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203728:	d29fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==5);
ffffffffc020372c:	00003697          	auipc	a3,0x3
ffffffffc0203730:	fec68693          	addi	a3,a3,-20 # ffffffffc0206718 <default_pmm_manager+0xb30>
ffffffffc0203734:	00002617          	auipc	a2,0x2
ffffffffc0203738:	11c60613          	addi	a2,a2,284 # ffffffffc0205850 <commands+0x870>
ffffffffc020373c:	05d00593          	li	a1,93
ffffffffc0203740:	00003517          	auipc	a0,0x3
ffffffffc0203744:	f2050513          	addi	a0,a0,-224 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203748:	d09fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc020374c:	00003697          	auipc	a3,0x3
ffffffffc0203750:	d8c68693          	addi	a3,a3,-628 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc0203754:	00002617          	auipc	a2,0x2
ffffffffc0203758:	0fc60613          	addi	a2,a2,252 # ffffffffc0205850 <commands+0x870>
ffffffffc020375c:	05a00593          	li	a1,90
ffffffffc0203760:	00003517          	auipc	a0,0x3
ffffffffc0203764:	f0050513          	addi	a0,a0,-256 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203768:	ce9fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc020376c:	00003697          	auipc	a3,0x3
ffffffffc0203770:	d6c68693          	addi	a3,a3,-660 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc0203774:	00002617          	auipc	a2,0x2
ffffffffc0203778:	0dc60613          	addi	a2,a2,220 # ffffffffc0205850 <commands+0x870>
ffffffffc020377c:	05700593          	li	a1,87
ffffffffc0203780:	00003517          	auipc	a0,0x3
ffffffffc0203784:	ee050513          	addi	a0,a0,-288 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc0203788:	cc9fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgfault_num==4);
ffffffffc020378c:	00003697          	auipc	a3,0x3
ffffffffc0203790:	d4c68693          	addi	a3,a3,-692 # ffffffffc02064d8 <default_pmm_manager+0x8f0>
ffffffffc0203794:	00002617          	auipc	a2,0x2
ffffffffc0203798:	0bc60613          	addi	a2,a2,188 # ffffffffc0205850 <commands+0x870>
ffffffffc020379c:	05400593          	li	a1,84
ffffffffc02037a0:	00003517          	auipc	a0,0x3
ffffffffc02037a4:	ec050513          	addi	a0,a0,-320 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc02037a8:	ca9fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02037ac <_fifo_swap_out_victim>:
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02037ac:	751c                	ld	a5,40(a0)
{
ffffffffc02037ae:	1141                	addi	sp,sp,-16
ffffffffc02037b0:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc02037b2:	cf91                	beqz	a5,ffffffffc02037ce <_fifo_swap_out_victim+0x22>
     assert(in_tick==0);
ffffffffc02037b4:	ee0d                	bnez	a2,ffffffffc02037ee <_fifo_swap_out_victim+0x42>
    return listelm->next;
ffffffffc02037b6:	679c                	ld	a5,8(a5)
}
ffffffffc02037b8:	60a2                	ld	ra,8(sp)
ffffffffc02037ba:	4501                	li	a0,0
    __list_del(listelm->prev, listelm->next);
ffffffffc02037bc:	6394                	ld	a3,0(a5)
ffffffffc02037be:	6798                	ld	a4,8(a5)
    *ptr_page = le2page(entry, pra_page_link);
ffffffffc02037c0:	fd878793          	addi	a5,a5,-40
    prev->next = next;
ffffffffc02037c4:	e698                	sd	a4,8(a3)
    next->prev = prev;
ffffffffc02037c6:	e314                	sd	a3,0(a4)
ffffffffc02037c8:	e19c                	sd	a5,0(a1)
}
ffffffffc02037ca:	0141                	addi	sp,sp,16
ffffffffc02037cc:	8082                	ret
         assert(head != NULL);
ffffffffc02037ce:	00003697          	auipc	a3,0x3
ffffffffc02037d2:	01a68693          	addi	a3,a3,26 # ffffffffc02067e8 <default_pmm_manager+0xc00>
ffffffffc02037d6:	00002617          	auipc	a2,0x2
ffffffffc02037da:	07a60613          	addi	a2,a2,122 # ffffffffc0205850 <commands+0x870>
ffffffffc02037de:	04100593          	li	a1,65
ffffffffc02037e2:	00003517          	auipc	a0,0x3
ffffffffc02037e6:	e7e50513          	addi	a0,a0,-386 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc02037ea:	c67fc0ef          	jal	ra,ffffffffc0200450 <__panic>
     assert(in_tick==0);
ffffffffc02037ee:	00003697          	auipc	a3,0x3
ffffffffc02037f2:	00a68693          	addi	a3,a3,10 # ffffffffc02067f8 <default_pmm_manager+0xc10>
ffffffffc02037f6:	00002617          	auipc	a2,0x2
ffffffffc02037fa:	05a60613          	addi	a2,a2,90 # ffffffffc0205850 <commands+0x870>
ffffffffc02037fe:	04200593          	li	a1,66
ffffffffc0203802:	00003517          	auipc	a0,0x3
ffffffffc0203806:	e5e50513          	addi	a0,a0,-418 # ffffffffc0206660 <default_pmm_manager+0xa78>
ffffffffc020380a:	c47fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020380e <_fifo_map_swappable>:
    list_entry_t *entry=&(page->pra_page_link);
ffffffffc020380e:	02860713          	addi	a4,a2,40
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203812:	751c                	ld	a5,40(a0)
    assert(entry != NULL && head != NULL);
ffffffffc0203814:	cb09                	beqz	a4,ffffffffc0203826 <_fifo_map_swappable+0x18>
ffffffffc0203816:	cb81                	beqz	a5,ffffffffc0203826 <_fifo_map_swappable+0x18>
    __list_add(elm, listelm->prev, listelm);
...
ffffffffc020381e:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0203820:	fa1c                	sd	a5,48(a2)
    elm->prev = prev;
ffffffffc0203822:	f614                	sd	a3,40(a2)
ffffffffc0203824:	8082                	ret
{
ffffffffc0203826:	1141                	addi	sp,sp,-16
    assert(entry != NULL && head != NULL);
ffffffffc0203828:	00003697          	auipc	a3,0x3
ffffffffc020382c:	fa068693          	addi	a3,a3,-96 # ffffffffc02067c8 <default_pmm_manager+0xbe0>
ffffffffc0203830:	00002617          	auipc	a2,0x2
ffffffffc0203834:	02060613          	addi	a2,a2,32 # ffffffffc0205850 <commands+0x870>
ffffffffc0203838:	03200593          	li	a1,50
ffffffffc020383c:	00003517          	auipc	a0,0x3
ffffffffc0203840:	e2450513          	addi	a0,a0,-476 # ffffffffc0206660 <default_pmm_manager+0xa78>
{
ffffffffc0203844:	e406                	sd	ra,8(sp)
    assert(entry != NULL && head != NULL);
ffffffffc0203846:	c0bfc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020384a <check_vma_overlap.isra.0.part.1>:
}
...
ffffffffc0203850:	fd468693          	addi	a3,a3,-44 # ffffffffc0206820 <default_pmm_manager+0xc38>
ffffffffc0203854:	00002617          	auipc	a2,0x2
ffffffffc0203858:	ffc60613          	addi	a2,a2,-4 # ffffffffc0205850 <commands+0x870>
ffffffffc020385c:	07e00593          	li	a1,126
ffffffffc0203860:	00003517          	auipc	a0,0x3
ffffffffc0203864:	fe050513          	addi	a0,a0,-32 # ffffffffc0206840 <default_pmm_manager+0xc58>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc0203868:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020386a:	be7fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc020386e <mm_create>:
mm_create(void) {
ffffffffc020386e:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203870:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203874:	e022                	sd	s0,0(sp)
ffffffffc0203876:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203878:	922fe0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc020387c:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc020387e:	c115                	beqz	a0,ffffffffc02038a2 <mm_create+0x34>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203880:	00012797          	auipc	a5,0x12
ffffffffc0203884:	c2078793          	addi	a5,a5,-992 # ffffffffc02154a0 <swap_init_ok>
ffffffffc0203888:	439c                	lw	a5,0(a5)
    elm->prev = elm->next = elm;
ffffffffc020388a:	e408                	sd	a0,8(s0)
ffffffffc020388c:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
...
ffffffffc020389c:	eb81                	bnez	a5,ffffffffc02038ac <mm_create+0x3e>
        else mm->sm_priv = NULL;
ffffffffc020389e:	02053423          	sd	zero,40(a0)
}
ffffffffc02038a2:	8522                	mv	a0,s0
ffffffffc02038a4:	60a2                	ld	ra,8(sp)
ffffffffc02038a6:	6402                	ld	s0,0(sp)
ffffffffc02038a8:	0141                	addi	sp,sp,16
ffffffffc02038aa:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038ac:	9f5ff0ef          	jal	ra,ffffffffc02032a0 <swap_init_mm>
}
ffffffffc02038b0:	8522                	mv	a0,s0
ffffffffc02038b2:	60a2                	ld	ra,8(sp)
ffffffffc02038b4:	6402                	ld	s0,0(sp)
ffffffffc02038b6:	0141                	addi	sp,sp,16
ffffffffc02038b8:	8082                	ret

ffffffffc02038ba <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint32_t vm_flags) {
ffffffffc02038ba:	1101                	addi	sp,sp,-32
ffffffffc02038bc:	e04a                	sd	s2,0(sp)
ffffffffc02038be:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038c0:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint32_t vm_flags) {
ffffffffc02038c4:	e822                	sd	s0,16(sp)
ffffffffc02038c6:	e426                	sd	s1,8(sp)
ffffffffc02038c8:	ec06                	sd	ra,24(sp)
ffffffffc02038ca:	84ae                	mv	s1,a1
ffffffffc02038cc:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038ce:	8ccfe0ef          	jal	ra,ffffffffc020199a <kmalloc>
    if (vma != NULL) {
ffffffffc02038d2:	c509                	beqz	a0,ffffffffc02038dc <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02038d4:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02038d8:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02038da:	cd00                	sw	s0,24(a0)
}
...
ffffffffc02038e8 <find_vma>:
    if (mm != NULL) {
ffffffffc02038e8:	c51d                	beqz	a0,ffffffffc0203916 <find_vma+0x2e>
        vma = mm->mmap_cache;
ffffffffc02038ea:	691c                	ld	a5,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02038ec:	c781                	beqz	a5,ffffffffc02038f4 <find_vma+0xc>
ffffffffc02038ee:	6798                	ld	a4,8(a5)
ffffffffc02038f0:	02e5f663          	bleu	a4,a1,ffffffffc020391c <find_vma+0x34>
                list_entry_t *list = &(mm->mmap_list), *le = list;
ffffffffc02038f4:	87aa                	mv	a5,a0
    return listelm->next;
ffffffffc02038f6:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02038f8:	00f50f63          	beq	a0,a5,ffffffffc0203916 <find_vma+0x2e>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc02038fc:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203900:	fee5ebe3          	bltu	a1,a4,ffffffffc02038f6 <find_vma+0xe>
ffffffffc0203904:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203908:	fee5f7e3          	bleu	a4,a1,ffffffffc02038f6 <find_vma+0xe>
                    vma = le2vma(le, list_link);
ffffffffc020390c:	1781                	addi	a5,a5,-32
        if (vma != NULL) {
ffffffffc020390e:	c781                	beqz	a5,ffffffffc0203916 <find_vma+0x2e>
            mm->mmap_cache = vma;
ffffffffc0203910:	e91c                	sd	a5,16(a0)
}
ffffffffc0203912:	853e                	mv	a0,a5
ffffffffc0203914:	8082                	ret
    struct vma_struct *vma = NULL;
ffffffffc0203916:	4781                	li	a5,0
}
ffffffffc0203918:	853e                	mv	a0,a5
ffffffffc020391a:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020391c:	6b98                	ld	a4,16(a5)
ffffffffc020391e:	fce5fbe3          	bleu	a4,a1,ffffffffc02038f4 <find_vma+0xc>
            mm->mmap_cache = vma;
ffffffffc0203922:	e91c                	sd	a5,16(a0)
    return vma;
ffffffffc0203924:	b7fd                	j	ffffffffc0203912 <find_vma+0x2a>
...
ffffffffc0203928:	0105b803          	ld	a6,16(a1) # 1010 <BASE_ADDRESS-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020392c:	1141                	addi	sp,sp,-16
ffffffffc020392e:	e406                	sd	ra,8(sp)
ffffffffc0203930:	872a                	mv	a4,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203932:	01066863          	bltu	a2,a6,ffffffffc0203942 <insert_vma_struct+0x1c>
ffffffffc0203936:	a8b9                	j	ffffffffc0203994 <insert_vma_struct+0x6e>
...
ffffffffc0203938:	fe87b683          	ld	a3,-24(a5)
ffffffffc020393c:	04d66763          	bltu	a2,a3,ffffffffc020398a <insert_vma_struct+0x64>
ffffffffc0203940:	873e                	mv	a4,a5
ffffffffc0203942:	671c                	ld	a5,8(a4)
        while ((le = list_next(le)) != list) {
ffffffffc0203944:	fef51ae3          	bne	a0,a5,ffffffffc0203938 <insert_vma_struct+0x12>
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc0203948:	02a70463          	beq	a4,a0,ffffffffc0203970 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc020394c:	ff073683          	ld	a3,-16(a4)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203950:	fe873883          	ld	a7,-24(a4)
ffffffffc0203954:	08d8f063          	bleu	a3,a7,ffffffffc02039d4 <insert_vma_struct+0xae>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203958:	04d66e63          	bltu	a2,a3,ffffffffc02039b4 <insert_vma_struct+0x8e>
    }
    if (le_next != list) {
ffffffffc020395c:	00f50a63          	beq	a0,a5,ffffffffc0203970 <insert_vma_struct+0x4a>
ffffffffc0203960:	fe87b683          	ld	a3,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203964:	0506e863          	bltu	a3,a6,ffffffffc02039b4 <insert_vma_struct+0x8e>
    assert(next->vm_start < next->vm_end);
ffffffffc0203968:	ff07b603          	ld	a2,-16(a5)
ffffffffc020396c:	02c6f263          	bleu	a2,a3,ffffffffc0203990 <insert_vma_struct+0x6a>
    }
    ...
    mm->map_count ++;
ffffffffc0203970:	5114                	lw	a3,32(a0)
    vma->vm_mm = mm;
...
ffffffffc020397a:	e710                	sd	a2,8(a4)
}
ffffffffc020397c:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc020397e:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203980:	f198                	sd	a4,32(a1)
    mm->map_count ++;
ffffffffc0203982:	2685                	addiw	a3,a3,1
ffffffffc0203984:	d114                	sw	a3,32(a0)
}
ffffffffc0203986:	0141                	addi	sp,sp,16
ffffffffc0203988:	8082                	ret
    if (le_prev != list) {
ffffffffc020398a:	fca711e3          	bne	a4,a0,ffffffffc020394c <insert_vma_struct+0x26>
ffffffffc020398e:	bfd9                	j	ffffffffc0203964 <insert_vma_struct+0x3e>
ffffffffc0203990:	ebbff0ef          	jal	ra,ffffffffc020384a <check_vma_overlap.isra.0.part.1>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203994:	00003697          	auipc	a3,0x3
ffffffffc0203998:	f6c68693          	addi	a3,a3,-148 # ffffffffc0206900 <default_pmm_manager+0xd18>
ffffffffc020399c:	00002617          	auipc	a2,0x2
ffffffffc02039a0:	eb460613          	addi	a2,a2,-332 # ffffffffc0205850 <commands+0x870>
ffffffffc02039a4:	08500593          	li	a1,133
ffffffffc02039a8:	00003517          	auipc	a0,0x3
ffffffffc02039ac:	e9850513          	addi	a0,a0,-360 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc02039b0:	aa1fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039b4:	00003697          	auipc	a3,0x3
ffffffffc02039b8:	f8c68693          	addi	a3,a3,-116 # ffffffffc0206940 <default_pmm_manager+0xd58>
ffffffffc02039bc:	00002617          	auipc	a2,0x2
ffffffffc02039c0:	e9460613          	addi	a2,a2,-364 # ffffffffc0205850 <commands+0x870>
ffffffffc02039c4:	07d00593          	li	a1,125
ffffffffc02039c8:	00003517          	auipc	a0,0x3
ffffffffc02039cc:	e7850513          	addi	a0,a0,-392 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc02039d0:	a81fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039d4:	00003697          	auipc	a3,0x3
ffffffffc02039d8:	f4c68693          	addi	a3,a3,-180 # ffffffffc0206920 <default_pmm_manager+0xd38>
ffffffffc02039dc:	00002617          	auipc	a2,0x2
ffffffffc02039e0:	e7460613          	addi	a2,a2,-396 # ffffffffc0205850 <commands+0x870>
ffffffffc02039e4:	07c00593          	li	a1,124
ffffffffc02039e8:	00003517          	auipc	a0,0x3
ffffffffc02039ec:	e5850513          	addi	a0,a0,-424 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc02039f0:	a61fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02039f4 <mm_destroy>:
...
ffffffffc02039f8:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02039fa:	6508                	ld	a0,8(a0)
ffffffffc02039fc:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02039fe:	00a40c63          	beq	s0,a0,ffffffffc0203a16 <mm_destroy+0x22>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203a02:	6118                	ld	a4,0(a0)
ffffffffc0203a04:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link));  //kfree vma        
ffffffffc0203a06:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203a08:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203a0a:	e398                	sd	a4,0(a5)
ffffffffc0203a0c:	84afe0ef          	jal	ra,ffffffffc0201a56 <kfree>
    return listelm->next;
ffffffffc0203a10:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a12:	fea418e3          	bne	s0,a0,ffffffffc0203a02 <mm_destroy+0xe>
    }
    kfree(mm); //kfree mm
ffffffffc0203a16:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203a18:	6402                	ld	s0,0(sp)
ffffffffc0203a1a:	60a2                	ld	ra,8(sp)
ffffffffc0203a1c:	0141                	addi	sp,sp,16
    kfree(mm); //kfree mm
ffffffffc0203a1e:	838fe06f          	j	ffffffffc0201a56 <kfree>
...
ffffffffc0203a24:	f822                	sd	s0,48(sp)
ffffffffc0203a26:	f426                	sd	s1,40(sp)
...
check_vma_struct(void) {
    struct mm_struct *mm = mm_create();
ffffffffc0203a32:	e3dff0ef          	jal	ra,ffffffffc020386e <mm_create>
    assert(mm != NULL);
ffffffffc0203a36:	842a                	mv	s0,a0
ffffffffc0203a38:	03200493          	li	s1,50
ffffffffc0203a3c:	e919                	bnez	a0,ffffffffc0203a52 <vmm_init+0x30>
ffffffffc0203a3e:	a989                	j	ffffffffc0203e90 <vmm_init+0x46e>
        vma->vm_start = vm_start;
ffffffffc0203a40:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
...
ffffffffc0203a44:	00052c23          	sw	zero,24(a0)
    ...
    for (i = step1; i >= 1; i --) {
        ...
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203a48:	14ed                	addi	s1,s1,-5
ffffffffc0203a4a:	8522                	mv	a0,s0
ffffffffc0203a4c:	edbff0ef          	jal	ra,ffffffffc0203926 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203a50:	c88d                	beqz	s1,ffffffffc0203a82 <vmm_init+0x60>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203a52:	03000513          	li	a0,48
ffffffffc0203a56:	f45fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc0203a5a:	85aa                	mv	a1,a0
ffffffffc0203a5c:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc0203a60:	f165                	bnez	a0,ffffffffc0203a40 <vmm_init+0x1e>
        assert(vma != NULL);
ffffffffc0203a62:	00003697          	auipc	a3,0x3
ffffffffc0203a66:	93668693          	addi	a3,a3,-1738 # ffffffffc0206398 <default_pmm_manager+0x7b0>
ffffffffc0203a6a:	00002617          	auipc	a2,0x2
ffffffffc0203a6e:	de660613          	addi	a2,a2,-538 # ffffffffc0205850 <commands+0x870>
ffffffffc0203a72:	0c900593          	li	a1,201
ffffffffc0203a76:	00003517          	auipc	a0,0x3
ffffffffc0203a7a:	dca50513          	addi	a0,a0,-566 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203a7e:	9d3fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    for (i = step1; i >= 1; i --) {
ffffffffc0203a82:	03700493          	li	s1,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203a86:	1f900913          	li	s2,505
ffffffffc0203a8a:	a819                	j	ffffffffc0203aa0 <vmm_init+0x7e>
        vma->vm_start = vm_start;
ffffffffc0203a8c:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203a8e:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203a90:	00052c23          	sw	zero,24(a0)
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203a94:	0495                	addi	s1,s1,5
ffffffffc0203a96:	8522                	mv	a0,s0
ffffffffc0203a98:	e8fff0ef          	jal	ra,ffffffffc0203926 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203a9c:	03248a63          	beq	s1,s2,ffffffffc0203ad0 <vmm_init+0xae>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203aa0:	03000513          	li	a0,48
ffffffffc0203aa4:	ef7fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc0203aa8:	85aa                	mv	a1,a0
ffffffffc0203aaa:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc0203aae:	fd79                	bnez	a0,ffffffffc0203a8c <vmm_init+0x6a>
        assert(vma != NULL);
ffffffffc0203ab0:	00003697          	auipc	a3,0x3
ffffffffc0203ab4:	8e868693          	addi	a3,a3,-1816 # ffffffffc0206398 <default_pmm_manager+0x7b0>
ffffffffc0203ab8:	00002617          	auipc	a2,0x2
ffffffffc0203abc:	d9860613          	addi	a2,a2,-616 # ffffffffc0205850 <commands+0x870>
ffffffffc0203ac0:	0cf00593          	li	a1,207
ffffffffc0203ac4:	00003517          	auipc	a0,0x3
ffffffffc0203ac8:	d7c50513          	addi	a0,a0,-644 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203acc:	985fc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0203ad0:	6418                	ld	a4,8(s0)
ffffffffc0203ad2:	479d                	li	a5,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203ad4:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203ad8:	2ee40063          	beq	s0,a4,ffffffffc0203db8 <vmm_init+0x396>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203adc:	fe873603          	ld	a2,-24(a4)
ffffffffc0203ae0:	ffe78693          	addi	a3,a5,-2
ffffffffc0203ae4:	24d61a63          	bne	a2,a3,ffffffffc0203d38 <vmm_init+0x316>
ffffffffc0203ae8:	ff073683          	ld	a3,-16(a4)
ffffffffc0203aec:	24f69663          	bne	a3,a5,ffffffffc0203d38 <vmm_init+0x316>
ffffffffc0203af0:	0795                	addi	a5,a5,5
ffffffffc0203af2:	6718                	ld	a4,8(a4)
    for (i = 1; i <= step2; i ++) {
ffffffffc0203af4:	feb792e3          	bne	a5,a1,ffffffffc0203ad8 <vmm_init+0xb6>
ffffffffc0203af8:	491d                	li	s2,7
ffffffffc0203afa:	4495                	li	s1,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203afc:	1f900a93          	li	s5,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203b00:	85a6                	mv	a1,s1
ffffffffc0203b02:	8522                	mv	a0,s0
ffffffffc0203b04:	de5ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
ffffffffc0203b08:	8a2a                	mv	s4,a0
        assert(vma1 != NULL);
ffffffffc0203b0a:	30050763          	beqz	a0,ffffffffc0203e18 <vmm_init+0x3f6>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203b0e:	00148593          	addi	a1,s1,1
ffffffffc0203b12:	8522                	mv	a0,s0
ffffffffc0203b14:	dd5ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
ffffffffc0203b18:	89aa                	mv	s3,a0
        assert(vma2 != NULL);
ffffffffc0203b1a:	2c050f63          	beqz	a0,ffffffffc0203df8 <vmm_init+0x3d6>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203b1e:	85ca                	mv	a1,s2
ffffffffc0203b20:	8522                	mv	a0,s0
ffffffffc0203b22:	dc7ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203b26:	2a051963          	bnez	a0,ffffffffc0203dd8 <vmm_init+0x3b6>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203b2a:	00348593          	addi	a1,s1,3
ffffffffc0203b2e:	8522                	mv	a0,s0
ffffffffc0203b30:	db9ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203b34:	32051263          	bnez	a0,ffffffffc0203e58 <vmm_init+0x436>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203b38:	00448593          	addi	a1,s1,4
ffffffffc0203b3c:	8522                	mv	a0,s0
ffffffffc0203b3e:	dabff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203b42:	2e051b63          	bnez	a0,ffffffffc0203e38 <vmm_init+0x416>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203b46:	008a3783          	ld	a5,8(s4)
ffffffffc0203b4a:	20979763          	bne	a5,s1,ffffffffc0203d58 <vmm_init+0x336>
ffffffffc0203b4e:	010a3783          	ld	a5,16(s4)
ffffffffc0203b52:	21279363          	bne	a5,s2,ffffffffc0203d58 <vmm_init+0x336>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203b56:	0089b783          	ld	a5,8(s3)
ffffffffc0203b5a:	20979f63          	bne	a5,s1,ffffffffc0203d78 <vmm_init+0x356>
ffffffffc0203b5e:	0109b783          	ld	a5,16(s3)
ffffffffc0203b62:	21279b63          	bne	a5,s2,ffffffffc0203d78 <vmm_init+0x356>
ffffffffc0203b66:	0495                	addi	s1,s1,5
ffffffffc0203b68:	0915                	addi	s2,s2,5
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203b6a:	f9549be3          	bne	s1,s5,ffffffffc0203b00 <vmm_init+0xde>
ffffffffc0203b6e:	4491                	li	s1,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203b70:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203b72:	85a6                	mv	a1,s1
ffffffffc0203b74:	8522                	mv	a0,s0
ffffffffc0203b76:	d73ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
ffffffffc0203b7a:	0004859b          	sext.w	a1,s1
        if (vma_below_5 != NULL ) {
ffffffffc0203b7e:	c90d                	beqz	a0,ffffffffc0203bb0 <vmm_init+0x18e>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203b80:	6914                	ld	a3,16(a0)
ffffffffc0203b82:	6510                	ld	a2,8(a0)
ffffffffc0203b84:	00003517          	auipc	a0,0x3
ffffffffc0203b88:	edc50513          	addi	a0,a0,-292 # ffffffffc0206a60 <default_pmm_manager+0xe78>
ffffffffc0203b8c:	e02fc0ef          	jal	ra,ffffffffc020018e <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203b90:	00003697          	auipc	a3,0x3
ffffffffc0203b94:	ef868693          	addi	a3,a3,-264 # ffffffffc0206a88 <default_pmm_manager+0xea0>
ffffffffc0203b98:	00002617          	auipc	a2,0x2
ffffffffc0203b9c:	cb860613          	addi	a2,a2,-840 # ffffffffc0205850 <commands+0x870>
ffffffffc0203ba0:	0f100593          	li	a1,241
ffffffffc0203ba4:	00003517          	auipc	a0,0x3
ffffffffc0203ba8:	c9c50513          	addi	a0,a0,-868 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203bac:	8a5fc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0203bb0:	14fd                	addi	s1,s1,-1
    for (i =4; i>=0; i--) {
ffffffffc0203bb2:	fd2490e3          	bne	s1,s2,ffffffffc0203b72 <vmm_init+0x150>
    }

    mm_destroy(mm);
ffffffffc0203bb6:	8522                	mv	a0,s0
ffffffffc0203bb8:	e3dff0ef          	jal	ra,ffffffffc02039f4 <mm_destroy>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203bbc:	00003517          	auipc	a0,0x3
ffffffffc0203bc0:	ee450513          	addi	a0,a0,-284 # ffffffffc0206aa0 <default_pmm_manager+0xeb8>
ffffffffc0203bc4:	dcafc0ef          	jal	ra,ffffffffc020018e <cprintf>
...
ffffffffc0203bc8:	89cfe0ef          	jal	ra,ffffffffc0201c64 <nr_free_pages>
ffffffffc0203bcc:	89aa                	mv	s3,a0

    check_mm_struct = mm_create();
ffffffffc0203bce:	ca1ff0ef          	jal	ra,ffffffffc020386e <mm_create>
ffffffffc0203bd2:	00012797          	auipc	a5,0x12
ffffffffc0203bd6:	a0a7b723          	sd	a0,-1522(a5) # ffffffffc02155e0 <check_mm_struct>
ffffffffc0203bda:	84aa                	mv	s1,a0
    assert(check_mm_struct != NULL);
ffffffffc0203bdc:	36050663          	beqz	a0,ffffffffc0203f48 <vmm_init+0x526>

    struct mm_struct *mm = check_mm_struct;
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203be0:	00012797          	auipc	a5,0x12
ffffffffc0203be4:	8a878793          	addi	a5,a5,-1880 # ffffffffc0215488 <boot_pgdir>
ffffffffc0203be8:	0007b903          	ld	s2,0(a5)
    assert(pgdir[0] == 0);
ffffffffc0203bec:	00093783          	ld	a5,0(s2)
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203bf0:	01253c23          	sd	s2,24(a0)
    assert(pgdir[0] == 0);
ffffffffc0203bf4:	2c079e63          	bnez	a5,ffffffffc0203ed0 <vmm_init+0x4ae>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203bf8:	03000513          	li	a0,48
ffffffffc0203bfc:	d9ffd0ef          	jal	ra,ffffffffc020199a <kmalloc>
ffffffffc0203c00:	842a                	mv	s0,a0
    if (vma != NULL) {
ffffffffc0203c02:	18050b63          	beqz	a0,ffffffffc0203d98 <vmm_init+0x376>
        vma->vm_end = vm_end;
ffffffffc0203c06:	002007b7          	lui	a5,0x200
ffffffffc0203c0a:	e81c                	sd	a5,16(s0)
        vma->vm_flags = vm_flags;
ffffffffc0203c0c:	4789                	li	a5,2
...
ffffffffc0203c0e:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203c10:	cc1c                	sw	a5,24(s0)
    insert_vma_struct(mm, vma);
ffffffffc0203c12:	8526                	mv	a0,s1
        vma->vm_start = vm_start;
ffffffffc0203c14:	00043423          	sd	zero,8(s0)
    insert_vma_struct(mm, vma);
ffffffffc0203c18:	d0fff0ef          	jal	ra,ffffffffc0203926 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c1c:	10000593          	li	a1,256
ffffffffc0203c20:	8526                	mv	a0,s1
ffffffffc0203c22:	cc7ff0ef          	jal	ra,ffffffffc02038e8 <find_vma>
ffffffffc0203c26:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203c2a:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c2e:	2ca41163          	bne	s0,a0,ffffffffc0203ef0 <vmm_init+0x4ce>
        *(char *)(addr + i) = i;
ffffffffc0203c32:	00f78023          	sb	a5,0(a5) # 200000 <BASE_ADDRESS-0xffffffffc0000000>
        sum += i;
ffffffffc0203c36:	0785                	addi	a5,a5,1
    for (i = 0; i < 100; i ++) {
ffffffffc0203c38:	fee79de3          	bne	a5,a4,ffffffffc0203c32 <vmm_init+0x210>
        sum += i;
ffffffffc0203c3c:	6705                	lui	a4,0x1
    for (i = 0; i < 100; i ++) {
ffffffffc0203c3e:	10000793          	li	a5,256
        sum += i;
ffffffffc0203c42:	35670713          	addi	a4,a4,854 # 1356 <BASE_ADDRESS-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203c46:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203c4a:	0007c683          	lbu	a3,0(a5)
ffffffffc0203c4e:	0785                	addi	a5,a5,1
ffffffffc0203c50:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203c52:	fec79ce3          	bne	a5,a2,ffffffffc0203c4a <vmm_init+0x228>
    }
    assert(sum == 0);
ffffffffc0203c56:	2c071963          	bnez	a4,ffffffffc0203f28 <vmm_init+0x506>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203c5a:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203c5e:	00012a97          	auipc	s5,0x12
ffffffffc0203c62:	832a8a93          	addi	s5,s5,-1998 # ffffffffc0215490 <npage>
ffffffffc0203c66:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203c6a:	078a                	slli	a5,a5,0x2
ffffffffc0203c6c:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203c6e:	20e7f563          	bleu	a4,a5,ffffffffc0203e78 <vmm_init+0x456>
    return &pages[PPN(pa) - nbase];
ffffffffc0203c72:	00003697          	auipc	a3,0x3
ffffffffc0203c76:	34668693          	addi	a3,a3,838 # ffffffffc0206fb8 <nbase>
ffffffffc0203c7a:	0006ba03          	ld	s4,0(a3)
ffffffffc0203c7e:	414786b3          	sub	a3,a5,s4
ffffffffc0203c82:	069a                	slli	a3,a3,0x6
    return page - pages + nbase;
ffffffffc0203c84:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0203c86:	57fd                	li	a5,-1
    return page - pages + nbase;
ffffffffc0203c88:	96d2                	add	a3,a3,s4
    return KADDR(page2pa(page));
ffffffffc0203c8a:	83b1                	srli	a5,a5,0xc
ffffffffc0203c8c:	8ff5                	and	a5,a5,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc0203c8e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0203c90:	28e7f063          	bleu	a4,a5,ffffffffc0203f10 <vmm_init+0x4ee>
ffffffffc0203c94:	00012797          	auipc	a5,0x12
ffffffffc0203c98:	85c78793          	addi	a5,a5,-1956 # ffffffffc02154f0 <va_pa_offset>
ffffffffc0203c9c:	6380                	ld	s0,0(a5)

    pde_t *pd1=pgdir,*pd0=page2kva(pde2page(pgdir[0]));
    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203c9e:	4581                	li	a1,0
ffffffffc0203ca0:	854a                	mv	a0,s2
ffffffffc0203ca2:	9436                	add	s0,s0,a3
ffffffffc0203ca4:	a34fe0ef          	jal	ra,ffffffffc0201ed8 <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203ca8:	601c                	ld	a5,0(s0)
    if (PPN(pa) >= npage) {
ffffffffc0203caa:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cae:	078a                	slli	a5,a5,0x2
ffffffffc0203cb0:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203cb2:	1ce7f363          	bleu	a4,a5,ffffffffc0203e78 <vmm_init+0x456>
    return &pages[PPN(pa) - nbase];
ffffffffc0203cb6:	00012417          	auipc	s0,0x12
ffffffffc0203cba:	84a40413          	addi	s0,s0,-1974 # ffffffffc0215500 <pages>
ffffffffc0203cbe:	6008                	ld	a0,0(s0)
ffffffffc0203cc0:	414787b3          	sub	a5,a5,s4
ffffffffc0203cc4:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd0[0]));
ffffffffc0203cc6:	953e                	add	a0,a0,a5
ffffffffc0203cc8:	4585                	li	a1,1
ffffffffc0203cca:	f55fd0ef          	jal	ra,ffffffffc0201c1e <free_pages>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cce:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203cd2:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cd6:	078a                	slli	a5,a5,0x2
ffffffffc0203cd8:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203cda:	18e7ff63          	bleu	a4,a5,ffffffffc0203e78 <vmm_init+0x456>
    return &pages[PPN(pa) - nbase];
ffffffffc0203cde:	6008                	ld	a0,0(s0)
ffffffffc0203ce0:	414787b3          	sub	a5,a5,s4
ffffffffc0203ce4:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd1[0]));
ffffffffc0203ce6:	4585                	li	a1,1
ffffffffc0203ce8:	953e                	add	a0,a0,a5
ffffffffc0203cea:	f35fd0ef          	jal	ra,ffffffffc0201c1e <free_pages>
    pgdir[0] = 0;
ffffffffc0203cee:	00093023          	sd	zero,0(s2)
  asm volatile("sfence.vma");
ffffffffc0203cf2:	12000073          	sfence.vma
    flush_tlb();

    mm->pgdir = NULL;
ffffffffc0203cf6:	0004bc23          	sd	zero,24(s1)
    mm_destroy(mm);
ffffffffc0203cfa:	8526                	mv	a0,s1
ffffffffc0203cfc:	cf9ff0ef          	jal	ra,ffffffffc02039f4 <mm_destroy>
    check_mm_struct = NULL;
ffffffffc0203d00:	00012797          	auipc	a5,0x12
ffffffffc0203d04:	8e07b023          	sd	zero,-1824(a5) # ffffffffc02155e0 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d08:	f5dfd0ef          	jal	ra,ffffffffc0201c64 <nr_free_pages>
ffffffffc0203d0c:	1aa99263          	bne	s3,a0,ffffffffc0203eb0 <vmm_init+0x48e>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203d10:	00003517          	auipc	a0,0x3
ffffffffc0203d14:	e2050513          	addi	a0,a0,-480 # ffffffffc0206b30 <default_pmm_manager+0xf48>
ffffffffc0203d18:	c76fc0ef          	jal	ra,ffffffffc020018e <cprintf>
}
ffffffffc0203d1c:	7442                	ld	s0,48(sp)
ffffffffc0203d1e:	70e2                	ld	ra,56(sp)
ffffffffc0203d20:	74a2                	ld	s1,40(sp)
ffffffffc0203d22:	7902                	ld	s2,32(sp)
ffffffffc0203d24:	69e2                	ld	s3,24(sp)
ffffffffc0203d26:	6a42                	ld	s4,16(sp)
ffffffffc0203d28:	6aa2                	ld	s5,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203d2a:	00003517          	auipc	a0,0x3
ffffffffc0203d2e:	e2650513          	addi	a0,a0,-474 # ffffffffc0206b50 <default_pmm_manager+0xf68>
}
ffffffffc0203d32:	6121                	addi	sp,sp,64
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203d34:	c5afc06f          	j	ffffffffc020018e <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203d38:	00003697          	auipc	a3,0x3
ffffffffc0203d3c:	c4068693          	addi	a3,a3,-960 # ffffffffc0206978 <default_pmm_manager+0xd90>
ffffffffc0203d40:	00002617          	auipc	a2,0x2
ffffffffc0203d44:	b1060613          	addi	a2,a2,-1264 # ffffffffc0205850 <commands+0x870>
ffffffffc0203d48:	0d800593          	li	a1,216
ffffffffc0203d4c:	00003517          	auipc	a0,0x3
ffffffffc0203d50:	af450513          	addi	a0,a0,-1292 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203d54:	efcfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203d58:	00003697          	auipc	a3,0x3
ffffffffc0203d5c:	ca868693          	addi	a3,a3,-856 # ffffffffc0206a00 <default_pmm_manager+0xe18>
ffffffffc0203d60:	00002617          	auipc	a2,0x2
ffffffffc0203d64:	af060613          	addi	a2,a2,-1296 # ffffffffc0205850 <commands+0x870>
ffffffffc0203d68:	0e800593          	li	a1,232
ffffffffc0203d6c:	00003517          	auipc	a0,0x3
ffffffffc0203d70:	ad450513          	addi	a0,a0,-1324 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203d74:	edcfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203d78:	00003697          	auipc	a3,0x3
ffffffffc0203d7c:	cb868693          	addi	a3,a3,-840 # ffffffffc0206a30 <default_pmm_manager+0xe48>
ffffffffc0203d80:	00002617          	auipc	a2,0x2
ffffffffc0203d84:	ad060613          	addi	a2,a2,-1328 # ffffffffc0205850 <commands+0x870>
ffffffffc0203d88:	0e900593          	li	a1,233
ffffffffc0203d8c:	00003517          	auipc	a0,0x3
ffffffffc0203d90:	ab450513          	addi	a0,a0,-1356 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203d94:	ebcfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(vma != NULL);
ffffffffc0203d98:	00002697          	auipc	a3,0x2
ffffffffc0203d9c:	60068693          	addi	a3,a3,1536 # ffffffffc0206398 <default_pmm_manager+0x7b0>
ffffffffc0203da0:	00002617          	auipc	a2,0x2
ffffffffc0203da4:	ab060613          	addi	a2,a2,-1360 # ffffffffc0205850 <commands+0x870>
ffffffffc0203da8:	10800593          	li	a1,264
ffffffffc0203dac:	00003517          	auipc	a0,0x3
ffffffffc0203db0:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203db4:	e9cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203db8:	00003697          	auipc	a3,0x3
ffffffffc0203dbc:	ba868693          	addi	a3,a3,-1112 # ffffffffc0206960 <default_pmm_manager+0xd78>
ffffffffc0203dc0:	00002617          	auipc	a2,0x2
ffffffffc0203dc4:	a9060613          	addi	a2,a2,-1392 # ffffffffc0205850 <commands+0x870>
ffffffffc0203dc8:	0d600593          	li	a1,214
ffffffffc0203dcc:	00003517          	auipc	a0,0x3
ffffffffc0203dd0:	a7450513          	addi	a0,a0,-1420 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203dd4:	e7cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma3 == NULL);
ffffffffc0203dd8:	00003697          	auipc	a3,0x3
ffffffffc0203ddc:	bf868693          	addi	a3,a3,-1032 # ffffffffc02069d0 <default_pmm_manager+0xde8>
ffffffffc0203de0:	00002617          	auipc	a2,0x2
ffffffffc0203de4:	a7060613          	addi	a2,a2,-1424 # ffffffffc0205850 <commands+0x870>
ffffffffc0203de8:	0e200593          	li	a1,226
ffffffffc0203dec:	00003517          	auipc	a0,0x3
ffffffffc0203df0:	a5450513          	addi	a0,a0,-1452 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203df4:	e5cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma2 != NULL);
ffffffffc0203df8:	00003697          	auipc	a3,0x3
ffffffffc0203dfc:	bc868693          	addi	a3,a3,-1080 # ffffffffc02069c0 <default_pmm_manager+0xdd8>
ffffffffc0203e00:	00002617          	auipc	a2,0x2
ffffffffc0203e04:	a5060613          	addi	a2,a2,-1456 # ffffffffc0205850 <commands+0x870>
ffffffffc0203e08:	0e000593          	li	a1,224
ffffffffc0203e0c:	00003517          	auipc	a0,0x3
ffffffffc0203e10:	a3450513          	addi	a0,a0,-1484 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203e14:	e3cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e18:	00003697          	auipc	a3,0x3
ffffffffc0203e1c:	b9868693          	addi	a3,a3,-1128 # ffffffffc02069b0 <default_pmm_manager+0xdc8>
ffffffffc0203e20:	00002617          	auipc	a2,0x2
ffffffffc0203e24:	a3060613          	addi	a2,a2,-1488 # ffffffffc0205850 <commands+0x870>
ffffffffc0203e28:	0de00593          	li	a1,222
ffffffffc0203e2c:	00003517          	auipc	a0,0x3
ffffffffc0203e30:	a1450513          	addi	a0,a0,-1516 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203e34:	e1cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e38:	00003697          	auipc	a3,0x3
ffffffffc0203e3c:	bb868693          	addi	a3,a3,-1096 # ffffffffc02069f0 <default_pmm_manager+0xe08>
ffffffffc0203e40:	00002617          	auipc	a2,0x2
ffffffffc0203e44:	a1060613          	addi	a2,a2,-1520 # ffffffffc0205850 <commands+0x870>
ffffffffc0203e48:	0e600593          	li	a1,230
ffffffffc0203e4c:	00003517          	auipc	a0,0x3
ffffffffc0203e50:	9f450513          	addi	a0,a0,-1548 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203e54:	dfcfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e58:	00003697          	auipc	a3,0x3
ffffffffc0203e5c:	b8868693          	addi	a3,a3,-1144 # ffffffffc02069e0 <default_pmm_manager+0xdf8>
ffffffffc0203e60:	00002617          	auipc	a2,0x2
ffffffffc0203e64:	9f060613          	addi	a2,a2,-1552 # ffffffffc0205850 <commands+0x870>
ffffffffc0203e68:	0e400593          	li	a1,228
ffffffffc0203e6c:	00003517          	auipc	a0,0x3
ffffffffc0203e70:	9d450513          	addi	a0,a0,-1580 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203e74:	ddcfc0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203e78:	00002617          	auipc	a2,0x2
ffffffffc0203e7c:	e2060613          	addi	a2,a2,-480 # ffffffffc0205c98 <default_pmm_manager+0xb0>
ffffffffc0203e80:	06100593          	li	a1,97
ffffffffc0203e84:	00002517          	auipc	a0,0x2
ffffffffc0203e88:	ddc50513          	addi	a0,a0,-548 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc0203e8c:	dc4fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(mm != NULL);
ffffffffc0203e90:	00002697          	auipc	a3,0x2
ffffffffc0203e94:	4d068693          	addi	a3,a3,1232 # ffffffffc0206360 <default_pmm_manager+0x778>
ffffffffc0203e98:	00002617          	auipc	a2,0x2
ffffffffc0203e9c:	9b860613          	addi	a2,a2,-1608 # ffffffffc0205850 <commands+0x870>
ffffffffc0203ea0:	0c200593          	li	a1,194
ffffffffc0203ea4:	00003517          	auipc	a0,0x3
ffffffffc0203ea8:	99c50513          	addi	a0,a0,-1636 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203eac:	da4fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203eb0:	00003697          	auipc	a3,0x3
ffffffffc0203eb4:	c5868693          	addi	a3,a3,-936 # ffffffffc0206b08 <default_pmm_manager+0xf20>
ffffffffc0203eb8:	00002617          	auipc	a2,0x2
ffffffffc0203ebc:	99860613          	addi	a2,a2,-1640 # ffffffffc0205850 <commands+0x870>
ffffffffc0203ec0:	12400593          	li	a1,292
ffffffffc0203ec4:	00003517          	auipc	a0,0x3
ffffffffc0203ec8:	97c50513          	addi	a0,a0,-1668 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203ecc:	d84fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ed0:	00002697          	auipc	a3,0x2
ffffffffc0203ed4:	4b868693          	addi	a3,a3,1208 # ffffffffc0206388 <default_pmm_manager+0x7a0>
ffffffffc0203ed8:	00002617          	auipc	a2,0x2
ffffffffc0203edc:	97860613          	addi	a2,a2,-1672 # ffffffffc0205850 <commands+0x870>
ffffffffc0203ee0:	10500593          	li	a1,261
ffffffffc0203ee4:	00003517          	auipc	a0,0x3
ffffffffc0203ee8:	95c50513          	addi	a0,a0,-1700 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203eec:	d64fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203ef0:	00003697          	auipc	a3,0x3
ffffffffc0203ef4:	be868693          	addi	a3,a3,-1048 # ffffffffc0206ad8 <default_pmm_manager+0xef0>
ffffffffc0203ef8:	00002617          	auipc	a2,0x2
ffffffffc0203efc:	95860613          	addi	a2,a2,-1704 # ffffffffc0205850 <commands+0x870>
ffffffffc0203f00:	10d00593          	li	a1,269
ffffffffc0203f04:	00003517          	auipc	a0,0x3
ffffffffc0203f08:	93c50513          	addi	a0,a0,-1732 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203f0c:	d44fc0ef          	jal	ra,ffffffffc0200450 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f10:	00002617          	auipc	a2,0x2
ffffffffc0203f14:	d2860613          	addi	a2,a2,-728 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0203f18:	06800593          	li	a1,104
ffffffffc0203f1c:	00002517          	auipc	a0,0x2
ffffffffc0203f20:	d4450513          	addi	a0,a0,-700 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc0203f24:	d2cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(sum == 0);
ffffffffc0203f28:	00003697          	auipc	a3,0x3
ffffffffc0203f2c:	bd068693          	addi	a3,a3,-1072 # ffffffffc0206af8 <default_pmm_manager+0xf10>
ffffffffc0203f30:	00002617          	auipc	a2,0x2
ffffffffc0203f34:	92060613          	addi	a2,a2,-1760 # ffffffffc0205850 <commands+0x870>
ffffffffc0203f38:	11700593          	li	a1,279
ffffffffc0203f3c:	00003517          	auipc	a0,0x3
ffffffffc0203f40:	90450513          	addi	a0,a0,-1788 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203f44:	d0cfc0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203f48:	00003697          	auipc	a3,0x3
ffffffffc0203f4c:	b7868693          	addi	a3,a3,-1160 # ffffffffc0206ac0 <default_pmm_manager+0xed8>
ffffffffc0203f50:	00002617          	auipc	a2,0x2
ffffffffc0203f54:	90060613          	addi	a2,a2,-1792 # ffffffffc0205850 <commands+0x870>
ffffffffc0203f58:	10100593          	li	a1,257
ffffffffc0203f5c:	00003517          	auipc	a0,0x3
ffffffffc0203f60:	8e450513          	addi	a0,a0,-1820 # ffffffffc0206840 <default_pmm_manager+0xc58>
ffffffffc0203f64:	cecfc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0203f68 <do_pgfault>:
...
ffffffffc0203f6a:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
ffffffffc0203f6c:	f822                	sd	s0,48(sp)
ffffffffc0203f6e:	f426                	sd	s1,40(sp)
ffffffffc0203f70:	fc06                	sd	ra,56(sp)
ffffffffc0203f72:	f04a                	sd	s2,32(sp)
ffffffffc0203f74:	ec4e                	sd	s3,24(sp)
ffffffffc0203f76:	8432                	mv	s0,a2
ffffffffc0203f78:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203f7a:	96fff0ef          	jal	ra,ffffffffc02038e8 <find_vma>

    pgfault_num++;
ffffffffc0203f7e:	00011797          	auipc	a5,0x11
ffffffffc0203f82:	52678793          	addi	a5,a5,1318 # ffffffffc02154a4 <pgfault_num>
ffffffffc0203f86:	439c                	lw	a5,0(a5)
ffffffffc0203f88:	2785                	addiw	a5,a5,1
ffffffffc0203f8a:	00011717          	auipc	a4,0x11
ffffffffc0203f8e:	50f72d23          	sw	a5,1306(a4) # ffffffffc02154a4 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203f92:	c555                	beqz	a0,ffffffffc020403e <do_pgfault+0xd6>
ffffffffc0203f94:	651c                	ld	a5,8(a0)
ffffffffc0203f96:	0af46463          	bltu	s0,a5,ffffffffc020403e <do_pgfault+0xd6>
...
ffffffffc0203f9a:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203f9c:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203f9e:	8b89                	andi	a5,a5,2
ffffffffc0203fa0:	e3a5                	bnez	a5,ffffffffc0204000 <do_pgfault+0x98>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203fa2:	767d                	lui	a2,0xfffff
...
ffffffffc0203fa4:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203fa6:	8c71                	and	s0,s0,a2
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc0203fa8:	85a2                	mv	a1,s0
ffffffffc0203faa:	4605                	li	a2,1
ffffffffc0203fac:	cf9fd0ef          	jal	ra,ffffffffc0201ca4 <get_pte>
ffffffffc0203fb0:	c945                	beqz	a0,ffffffffc0204060 <do_pgfault+0xf8>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0203fb2:	610c                	ld	a1,0(a0)
ffffffffc0203fb4:	c5b5                	beqz	a1,ffffffffc0204020 <do_pgfault+0xb8>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203fb6:	00011797          	auipc	a5,0x11
ffffffffc0203fba:	4ea78793          	addi	a5,a5,1258 # ffffffffc02154a0 <swap_init_ok>
ffffffffc0203fbe:	439c                	lw	a5,0(a5)
ffffffffc0203fc0:	2781                	sext.w	a5,a5
ffffffffc0203fc2:	c7d9                	beqz	a5,ffffffffc0204050 <do_pgfault+0xe8>
...
ffffffffc0203fc4:	0030                	addi	a2,sp,8
ffffffffc0203fc6:	85a2                	mv	a1,s0
ffffffffc0203fc8:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203fca:	e402                	sd	zero,8(sp)
            ret = swap_in(mm, addr, &page);
ffffffffc0203fcc:	c08ff0ef          	jal	ra,ffffffffc02033d4 <swap_in>
ffffffffc0203fd0:	892a                	mv	s2,a0
            if(ret!=0){
ffffffffc0203fd2:	e90d                	bnez	a0,ffffffffc0204004 <do_pgfault+0x9c>
                cprintf("swap_in failed\n");
                goto failed;
            }
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203fd4:	65a2                	ld	a1,8(sp)
ffffffffc0203fd6:	6c88                	ld	a0,24(s1)
ffffffffc0203fd8:	86ce                	mv	a3,s3
ffffffffc0203fda:	8622                	mv	a2,s0
ffffffffc0203fdc:	f71fd0ef          	jal	ra,ffffffffc0201f4c <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203fe0:	6622                	ld	a2,8(sp)
ffffffffc0203fe2:	4685                	li	a3,1
ffffffffc0203fe4:	85a2                	mv	a1,s0
ffffffffc0203fe6:	8526                	mv	a0,s1
ffffffffc0203fe8:	ac8ff0ef          	jal	ra,ffffffffc02032b0 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203fec:	67a2                	ld	a5,8(sp)
ffffffffc0203fee:	ff80                	sd	s0,56(a5)
   }
...
ffffffffc0203ff0:	70e2                	ld	ra,56(sp)
ffffffffc0203ff2:	7442                	ld	s0,48(sp)
ffffffffc0203ff4:	854a                	mv	a0,s2
ffffffffc0203ff6:	74a2                	ld	s1,40(sp)
ffffffffc0203ff8:	7902                	ld	s2,32(sp)
ffffffffc0203ffa:	69e2                	ld	s3,24(sp)
ffffffffc0203ffc:	6121                	addi	sp,sp,64
ffffffffc0203ffe:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204000:	49dd                	li	s3,23
ffffffffc0204002:	b745                	j	ffffffffc0203fa2 <do_pgfault+0x3a>
                cprintf("swap_in failed\n");
ffffffffc0204004:	00003517          	auipc	a0,0x3
ffffffffc0204008:	8c450513          	addi	a0,a0,-1852 # ffffffffc02068c8 <default_pmm_manager+0xce0>
ffffffffc020400c:	982fc0ef          	jal	ra,ffffffffc020018e <cprintf>
}
ffffffffc0204010:	70e2                	ld	ra,56(sp)
ffffffffc0204012:	7442                	ld	s0,48(sp)
ffffffffc0204014:	854a                	mv	a0,s2
ffffffffc0204016:	74a2                	ld	s1,40(sp)
ffffffffc0204018:	7902                	ld	s2,32(sp)
ffffffffc020401a:	69e2                	ld	s3,24(sp)
ffffffffc020401c:	6121                	addi	sp,sp,64
ffffffffc020401e:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204020:	6c88                	ld	a0,24(s1)
ffffffffc0204022:	864e                	mv	a2,s3
ffffffffc0204024:	85a2                	mv	a1,s0
ffffffffc0204026:	a75fe0ef          	jal	ra,ffffffffc0202a9a <pgdir_alloc_page>
   ret = 0;
ffffffffc020402a:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020402c:	f171                	bnez	a0,ffffffffc0203ff0 <do_pgfault+0x88>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020402e:	00003517          	auipc	a0,0x3
ffffffffc0204032:	87250513          	addi	a0,a0,-1934 # ffffffffc02068a0 <default_pmm_manager+0xcb8>
ffffffffc0204036:	958fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc020403a:	5971                	li	s2,-4
            goto failed;
ffffffffc020403c:	bf55                	j	ffffffffc0203ff0 <do_pgfault+0x88>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc020403e:	85a2                	mv	a1,s0
ffffffffc0204040:	00003517          	auipc	a0,0x3
ffffffffc0204044:	81050513          	addi	a0,a0,-2032 # ffffffffc0206850 <default_pmm_manager+0xc68>
ffffffffc0204048:	946fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    int ret = -E_INVAL;
ffffffffc020404c:	5975                	li	s2,-3
        goto failed;
ffffffffc020404e:	b74d                	j	ffffffffc0203ff0 <do_pgfault+0x88>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0204050:	00003517          	auipc	a0,0x3
ffffffffc0204054:	88850513          	addi	a0,a0,-1912 # ffffffffc02068d8 <default_pmm_manager+0xcf0>
ffffffffc0204058:	936fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc020405c:	5971                	li	s2,-4
            goto failed;
ffffffffc020405e:	bf49                	j	ffffffffc0203ff0 <do_pgfault+0x88>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc0204060:	00003517          	auipc	a0,0x3
ffffffffc0204064:	82050513          	addi	a0,a0,-2016 # ffffffffc0206880 <default_pmm_manager+0xc98>
ffffffffc0204068:	926fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    ret = -E_NO_MEM;
ffffffffc020406c:	5971                	li	s2,-4
        goto failed;
ffffffffc020406e:	b749                	j	ffffffffc0203ff0 <do_pgfault+0x88>

ffffffffc0204070 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
void
swapfs_init(void) {
ffffffffc0204070:	1141                	addi	sp,sp,-16
...
ffffffffc0204074:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0204076:	d06fc0ef          	jal	ra,ffffffffc020057c <ide_device_valid>
ffffffffc020407a:	cd01                	beqz	a0,ffffffffc0204092 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc020407c:	4505                	li	a0,1
ffffffffc020407e:	d04fc0ef          	jal	ra,ffffffffc0200582 <ide_device_size>
}
ffffffffc0204082:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204084:	810d                	srli	a0,a0,0x3
ffffffffc0204086:	00011797          	auipc	a5,0x11
ffffffffc020408a:	50a7b523          	sd	a0,1290(a5) # ffffffffc0215590 <max_swap_offset>
}
ffffffffc020408e:	0141                	addi	sp,sp,16
ffffffffc0204090:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204092:	00003617          	auipc	a2,0x3
ffffffffc0204096:	ad660613          	addi	a2,a2,-1322 # ffffffffc0206b68 <default_pmm_manager+0xf80>
ffffffffc020409a:	45b5                	li	a1,13
ffffffffc020409c:	00003517          	auipc	a0,0x3
ffffffffc02040a0:	aec50513          	addi	a0,a0,-1300 # ffffffffc0206b88 <default_pmm_manager+0xfa0>
ffffffffc02040a4:	bacfc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02040a8 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc02040a8:	1141                	addi	sp,sp,-16
ffffffffc02040aa:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02040ac:	00855793          	srli	a5,a0,0x8
ffffffffc02040b0:	cfb9                	beqz	a5,ffffffffc020410e <swapfs_read+0x66>
ffffffffc02040b2:	00011717          	auipc	a4,0x11
ffffffffc02040b6:	4de70713          	addi	a4,a4,1246 # ffffffffc0215590 <max_swap_offset>
ffffffffc02040ba:	6318                	ld	a4,0(a4)
ffffffffc02040bc:	04e7f963          	bleu	a4,a5,ffffffffc020410e <swapfs_read+0x66>
    return page - pages + nbase;
ffffffffc02040c0:	00011717          	auipc	a4,0x11
ffffffffc02040c4:	44070713          	addi	a4,a4,1088 # ffffffffc0215500 <pages>
ffffffffc02040c8:	6310                	ld	a2,0(a4)
ffffffffc02040ca:	00003717          	auipc	a4,0x3
ffffffffc02040ce:	eee70713          	addi	a4,a4,-274 # ffffffffc0206fb8 <nbase>
    return KADDR(page2pa(page));
ffffffffc02040d2:	00011697          	auipc	a3,0x11
ffffffffc02040d6:	3be68693          	addi	a3,a3,958 # ffffffffc0215490 <npage>
    return page - pages + nbase;
ffffffffc02040da:	40c58633          	sub	a2,a1,a2
ffffffffc02040de:	630c                	ld	a1,0(a4)
ffffffffc02040e0:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc02040e2:	577d                	li	a4,-1
ffffffffc02040e4:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc02040e6:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc02040e8:	8331                	srli	a4,a4,0xc
ffffffffc02040ea:	8f71                	and	a4,a4,a2
ffffffffc02040ec:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02040f0:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02040f2:	02d77a63          	bleu	a3,a4,ffffffffc0204126 <swapfs_read+0x7e>
ffffffffc02040f6:	00011797          	auipc	a5,0x11
ffffffffc02040fa:	3fa78793          	addi	a5,a5,1018 # ffffffffc02154f0 <va_pa_offset>
ffffffffc02040fe:	639c                	ld	a5,0(a5)
}
ffffffffc0204100:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204102:	46a1                	li	a3,8
ffffffffc0204104:	963e                	add	a2,a2,a5
ffffffffc0204106:	4505                	li	a0,1
}
ffffffffc0204108:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020410a:	c7efc06f          	j	ffffffffc0200588 <ide_read_secs>
ffffffffc020410e:	86aa                	mv	a3,a0
ffffffffc0204110:	00003617          	auipc	a2,0x3
ffffffffc0204114:	a9060613          	addi	a2,a2,-1392 # ffffffffc0206ba0 <default_pmm_manager+0xfb8>
ffffffffc0204118:	45d1                	li	a1,20
ffffffffc020411a:	00003517          	auipc	a0,0x3
ffffffffc020411e:	a6e50513          	addi	a0,a0,-1426 # ffffffffc0206b88 <default_pmm_manager+0xfa0>
ffffffffc0204122:	b2efc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc0204126:	86b2                	mv	a3,a2
ffffffffc0204128:	06800593          	li	a1,104
ffffffffc020412c:	00002617          	auipc	a2,0x2
ffffffffc0204130:	b0c60613          	addi	a2,a2,-1268 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc0204134:	00002517          	auipc	a0,0x2
ffffffffc0204138:	b2c50513          	addi	a0,a0,-1236 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc020413c:	b14fc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204140 <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc0204140:	1141                	addi	sp,sp,-16
ffffffffc0204142:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204144:	00855793          	srli	a5,a0,0x8
ffffffffc0204148:	cfb9                	beqz	a5,ffffffffc02041a6 <swapfs_write+0x66>
ffffffffc020414a:	00011717          	auipc	a4,0x11
ffffffffc020414e:	44670713          	addi	a4,a4,1094 # ffffffffc0215590 <max_swap_offset>
ffffffffc0204152:	6318                	ld	a4,0(a4)
ffffffffc0204154:	04e7f963          	bleu	a4,a5,ffffffffc02041a6 <swapfs_write+0x66>
    return page - pages + nbase;
ffffffffc0204158:	00011717          	auipc	a4,0x11
ffffffffc020415c:	3a870713          	addi	a4,a4,936 # ffffffffc0215500 <pages>
ffffffffc0204160:	6310                	ld	a2,0(a4)
ffffffffc0204162:	00003717          	auipc	a4,0x3
ffffffffc0204166:	e5670713          	addi	a4,a4,-426 # ffffffffc0206fb8 <nbase>
    return KADDR(page2pa(page));
ffffffffc020416a:	00011697          	auipc	a3,0x11
ffffffffc020416e:	32668693          	addi	a3,a3,806 # ffffffffc0215490 <npage>
    return page - pages + nbase;
ffffffffc0204172:	40c58633          	sub	a2,a1,a2
ffffffffc0204176:	630c                	ld	a1,0(a4)
ffffffffc0204178:	8619                	srai	a2,a2,0x6
    return KADDR(page2pa(page));
ffffffffc020417a:	577d                	li	a4,-1
ffffffffc020417c:	6294                	ld	a3,0(a3)
    return page - pages + nbase;
ffffffffc020417e:	962e                	add	a2,a2,a1
    return KADDR(page2pa(page));
ffffffffc0204180:	8331                	srli	a4,a4,0xc
ffffffffc0204182:	8f71                	and	a4,a4,a2
ffffffffc0204184:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204188:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc020418a:	02d77a63          	bleu	a3,a4,ffffffffc02041be <swapfs_write+0x7e>
ffffffffc020418e:	00011797          	auipc	a5,0x11
ffffffffc0204192:	36278793          	addi	a5,a5,866 # ffffffffc02154f0 <va_pa_offset>
ffffffffc0204196:	639c                	ld	a5,0(a5)
}
ffffffffc0204198:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020419a:	46a1                	li	a3,8
ffffffffc020419c:	963e                	add	a2,a2,a5
ffffffffc020419e:	4505                	li	a0,1
}
ffffffffc02041a0:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041a2:	c0afc06f          	j	ffffffffc02005ac <ide_write_secs>
ffffffffc02041a6:	86aa                	mv	a3,a0
ffffffffc02041a8:	00003617          	auipc	a2,0x3
ffffffffc02041ac:	9f860613          	addi	a2,a2,-1544 # ffffffffc0206ba0 <default_pmm_manager+0xfb8>
ffffffffc02041b0:	45e5                	li	a1,25
ffffffffc02041b2:	00003517          	auipc	a0,0x3
ffffffffc02041b6:	9d650513          	addi	a0,a0,-1578 # ffffffffc0206b88 <default_pmm_manager+0xfa0>
ffffffffc02041ba:	a96fc0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc02041be:	86b2                	mv	a3,a2
ffffffffc02041c0:	06800593          	li	a1,104
ffffffffc02041c4:	00002617          	auipc	a2,0x2
ffffffffc02041c8:	a7460613          	addi	a2,a2,-1420 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02041cc:	00002517          	auipc	a0,0x2
ffffffffc02041d0:	a9450513          	addi	a0,a0,-1388 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02041d4:	a7cfc0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc02041d8 <kernel_thread_entry>:
.text
...
ffffffffc02041e8:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc02041ea:	fb0fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
...
ffffffffc0204216:	441000ef          	jal	ra,ffffffffc0204e56 <memset>
        proc->tf = NULL; // 中断帧指针
        proc->cr3 = boot_cr3; // 页目录表地址 设为 内核页目录表基址
ffffffffc020421a:	00011797          	auipc	a5,0x11
ffffffffc020421e:	2de78793          	addi	a5,a5,734 # ffffffffc02154f8 <boot_cr3>
...
ffffffffc0204236:	421000ef          	jal	ra,ffffffffc0204e56 <memset>
    }
    return proc;
}
...
ffffffffc0204248:	26478793          	addi	a5,a5,612 # ffffffffc02154a8 <current>
ffffffffc020424c:	639c                	ld	a5,0(a5)
ffffffffc020424e:	73c8                	ld	a0,160(a5)
ffffffffc0204250:	949fc06f          	j	ffffffffc0200b98 <forkrets>
...
ffffffffc0204266:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204268:	3ef000ef          	jal	ra,ffffffffc0204e56 <memset>
...
ffffffffc0204278:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020427a:	3ef0006f          	j	ffffffffc0204e68 <memcpy>
...
ffffffffc0204294:	ec06                	sd	ra,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204296:	3c1000ef          	jal	ra,ffffffffc0204e56 <memset>
...
ffffffffc02042a8:	6105                	addi	sp,sp,32
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042aa:	3bf0006f          	j	ffffffffc0204e68 <memcpy>
...
ffffffffc02042ae:	00011797          	auipc	a5,0x11
ffffffffc02042b2:	1fa78793          	addi	a5,a5,506 # ffffffffc02154a8 <current>
ffffffffc02042b6:	639c                	ld	a5,0(a5)
init_main(void *arg) {
ffffffffc02042b8:	1101                	addi	sp,sp,-32
ffffffffc02042ba:	e426                	sd	s1,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042bc:	43c4                	lw	s1,4(a5)
init_main(void *arg) {
ffffffffc02042be:	e822                	sd	s0,16(sp)
ffffffffc02042c0:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c2:	853e                	mv	a0,a5
init_main(void *arg) {
ffffffffc02042c4:	ec06                	sd	ra,24(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c6:	fb9ff0ef          	jal	ra,ffffffffc020427e <get_proc_name>
ffffffffc02042ca:	862a                	mv	a2,a0
ffffffffc02042cc:	85a6                	mv	a1,s1
ffffffffc02042ce:	00003517          	auipc	a0,0x3
ffffffffc02042d2:	93a50513          	addi	a0,a0,-1734 # ffffffffc0206c08 <default_pmm_manager+0x1020>
ffffffffc02042d6:	eb9fb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042da:	85a2                	mv	a1,s0
ffffffffc02042dc:	00003517          	auipc	a0,0x3
ffffffffc02042e0:	95450513          	addi	a0,a0,-1708 # ffffffffc0206c30 <default_pmm_manager+0x1048>
ffffffffc02042e4:	eabfb0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e8:	00003517          	auipc	a0,0x3
ffffffffc02042ec:	95850513          	addi	a0,a0,-1704 # ffffffffc0206c40 <default_pmm_manager+0x1058>
ffffffffc02042f0:	e9ffb0ef          	jal	ra,ffffffffc020018e <cprintf>
    return 0;
}
...
ffffffffc02042fc:	6105                	addi	sp,sp,32
ffffffffc02042fe:	8082                	ret

ffffffffc0204300 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204300:	1101                	addi	sp,sp,-32
    if (proc != current) {
ffffffffc0204302:	00011797          	auipc	a5,0x11
ffffffffc0204306:	1a678793          	addi	a5,a5,422 # ffffffffc02154a8 <current>
proc_run(struct proc_struct *proc) {
ffffffffc020430a:	e426                	sd	s1,8(sp)
    if (proc != current) {
ffffffffc020430c:	6384                	ld	s1,0(a5)
proc_run(struct proc_struct *proc) {
ffffffffc020430e:	ec06                	sd	ra,24(sp)
ffffffffc0204310:	e822                	sd	s0,16(sp)
ffffffffc0204312:	e04a                	sd	s2,0(sp)
    if (proc != current) {
ffffffffc0204314:	02a48c63          	beq	s1,a0,ffffffffc020434c <proc_run+0x4c>
ffffffffc0204318:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020431a:	100027f3          	csrr	a5,sstatus
ffffffffc020431e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204320:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204322:	e3b1                	bnez	a5,ffffffffc0204366 <proc_run+0x66>
            lcr3(next->cr3); // 重新加载 cr3 寄存器(页目录表基址) 进行进程间的页表切换
ffffffffc0204324:	745c                	ld	a5,168(s0)
            current = proc; // 将当前进程换为 要切换到的进程
ffffffffc0204326:	00011717          	auipc	a4,0x11
ffffffffc020432a:	18873123          	sd	s0,386(a4) # ffffffffc02154a8 <current>
...
ffffffffc0204332:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204336:	8fd9                	or	a5,a5,a4
ffffffffc0204338:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context)); // 调用 switch_to 进行上下文的保存与切换
ffffffffc020433c:	03040593          	addi	a1,s0,48
ffffffffc0204340:	03048513          	addi	a0,s1,48
ffffffffc0204344:	52e000ef          	jal	ra,ffffffffc0204872 <switch_to>
    if (flag) {
ffffffffc0204348:	00091863          	bnez	s2,ffffffffc0204358 <proc_run+0x58>
}
ffffffffc020434c:	60e2                	ld	ra,24(sp)
ffffffffc020434e:	6442                	ld	s0,16(sp)
ffffffffc0204350:	64a2                	ld	s1,8(sp)
ffffffffc0204352:	6902                	ld	s2,0(sp)
ffffffffc0204354:	6105                	addi	sp,sp,32
ffffffffc0204356:	8082                	ret
ffffffffc0204358:	6442                	ld	s0,16(sp)
ffffffffc020435a:	60e2                	ld	ra,24(sp)
ffffffffc020435c:	64a2                	ld	s1,8(sp)
ffffffffc020435e:	6902                	ld	s2,0(sp)
ffffffffc0204360:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0204362:	a70fc06f          	j	ffffffffc02005d2 <intr_enable>
        intr_disable();
ffffffffc0204366:	a72fc0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc020436a:	4905                	li	s2,1
ffffffffc020436c:	bf65                	j	ffffffffc0204324 <proc_run+0x24>

ffffffffc020436e <find_proc>:
    if (0 < pid && pid < MAX_PID) {
ffffffffc020436e:	0005071b          	sext.w	a4,a0
ffffffffc0204372:	6789                	lui	a5,0x2
ffffffffc0204374:	fff7069b          	addiw	a3,a4,-1
ffffffffc0204378:	17f9                	addi	a5,a5,-2
ffffffffc020437a:	04d7e063          	bltu	a5,a3,ffffffffc02043ba <find_proc+0x4c>
find_proc(int pid) {
ffffffffc020437e:	1141                	addi	sp,sp,-16
ffffffffc0204380:	e022                	sd	s0,0(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204382:	45a9                	li	a1,10
ffffffffc0204384:	842a                	mv	s0,a0
ffffffffc0204386:	853a                	mv	a0,a4
find_proc(int pid) {
ffffffffc0204388:	e406                	sd	ra,8(sp)
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020438a:	61e000ef          	jal	ra,ffffffffc02049a8 <hash32>
ffffffffc020438e:	02051693          	slli	a3,a0,0x20
ffffffffc0204392:	82f1                	srli	a3,a3,0x1c
ffffffffc0204394:	0000d517          	auipc	a0,0xd
ffffffffc0204398:	0cc50513          	addi	a0,a0,204 # ffffffffc0211460 <hash_list>
ffffffffc020439c:	96aa                	add	a3,a3,a0
ffffffffc020439e:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02043a0:	a029                	j	ffffffffc02043aa <find_proc+0x3c>
            if (proc->pid == pid) {
ffffffffc02043a2:	f2c7a703          	lw	a4,-212(a5) # 1f2c <BASE_ADDRESS-0xffffffffc01fe0d4>
ffffffffc02043a6:	00870c63          	beq	a4,s0,ffffffffc02043be <find_proc+0x50>
ffffffffc02043aa:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02043ac:	fef69be3          	bne	a3,a5,ffffffffc02043a2 <find_proc+0x34>
}
ffffffffc02043b0:	60a2                	ld	ra,8(sp)
ffffffffc02043b2:	6402                	ld	s0,0(sp)
    return NULL;
...
ffffffffc02043c0:	6402                	ld	s0,0(sp)
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02043c2:	f2878513          	addi	a0,a5,-216
}
...
ffffffffc02043e0:	e44e                	sd	s3,8(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc02043e2:	6785                	lui	a5,0x1
ffffffffc02043e4:	1cf75963          	ble	a5,a4,ffffffffc02045b6 <do_fork+0x1ec>
ffffffffc02043e8:	89ae                	mv	s3,a1
ffffffffc02043ea:	84b2                	mv	s1,a2
    if ((proc = alloc_proc()) == NULL)
ffffffffc02043ec:	df5ff0ef          	jal	ra,ffffffffc02041e0 <alloc_proc>
ffffffffc02043f0:	842a                	mv	s0,a0
ffffffffc02043f2:	1c050463          	beqz	a0,ffffffffc02045ba <do_fork+0x1f0>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043f6:	4509                	li	a0,2
ffffffffc02043f8:	f9efd0ef          	jal	ra,ffffffffc0201b96 <alloc_pages>
    if (page != NULL) {
ffffffffc02043fc:	1a050863          	beqz	a0,ffffffffc02045ac <do_fork+0x1e2>
    return page - pages + nbase;
ffffffffc0204400:	00011797          	auipc	a5,0x11
ffffffffc0204404:	10078793          	addi	a5,a5,256 # ffffffffc0215500 <pages>
ffffffffc0204408:	6394                	ld	a3,0(a5)
ffffffffc020440a:	00003797          	auipc	a5,0x3
ffffffffc020440e:	bae78793          	addi	a5,a5,-1106 # ffffffffc0206fb8 <nbase>
    return KADDR(page2pa(page));
ffffffffc0204412:	00011717          	auipc	a4,0x11
ffffffffc0204416:	07e70713          	addi	a4,a4,126 # ffffffffc0215490 <npage>
    return page - pages + nbase;
...
ffffffffc020442c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020442e:	1ae7f863          	bleu	a4,a5,ffffffffc02045de <do_fork+0x214>
    assert(current->mm == NULL);
ffffffffc0204432:	00011797          	auipc	a5,0x11
ffffffffc0204436:	07678793          	addi	a5,a5,118 # ffffffffc02154a8 <current>
ffffffffc020443a:	639c                	ld	a5,0(a5)
ffffffffc020443c:	00011717          	auipc	a4,0x11
ffffffffc0204440:	0b470713          	addi	a4,a4,180 # ffffffffc02154f0 <va_pa_offset>
ffffffffc0204444:	6318                	ld	a4,0(a4)
ffffffffc0204446:	779c                	ld	a5,40(a5)
ffffffffc0204448:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc020444a:	e814                	sd	a3,16(s0)
    assert(current->mm == NULL);
ffffffffc020444c:	16079963          	bnez	a5,ffffffffc02045be <do_fork+0x1f4>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204450:	6789                	lui	a5,0x2
ffffffffc0204452:	ee078793          	addi	a5,a5,-288 # 1ee0 <BASE_ADDRESS-0xffffffffc01fe120>
ffffffffc0204456:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204458:	8626                	mv	a2,s1
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020445a:	f054                	sd	a3,160(s0)
    *(proc->tf) = *tf;
ffffffffc020445c:	87b6                	mv	a5,a3
ffffffffc020445e:	12048893          	addi	a7,s1,288
ffffffffc0204462:	00063803          	ld	a6,0(a2)
ffffffffc0204466:	6608                	ld	a0,8(a2)
ffffffffc0204468:	6a0c                	ld	a1,16(a2)
ffffffffc020446a:	6e18                	ld	a4,24(a2)
ffffffffc020446c:	0107b023          	sd	a6,0(a5)
ffffffffc0204470:	e788                	sd	a0,8(a5)
ffffffffc0204472:	eb8c                	sd	a1,16(a5)
ffffffffc0204474:	ef98                	sd	a4,24(a5)
ffffffffc0204476:	02060613          	addi	a2,a2,32
ffffffffc020447a:	02078793          	addi	a5,a5,32
ffffffffc020447e:	ff1612e3          	bne	a2,a7,ffffffffc0204462 <do_fork+0x98>
    proc->tf->gpr.a0 = 0;
ffffffffc0204482:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204486:	10098563          	beqz	s3,ffffffffc0204590 <do_fork+0x1c6>
    if (++ last_pid >= MAX_PID) {
ffffffffc020448a:	00006797          	auipc	a5,0x6
ffffffffc020448e:	bce78793          	addi	a5,a5,-1074 # ffffffffc020a058 <last_pid.1575>
ffffffffc0204492:	439c                	lw	a5,0(a5)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204494:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204498:	00000717          	auipc	a4,0x0
ffffffffc020449c:	dac70713          	addi	a4,a4,-596 # ffffffffc0204244 <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc02044a0:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc02044a4:	f818                	sd	a4,48(s0)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc02044a6:	fc14                	sd	a3,56(s0)
    if (++ last_pid >= MAX_PID) {
ffffffffc02044a8:	00006717          	auipc	a4,0x6
ffffffffc02044ac:	baa72823          	sw	a0,-1104(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc02044b0:	6789                	lui	a5,0x2
ffffffffc02044b2:	0ef55163          	ble	a5,a0,ffffffffc0204594 <do_fork+0x1ca>
    if (last_pid >= next_safe) {
ffffffffc02044b6:	00006797          	auipc	a5,0x6
ffffffffc02044ba:	ba678793          	addi	a5,a5,-1114 # ffffffffc020a05c <next_safe.1574>
ffffffffc02044be:	439c                	lw	a5,0(a5)
ffffffffc02044c0:	00011497          	auipc	s1,0x11
ffffffffc02044c4:	12848493          	addi	s1,s1,296 # ffffffffc02155e8 <proc_list>
ffffffffc02044c8:	06f54063          	blt	a0,a5,ffffffffc0204528 <do_fork+0x15e>
        next_safe = MAX_PID;
ffffffffc02044cc:	6789                	lui	a5,0x2
ffffffffc02044ce:	00006717          	auipc	a4,0x6
ffffffffc02044d2:	b8f72723          	sw	a5,-1138(a4) # ffffffffc020a05c <next_safe.1574>
ffffffffc02044d6:	4581                	li	a1,0
ffffffffc02044d8:	87aa                	mv	a5,a0
ffffffffc02044da:	00011497          	auipc	s1,0x11
ffffffffc02044de:	10e48493          	addi	s1,s1,270 # ffffffffc02155e8 <proc_list>
    repeat:
ffffffffc02044e2:	6889                	lui	a7,0x2
ffffffffc02044e4:	882e                	mv	a6,a1
ffffffffc02044e6:	6609                	lui	a2,0x2
        le = list;
ffffffffc02044e8:	00011697          	auipc	a3,0x11
ffffffffc02044ec:	10068693          	addi	a3,a3,256 # ffffffffc02155e8 <proc_list>
ffffffffc02044f0:	6694                	ld	a3,8(a3)
        while ((le = list_next(le)) != list) {
ffffffffc02044f2:	00968f63          	beq	a3,s1,ffffffffc0204510 <do_fork+0x146>
            if (proc->pid == last_pid) {
ffffffffc02044f6:	f3c6a703          	lw	a4,-196(a3)
ffffffffc02044fa:	08e78663          	beq	a5,a4,ffffffffc0204586 <do_fork+0x1bc>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044fe:	fee7d9e3          	ble	a4,a5,ffffffffc02044f0 <do_fork+0x126>
ffffffffc0204502:	fec757e3          	ble	a2,a4,ffffffffc02044f0 <do_fork+0x126>
ffffffffc0204506:	6694                	ld	a3,8(a3)
ffffffffc0204508:	863a                	mv	a2,a4
ffffffffc020450a:	4805                	li	a6,1
        while ((le = list_next(le)) != list) {
ffffffffc020450c:	fe9695e3          	bne	a3,s1,ffffffffc02044f6 <do_fork+0x12c>
ffffffffc0204510:	c591                	beqz	a1,ffffffffc020451c <do_fork+0x152>
ffffffffc0204512:	00006717          	auipc	a4,0x6
ffffffffc0204516:	b4f72323          	sw	a5,-1210(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc020451a:	853e                	mv	a0,a5
ffffffffc020451c:	00080663          	beqz	a6,ffffffffc0204528 <do_fork+0x15e>
ffffffffc0204520:	00006797          	auipc	a5,0x6
ffffffffc0204524:	b2c7ae23          	sw	a2,-1220(a5) # ffffffffc020a05c <next_safe.1574>
    nr_process++;
ffffffffc0204528:	00092783          	lw	a5,0(s2)
...
ffffffffc0204538:	f8f72623          	sw	a5,-116(a4) # ffffffffc02154c0 <nr_process>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020453c:	46c000ef          	jal	ra,ffffffffc02049a8 <hash32>
ffffffffc0204540:	1502                	slli	a0,a0,0x20
ffffffffc0204542:	0000d797          	auipc	a5,0xd
ffffffffc0204546:	f1e78793          	addi	a5,a5,-226 # ffffffffc0211460 <hash_list>
ffffffffc020454a:	8171                	srli	a0,a0,0x1c
ffffffffc020454c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020454e:	6514                	ld	a3,8(a0)
ffffffffc0204550:	0d840613          	addi	a2,s0,216
    list_add_before(&proc_list, &proc->list_link);
ffffffffc0204554:	0c840793          	addi	a5,s0,200
    prev->next = next->prev = elm;
ffffffffc0204558:	e290                	sd	a2,0(a3)
    __list_add(elm, listelm->prev, listelm);
ffffffffc020455a:	6098                	ld	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc020455c:	e510                	sd	a2,8(a0)
    elm->prev = prev;
ffffffffc020455e:	ec68                	sd	a0,216(s0)
    elm->next = next;
ffffffffc0204560:	f074                	sd	a3,224(s0)
    prev->next = next->prev = elm;
ffffffffc0204562:	e71c                	sd	a5,8(a4)
    elm->prev = prev;
ffffffffc0204564:	e478                	sd	a4,200(s0)
    wakeup_proc(proc);
ffffffffc0204566:	8522                	mv	a0,s0
    elm->next = next;
ffffffffc0204568:	e864                	sd	s1,208(s0)
    prev->next = next->prev = elm;
ffffffffc020456a:	00011717          	auipc	a4,0x11
ffffffffc020456e:	06f73f23          	sd	a5,126(a4) # ffffffffc02155e8 <proc_list>
ffffffffc0204572:	36a000ef          	jal	ra,ffffffffc02048dc <wakeup_proc>
    ret = proc->pid;
ffffffffc0204576:	4048                	lw	a0,4(s0)
}
ffffffffc0204578:	70a2                	ld	ra,40(sp)
ffffffffc020457a:	7402                	ld	s0,32(sp)
ffffffffc020457c:	64e2                	ld	s1,24(sp)
ffffffffc020457e:	6942                	ld	s2,16(sp)
ffffffffc0204580:	69a2                	ld	s3,8(sp)
ffffffffc0204582:	6145                	addi	sp,sp,48
ffffffffc0204584:	8082                	ret
                if (++ last_pid >= next_safe) {
ffffffffc0204586:	2785                	addiw	a5,a5,1
ffffffffc0204588:	00c7dd63          	ble	a2,a5,ffffffffc02045a2 <do_fork+0x1d8>
ffffffffc020458c:	4585                	li	a1,1
ffffffffc020458e:	b78d                	j	ffffffffc02044f0 <do_fork+0x126>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204590:	89b6                	mv	s3,a3
ffffffffc0204592:	bde5                	j	ffffffffc020448a <do_fork+0xc0>
        last_pid = 1;
ffffffffc0204594:	4785                	li	a5,1
ffffffffc0204596:	00006717          	auipc	a4,0x6
ffffffffc020459a:	acf72123          	sw	a5,-1342(a4) # ffffffffc020a058 <last_pid.1575>
ffffffffc020459e:	4505                	li	a0,1
ffffffffc02045a0:	b735                	j	ffffffffc02044cc <do_fork+0x102>
                    if (last_pid >= MAX_PID) {
ffffffffc02045a2:	0117c363          	blt	a5,a7,ffffffffc02045a8 <do_fork+0x1de>
                        last_pid = 1;
ffffffffc02045a6:	4785                	li	a5,1
                    goto repeat;
ffffffffc02045a8:	4585                	li	a1,1
ffffffffc02045aa:	bf2d                	j	ffffffffc02044e4 <do_fork+0x11a>
    kfree(proc);
ffffffffc02045ac:	8522                	mv	a0,s0
ffffffffc02045ae:	ca8fd0ef          	jal	ra,ffffffffc0201a56 <kfree>
    ret = -E_NO_MEM;
ffffffffc02045b2:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045b4:	b7d1                	j	ffffffffc0204578 <do_fork+0x1ae>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045b6:	556d                	li	a0,-5
ffffffffc02045b8:	b7c1                	j	ffffffffc0204578 <do_fork+0x1ae>
    ret = -E_NO_MEM;
ffffffffc02045ba:	5571                	li	a0,-4
ffffffffc02045bc:	bf75                	j	ffffffffc0204578 <do_fork+0x1ae>
    assert(current->mm == NULL);
ffffffffc02045be:	00002697          	auipc	a3,0x2
ffffffffc02045c2:	61a68693          	addi	a3,a3,1562 # ffffffffc0206bd8 <default_pmm_manager+0xff0>
ffffffffc02045c6:	00001617          	auipc	a2,0x1
ffffffffc02045ca:	28a60613          	addi	a2,a2,650 # ffffffffc0205850 <commands+0x870>
ffffffffc02045ce:	10800593          	li	a1,264
ffffffffc02045d2:	00002517          	auipc	a0,0x2
ffffffffc02045d6:	61e50513          	addi	a0,a0,1566 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
ffffffffc02045da:	e77fb0ef          	jal	ra,ffffffffc0200450 <__panic>
ffffffffc02045de:	00001617          	auipc	a2,0x1
ffffffffc02045e2:	65a60613          	addi	a2,a2,1626 # ffffffffc0205c38 <default_pmm_manager+0x50>
ffffffffc02045e6:	06800593          	li	a1,104
ffffffffc02045ea:	00001517          	auipc	a0,0x1
ffffffffc02045ee:	67650513          	addi	a0,a0,1654 # ffffffffc0205c60 <default_pmm_manager+0x78>
ffffffffc02045f2:	e5ffb0ef          	jal	ra,ffffffffc0200450 <__panic>
...
ffffffffc020460c:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020460e:	049000ef          	jal	ra,ffffffffc0204e56 <memset>
...
ffffffffc020462e:	bae78793          	addi	a5,a5,-1106 # ffffffffc02041d8 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204632:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204634:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204636:	d95ff0ef          	jal	ra,ffffffffc02043ca <do_fork>
}
...
ffffffffc020464c:	57860613          	addi	a2,a2,1400 # ffffffffc0206bc0 <default_pmm_manager+0xfd8>
ffffffffc0204650:	16200593          	li	a1,354
ffffffffc0204654:	00002517          	auipc	a0,0x2
ffffffffc0204658:	59c50513          	addi	a0,a0,1436 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc020465c:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020465e:	df3fb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204662 <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0204662:	00011797          	auipc	a5,0x11
ffffffffc0204666:	f8678793          	addi	a5,a5,-122 # ffffffffc02155e8 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc020466a:	1101                	addi	sp,sp,-32
ffffffffc020466c:	00011717          	auipc	a4,0x11
ffffffffc0204670:	f8f73223          	sd	a5,-124(a4) # ffffffffc02155f0 <proc_list+0x8>
ffffffffc0204674:	00011717          	auipc	a4,0x11
ffffffffc0204678:	f6f73a23          	sd	a5,-140(a4) # ffffffffc02155e8 <proc_list>
ffffffffc020467c:	ec06                	sd	ra,24(sp)
ffffffffc020467e:	e822                	sd	s0,16(sp)
ffffffffc0204680:	e426                	sd	s1,8(sp)
ffffffffc0204682:	e04a                	sd	s2,0(sp)
ffffffffc0204684:	0000d797          	auipc	a5,0xd
ffffffffc0204688:	ddc78793          	addi	a5,a5,-548 # ffffffffc0211460 <hash_list>
ffffffffc020468c:	00011717          	auipc	a4,0x11
ffffffffc0204690:	dd470713          	addi	a4,a4,-556 # ffffffffc0215460 <name.1565>
ffffffffc0204694:	e79c                	sd	a5,8(a5)
ffffffffc0204696:	e39c                	sd	a5,0(a5)
ffffffffc0204698:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc020469a:	fee79de3          	bne	a5,a4,ffffffffc0204694 <proc_init+0x32>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc020469e:	b43ff0ef          	jal	ra,ffffffffc02041e0 <alloc_proc>
ffffffffc02046a2:	00011797          	auipc	a5,0x11
ffffffffc02046a6:	e0a7b723          	sd	a0,-498(a5) # ffffffffc02154b0 <idleproc>
ffffffffc02046aa:	00011417          	auipc	s0,0x11
ffffffffc02046ae:	e0640413          	addi	s0,s0,-506 # ffffffffc02154b0 <idleproc>
ffffffffc02046b2:	12050a63          	beqz	a0,ffffffffc02047e6 <proc_init+0x184>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046b6:	07000513          	li	a0,112
ffffffffc02046ba:	ae0fd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046be:	07000613          	li	a2,112
ffffffffc02046c2:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046c4:	84aa                	mv	s1,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046c6:	790000ef          	jal	ra,ffffffffc0204e56 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02046ca:	6008                	ld	a0,0(s0)
ffffffffc02046cc:	85a6                	mv	a1,s1
ffffffffc02046ce:	07000613          	li	a2,112
ffffffffc02046d2:	03050513          	addi	a0,a0,48
ffffffffc02046d6:	7aa000ef          	jal	ra,ffffffffc0204e80 <memcmp>
ffffffffc02046da:	892a                	mv	s2,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046dc:	453d                	li	a0,15
ffffffffc02046de:	abcfd0ef          	jal	ra,ffffffffc020199a <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046e2:	463d                	li	a2,15
ffffffffc02046e4:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046e6:	84aa                	mv	s1,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046e8:	76e000ef          	jal	ra,ffffffffc0204e56 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046ec:	6008                	ld	a0,0(s0)
ffffffffc02046ee:	463d                	li	a2,15
ffffffffc02046f0:	85a6                	mv	a1,s1
ffffffffc02046f2:	0b450513          	addi	a0,a0,180
ffffffffc02046f6:	78a000ef          	jal	ra,ffffffffc0204e80 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046fa:	601c                	ld	a5,0(s0)
ffffffffc02046fc:	00011717          	auipc	a4,0x11
ffffffffc0204700:	dfc70713          	addi	a4,a4,-516 # ffffffffc02154f8 <boot_cr3>
ffffffffc0204704:	6318                	ld	a4,0(a4)
ffffffffc0204706:	77d4                	ld	a3,168(a5)
ffffffffc0204708:	08e68e63          	beq	a3,a4,ffffffffc02047a4 <proc_init+0x142>
...
ffffffffc020470e:	e398                	sd	a4,0(a5)
...
ffffffffc0204722:	57258593          	addi	a1,a1,1394 # ffffffffc0206c90 <default_pmm_manager+0x10a8>
ffffffffc0204726:	853e                	mv	a0,a5
ffffffffc0204728:	b2dff0ef          	jal	ra,ffffffffc0204254 <set_proc_name>
    nr_process ++;
ffffffffc020472c:	00011797          	auipc	a5,0x11
ffffffffc0204730:	d9478793          	addi	a5,a5,-620 # ffffffffc02154c0 <nr_process>
ffffffffc0204734:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc0204736:	6018                	ld	a4,0(s0)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204738:	4601                	li	a2,0
    nr_process ++;
ffffffffc020473a:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020473c:	00002597          	auipc	a1,0x2
ffffffffc0204740:	55c58593          	addi	a1,a1,1372 # ffffffffc0206c98 <default_pmm_manager+0x10b0>
ffffffffc0204744:	00000517          	auipc	a0,0x0
ffffffffc0204748:	b6a50513          	addi	a0,a0,-1174 # ffffffffc02042ae <init_main>
    nr_process ++;
ffffffffc020474c:	00011697          	auipc	a3,0x11
ffffffffc0204750:	d6f6aa23          	sw	a5,-652(a3) # ffffffffc02154c0 <nr_process>
    current = idleproc;
ffffffffc0204754:	00011797          	auipc	a5,0x11
ffffffffc0204758:	d4e7ba23          	sd	a4,-684(a5) # ffffffffc02154a8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020475c:	e9bff0ef          	jal	ra,ffffffffc02045f6 <kernel_thread>
    if (pid <= 0) {
ffffffffc0204760:	0ca05f63          	blez	a0,ffffffffc020483e <proc_init+0x1dc>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204764:	c0bff0ef          	jal	ra,ffffffffc020436e <find_proc>
    set_proc_name(initproc, "init");
ffffffffc0204768:	00002597          	auipc	a1,0x2
ffffffffc020476c:	56058593          	addi	a1,a1,1376 # ffffffffc0206cc8 <default_pmm_manager+0x10e0>
    initproc = find_proc(pid);
ffffffffc0204770:	00011797          	auipc	a5,0x11
ffffffffc0204774:	d4a7b423          	sd	a0,-696(a5) # ffffffffc02154b8 <initproc>
    set_proc_name(initproc, "init");
ffffffffc0204778:	addff0ef          	jal	ra,ffffffffc0204254 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020477c:	601c                	ld	a5,0(s0)
ffffffffc020477e:	c3c5                	beqz	a5,ffffffffc020481e <proc_init+0x1bc>
ffffffffc0204780:	43dc                	lw	a5,4(a5)
ffffffffc0204782:	efd1                	bnez	a5,ffffffffc020481e <proc_init+0x1bc>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204784:	00011797          	auipc	a5,0x11
ffffffffc0204788:	d3478793          	addi	a5,a5,-716 # ffffffffc02154b8 <initproc>
ffffffffc020478c:	639c                	ld	a5,0(a5)
ffffffffc020478e:	cba5                	beqz	a5,ffffffffc02047fe <proc_init+0x19c>
ffffffffc0204790:	43d8                	lw	a4,4(a5)
ffffffffc0204792:	4785                	li	a5,1
ffffffffc0204794:	06f71563          	bne	a4,a5,ffffffffc02047fe <proc_init+0x19c>
}
ffffffffc0204798:	60e2                	ld	ra,24(sp)
ffffffffc020479a:	6442                	ld	s0,16(sp)
ffffffffc020479c:	64a2                	ld	s1,8(sp)
ffffffffc020479e:	6902                	ld	s2,0(sp)
ffffffffc02047a0:	6105                	addi	sp,sp,32
ffffffffc02047a2:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02047a4:	73d8                	ld	a4,160(a5)
ffffffffc02047a6:	f33d                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
ffffffffc02047a8:	f60912e3          	bnez	s2,ffffffffc020470c <proc_init+0xaa>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047ac:	6394                	ld	a3,0(a5)
ffffffffc02047ae:	577d                	li	a4,-1
ffffffffc02047b0:	1702                	slli	a4,a4,0x20
ffffffffc02047b2:	f4e69de3          	bne	a3,a4,ffffffffc020470c <proc_init+0xaa>
ffffffffc02047b6:	4798                	lw	a4,8(a5)
ffffffffc02047b8:	fb31                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047ba:	6b98                	ld	a4,16(a5)
ffffffffc02047bc:	fb21                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
ffffffffc02047be:	4f98                	lw	a4,24(a5)
ffffffffc02047c0:	2701                	sext.w	a4,a4
ffffffffc02047c2:	f729                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
ffffffffc02047c4:	7398                	ld	a4,32(a5)
ffffffffc02047c6:	f339                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047c8:	7798                	ld	a4,40(a5)
ffffffffc02047ca:	f329                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
ffffffffc02047cc:	0b07a703          	lw	a4,176(a5)
ffffffffc02047d0:	8f49                	or	a4,a4,a0
ffffffffc02047d2:	2701                	sext.w	a4,a4
ffffffffc02047d4:	ff05                	bnez	a4,ffffffffc020470c <proc_init+0xaa>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047d6:	00002517          	auipc	a0,0x2
ffffffffc02047da:	4a250513          	addi	a0,a0,1186 # ffffffffc0206c78 <default_pmm_manager+0x1090>
ffffffffc02047de:	9b1fb0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02047e2:	601c                	ld	a5,0(s0)
ffffffffc02047e4:	b725                	j	ffffffffc020470c <proc_init+0xaa>
        panic("cannot alloc idleproc.\n");
ffffffffc02047e6:	00002617          	auipc	a2,0x2
ffffffffc02047ea:	47a60613          	addi	a2,a2,1146 # ffffffffc0206c60 <default_pmm_manager+0x1078>
ffffffffc02047ee:	17a00593          	li	a1,378
ffffffffc02047f2:	00002517          	auipc	a0,0x2
ffffffffc02047f6:	3fe50513          	addi	a0,a0,1022 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
ffffffffc02047fa:	c57fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047fe:	00002697          	auipc	a3,0x2
ffffffffc0204802:	4fa68693          	addi	a3,a3,1274 # ffffffffc0206cf8 <default_pmm_manager+0x1110>
ffffffffc0204806:	00001617          	auipc	a2,0x1
ffffffffc020480a:	04a60613          	addi	a2,a2,74 # ffffffffc0205850 <commands+0x870>
ffffffffc020480e:	1a100593          	li	a1,417
ffffffffc0204812:	00002517          	auipc	a0,0x2
ffffffffc0204816:	3de50513          	addi	a0,a0,990 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
ffffffffc020481a:	c37fb0ef          	jal	ra,ffffffffc0200450 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020481e:	00002697          	auipc	a3,0x2
ffffffffc0204822:	4b268693          	addi	a3,a3,1202 # ffffffffc0206cd0 <default_pmm_manager+0x10e8>
ffffffffc0204826:	00001617          	auipc	a2,0x1
ffffffffc020482a:	02a60613          	addi	a2,a2,42 # ffffffffc0205850 <commands+0x870>
ffffffffc020482e:	1a000593          	li	a1,416
ffffffffc0204832:	00002517          	auipc	a0,0x2
ffffffffc0204836:	3be50513          	addi	a0,a0,958 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
ffffffffc020483a:	c17fb0ef          	jal	ra,ffffffffc0200450 <__panic>
        panic("create init_main failed.\n");
ffffffffc020483e:	00002617          	auipc	a2,0x2
ffffffffc0204842:	46a60613          	addi	a2,a2,1130 # ffffffffc0206ca8 <default_pmm_manager+0x10c0>
ffffffffc0204846:	19a00593          	li	a1,410
ffffffffc020484a:	00002517          	auipc	a0,0x2
ffffffffc020484e:	3a650513          	addi	a0,a0,934 # ffffffffc0206bf0 <default_pmm_manager+0x1008>
ffffffffc0204852:	bfffb0ef          	jal	ra,ffffffffc0200450 <__panic>

ffffffffc0204856 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204856:	1141                	addi	sp,sp,-16
ffffffffc0204858:	e022                	sd	s0,0(sp)
ffffffffc020485a:	e406                	sd	ra,8(sp)
ffffffffc020485c:	00011417          	auipc	s0,0x11
ffffffffc0204860:	c4c40413          	addi	s0,s0,-948 # ffffffffc02154a8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204864:	6018                	ld	a4,0(s0)
ffffffffc0204866:	4f1c                	lw	a5,24(a4)
ffffffffc0204868:	2781                	sext.w	a5,a5
ffffffffc020486a:	dff5                	beqz	a5,ffffffffc0204866 <cpu_idle+0x10>
            schedule();
ffffffffc020486c:	0a2000ef          	jal	ra,ffffffffc020490e <schedule>
ffffffffc0204870:	bfd5                	j	ffffffffc0204864 <cpu_idle+0xe>

ffffffffc0204872 <switch_to>:
.text
...
ffffffffc0204872:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204876:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020487a:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020487c:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020487e:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204882:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204886:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020488a:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020488e:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204892:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204896:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020489a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020489e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048a2:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048a6:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02048aa:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02048ae:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02048b0:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02048b2:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02048b6:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02048ba:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02048be:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02048c2:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02048c6:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02048ca:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02048ce:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02048d2:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02048d6:	0685bd83          	ld	s11,104(a1)
...
ffffffffc02048e2:	00f77563          	bleu	a5,a4,ffffffffc02048ec <wakeup_proc+0x10>
...
ffffffffc02048f2:	43268693          	addi	a3,a3,1074 # ffffffffc0206d20 <default_pmm_manager+0x1138>
ffffffffc02048f6:	00001617          	auipc	a2,0x1
ffffffffc02048fa:	f5a60613          	addi	a2,a2,-166 # ffffffffc0205850 <commands+0x870>
ffffffffc02048fe:	45a5                	li	a1,9
ffffffffc0204900:	00002517          	auipc	a0,0x2
ffffffffc0204904:	46050513          	addi	a0,a0,1120 # ffffffffc0206d60 <default_pmm_manager+0x1178>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204908:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020490a:	b47fb0ef          	jal	ra,ffffffffc0200450 <__panic>
...
ffffffffc0204944:	ca860613          	addi	a2,a2,-856 # ffffffffc02155e8 <proc_list>
        le = last;
ffffffffc0204948:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc020494a:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc020494c:	4809                	li	a6,2
    return listelm->next;
ffffffffc020494e:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204950:	00c78863          	beq	a5,a2,ffffffffc0204960 <schedule+0x52>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204954:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204958:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020495c:	01070463          	beq	a4,a6,ffffffffc0204964 <schedule+0x56>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204960:	fef697e3          	bne	a3,a5,ffffffffc020494e <schedule+0x40>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204964:	c589                	beqz	a1,ffffffffc020496e <schedule+0x60>
ffffffffc0204966:	4198                	lw	a4,0(a1)
ffffffffc0204968:	4789                	li	a5,2
ffffffffc020496a:	00f70e63          	beq	a4,a5,ffffffffc0204986 <schedule+0x78>
            next = idleproc;
        }
        next->runs ++;
ffffffffc020496e:	451c                	lw	a5,8(a0)
ffffffffc0204970:	2785                	addiw	a5,a5,1
ffffffffc0204972:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204974:	00a88463          	beq	a7,a0,ffffffffc020497c <schedule+0x6e>
            proc_run(next);
ffffffffc0204978:	989ff0ef          	jal	ra,ffffffffc0204300 <proc_run>
    if (flag) {
ffffffffc020497c:	e419                	bnez	s0,ffffffffc020498a <schedule+0x7c>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204984:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204986:	852e                	mv	a0,a1
ffffffffc0204988:	b7dd                	j	ffffffffc020496e <schedule+0x60>
}
...
ffffffffc020499e:	b76d                	j	ffffffffc0204948 <schedule+0x3a>
        intr_disable();
ffffffffc02049a0:	c39fb0ef          	jal	ra,ffffffffc02005d8 <intr_disable>
        return 1;
ffffffffc02049a4:	4405                	li	s0,1
ffffffffc02049a6:	bfa5                	j	ffffffffc020491e <schedule+0x10>

ffffffffc02049a8 <hash32>:
 *
...
ffffffffc02049a8:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049ac:	2785                	addiw	a5,a5,1
ffffffffc02049ae:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc02049b2:	02000793          	li	a5,32
ffffffffc02049b6:	40b785bb          	subw	a1,a5,a1
}
ffffffffc02049ba:	00b5553b          	srlw	a0,a0,a1
ffffffffc02049be:	8082                	ret

ffffffffc02049c0 <printnum>:
 * */
static void
...
ffffffffc02049c0:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049c4:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049c6:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049ca:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049cc:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049d0:	f022                	sd	s0,32(sp)
ffffffffc02049d2:	ec26                	sd	s1,24(sp)
ffffffffc02049d4:	e84a                	sd	s2,16(sp)
ffffffffc02049d6:	f406                	sd	ra,40(sp)
ffffffffc02049d8:	e44e                	sd	s3,8(sp)
ffffffffc02049da:	84aa                	mv	s1,a0
ffffffffc02049dc:	892e                	mv	s2,a1
ffffffffc02049de:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02049e2:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc02049e4:	03067e63          	bleu	a6,a2,ffffffffc0204a20 <printnum+0x60>
ffffffffc02049e8:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc02049ea:	00805763          	blez	s0,ffffffffc02049f8 <printnum+0x38>
ffffffffc02049ee:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02049f0:	85ca                	mv	a1,s2
ffffffffc02049f2:	854e                	mv	a0,s3
ffffffffc02049f4:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc02049f6:	fc65                	bnez	s0,ffffffffc02049ee <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049f8:	1a02                	slli	s4,s4,0x20
ffffffffc02049fa:	020a5a13          	srli	s4,s4,0x20
ffffffffc02049fe:	00002797          	auipc	a5,0x2
ffffffffc0204a02:	50a78793          	addi	a5,a5,1290 # ffffffffc0206f08 <error_string+0x38>
ffffffffc0204a06:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a08:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a0a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a0e:	70a2                	ld	ra,40(sp)
ffffffffc0204a10:	69a2                	ld	s3,8(sp)
ffffffffc0204a12:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a14:	85ca                	mv	a1,s2
ffffffffc0204a16:	8326                	mv	t1,s1
}
ffffffffc0204a18:	6942                	ld	s2,16(sp)
ffffffffc0204a1a:	64e2                	ld	s1,24(sp)
ffffffffc0204a1c:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a1e:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a20:	03065633          	divu	a2,a2,a6
ffffffffc0204a24:	8722                	mv	a4,s0
ffffffffc0204a26:	f9bff0ef          	jal	ra,ffffffffc02049c0 <printnum>
ffffffffc0204a2a:	b7f9                	j	ffffffffc02049f8 <printnum+0x38>

ffffffffc0204a2c <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a2c:	7119                	addi	sp,sp,-128
ffffffffc0204a2e:	f4a6                	sd	s1,104(sp)
ffffffffc0204a30:	f0ca                	sd	s2,96(sp)
ffffffffc0204a32:	e8d2                	sd	s4,80(sp)
ffffffffc0204a34:	e4d6                	sd	s5,72(sp)
ffffffffc0204a36:	e0da                	sd	s6,64(sp)
ffffffffc0204a38:	fc5e                	sd	s7,56(sp)
ffffffffc0204a3a:	f862                	sd	s8,48(sp)
ffffffffc0204a3c:	f06a                	sd	s10,32(sp)
ffffffffc0204a3e:	fc86                	sd	ra,120(sp)
ffffffffc0204a40:	f8a2                	sd	s0,112(sp)
ffffffffc0204a42:	ecce                	sd	s3,88(sp)
ffffffffc0204a44:	f466                	sd	s9,40(sp)
ffffffffc0204a46:	ec6e                	sd	s11,24(sp)
ffffffffc0204a48:	892a                	mv	s2,a0
ffffffffc0204a4a:	84ae                	mv	s1,a1
ffffffffc0204a4c:	8d32                	mv	s10,a2
ffffffffc0204a4e:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
...
ffffffffc0204a52:	00002a17          	auipc	s4,0x2
ffffffffc0204a56:	326a0a13          	addi	s4,s4,806 # ffffffffc0206d78 <default_pmm_manager+0x1190>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204a5a:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204a5e:	00002c17          	auipc	s8,0x2
ffffffffc0204a62:	472c0c13          	addi	s8,s8,1138 # ffffffffc0206ed0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a66:	000d4503          	lbu	a0,0(s10) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
ffffffffc0204a6a:	02500793          	li	a5,37
ffffffffc0204a6e:	001d0413          	addi	s0,s10,1
ffffffffc0204a72:	00f50e63          	beq	a0,a5,ffffffffc0204a8e <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0204a76:	c521                	beqz	a0,ffffffffc0204abe <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a78:	02500993          	li	s3,37
ffffffffc0204a7c:	a011                	j	ffffffffc0204a80 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0204a7e:	c121                	beqz	a0,ffffffffc0204abe <vprintfmt+0x92>
            putch(ch, putdat);
...
ffffffffc0204a84:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a86:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204a8a:	ff351ae3          	bne	a0,s3,ffffffffc0204a7e <vprintfmt+0x52>
ffffffffc0204a8e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204a92:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204a96:	4981                	li	s3,0
ffffffffc0204a98:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0204a9a:	5cfd                	li	s9,-1
ffffffffc0204a9c:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a9e:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0204aa2:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aa4:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0204aa8:	0ff6f693          	andi	a3,a3,255
ffffffffc0204aac:	00140d13          	addi	s10,s0,1
ffffffffc0204ab0:	20d5e563          	bltu	a1,a3,ffffffffc0204cba <vprintfmt+0x28e>
ffffffffc0204ab4:	068a                	slli	a3,a3,0x2
ffffffffc0204ab6:	96d2                	add	a3,a3,s4
ffffffffc0204ab8:	4294                	lw	a3,0(a3)
ffffffffc0204aba:	96d2                	add	a3,a3,s4
ffffffffc0204abc:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204abe:	70e6                	ld	ra,120(sp)
ffffffffc0204ac0:	7446                	ld	s0,112(sp)
ffffffffc0204ac2:	74a6                	ld	s1,104(sp)
ffffffffc0204ac4:	7906                	ld	s2,96(sp)
ffffffffc0204ac6:	69e6                	ld	s3,88(sp)
ffffffffc0204ac8:	6a46                	ld	s4,80(sp)
ffffffffc0204aca:	6aa6                	ld	s5,72(sp)
ffffffffc0204acc:	6b06                	ld	s6,64(sp)
ffffffffc0204ace:	7be2                	ld	s7,56(sp)
ffffffffc0204ad0:	7c42                	ld	s8,48(sp)
ffffffffc0204ad2:	7ca2                	ld	s9,40(sp)
ffffffffc0204ad4:	7d02                	ld	s10,32(sp)
ffffffffc0204ad6:	6de2                	ld	s11,24(sp)
ffffffffc0204ad8:	6109                	addi	sp,sp,128
ffffffffc0204ada:	8082                	ret
    if (lflag >= 2) {
ffffffffc0204adc:	4705                	li	a4,1
ffffffffc0204ade:	008a8593          	addi	a1,s5,8
ffffffffc0204ae2:	01074463          	blt	a4,a6,ffffffffc0204aea <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0204ae6:	26080363          	beqz	a6,ffffffffc0204d4c <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0204aea:	000ab603          	ld	a2,0(s5)
ffffffffc0204aee:	46c1                	li	a3,16
ffffffffc0204af0:	8aae                	mv	s5,a1
ffffffffc0204af2:	a06d                	j	ffffffffc0204b9c <vprintfmt+0x170>
            goto reswitch;
ffffffffc0204af4:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204af8:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204afa:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204afc:	b765                	j	ffffffffc0204aa4 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0204afe:	000aa503          	lw	a0,0(s5)
ffffffffc0204b02:	85a6                	mv	a1,s1
ffffffffc0204b04:	0aa1                	addi	s5,s5,8
ffffffffc0204b06:	9902                	jalr	s2
            break;
ffffffffc0204b08:	bfb9                	j	ffffffffc0204a66 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204b0a:	4705                	li	a4,1
ffffffffc0204b0c:	008a8993          	addi	s3,s5,8
ffffffffc0204b10:	01074463          	blt	a4,a6,ffffffffc0204b18 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0204b14:	22080463          	beqz	a6,ffffffffc0204d3c <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0204b18:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0204b1c:	24044463          	bltz	s0,ffffffffc0204d64 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0204b20:	8622                	mv	a2,s0
ffffffffc0204b22:	8ace                	mv	s5,s3
ffffffffc0204b24:	46a9                	li	a3,10
ffffffffc0204b26:	a89d                	j	ffffffffc0204b9c <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0204b28:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b2c:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204b2e:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0204b30:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204b34:	8fb5                	xor	a5,a5,a3
ffffffffc0204b36:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204b3a:	1ad74363          	blt	a4,a3,ffffffffc0204ce0 <vprintfmt+0x2b4>
ffffffffc0204b3e:	00369793          	slli	a5,a3,0x3
ffffffffc0204b42:	97e2                	add	a5,a5,s8
ffffffffc0204b44:	639c                	ld	a5,0(a5)
ffffffffc0204b46:	18078d63          	beqz	a5,ffffffffc0204ce0 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204b4a:	86be                	mv	a3,a5
ffffffffc0204b4c:	00000617          	auipc	a2,0x0
ffffffffc0204b50:	38c60613          	addi	a2,a2,908 # ffffffffc0204ed8 <etext+0x28>
ffffffffc0204b54:	85a6                	mv	a1,s1
ffffffffc0204b56:	854a                	mv	a0,s2
ffffffffc0204b58:	240000ef          	jal	ra,ffffffffc0204d98 <printfmt>
ffffffffc0204b5c:	b729                	j	ffffffffc0204a66 <vprintfmt+0x3a>
            lflag ++;
ffffffffc0204b5e:	00144603          	lbu	a2,1(s0)
ffffffffc0204b62:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b64:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204b66:	bf3d                	j	ffffffffc0204aa4 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0204b68:	4705                	li	a4,1
ffffffffc0204b6a:	008a8593          	addi	a1,s5,8
ffffffffc0204b6e:	01074463          	blt	a4,a6,ffffffffc0204b76 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0204b72:	1e080263          	beqz	a6,ffffffffc0204d56 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0204b76:	000ab603          	ld	a2,0(s5)
ffffffffc0204b7a:	46a1                	li	a3,8
ffffffffc0204b7c:	8aae                	mv	s5,a1
ffffffffc0204b7e:	a839                	j	ffffffffc0204b9c <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0204b80:	03000513          	li	a0,48
ffffffffc0204b84:	85a6                	mv	a1,s1
ffffffffc0204b86:	e03e                	sd	a5,0(sp)
ffffffffc0204b88:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204b8a:	85a6                	mv	a1,s1
ffffffffc0204b8c:	07800513          	li	a0,120
ffffffffc0204b90:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204b92:	0aa1                	addi	s5,s5,8
ffffffffc0204b94:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0204b98:	6782                	ld	a5,0(sp)
ffffffffc0204b9a:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204b9c:	876e                	mv	a4,s11
ffffffffc0204b9e:	85a6                	mv	a1,s1
ffffffffc0204ba0:	854a                	mv	a0,s2
ffffffffc0204ba2:	e1fff0ef          	jal	ra,ffffffffc02049c0 <printnum>
            break;
ffffffffc0204ba6:	b5c1                	j	ffffffffc0204a66 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204ba8:	000ab603          	ld	a2,0(s5)
ffffffffc0204bac:	0aa1                	addi	s5,s5,8
ffffffffc0204bae:	1c060663          	beqz	a2,ffffffffc0204d7a <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0204bb2:	00160413          	addi	s0,a2,1
ffffffffc0204bb6:	17b05c63          	blez	s11,ffffffffc0204d2e <vprintfmt+0x302>
ffffffffc0204bba:	02d00593          	li	a1,45
ffffffffc0204bbe:	14b79263          	bne	a5,a1,ffffffffc0204d02 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204bc2:	00064783          	lbu	a5,0(a2)
ffffffffc0204bc6:	0007851b          	sext.w	a0,a5
ffffffffc0204bca:	c905                	beqz	a0,ffffffffc0204bfa <vprintfmt+0x1ce>
ffffffffc0204bcc:	000cc563          	bltz	s9,ffffffffc0204bd6 <vprintfmt+0x1aa>
ffffffffc0204bd0:	3cfd                	addiw	s9,s9,-1
ffffffffc0204bd2:	036c8263          	beq	s9,s6,ffffffffc0204bf6 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0204bd6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204bd8:	18098463          	beqz	s3,ffffffffc0204d60 <vprintfmt+0x334>
ffffffffc0204bdc:	3781                	addiw	a5,a5,-32
ffffffffc0204bde:	18fbf163          	bleu	a5,s7,ffffffffc0204d60 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0204be2:	03f00513          	li	a0,63
ffffffffc0204be6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204be8:	0405                	addi	s0,s0,1
ffffffffc0204bea:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bee:	3dfd                	addiw	s11,s11,-1
ffffffffc0204bf0:	0007851b          	sext.w	a0,a5
ffffffffc0204bf4:	fd61                	bnez	a0,ffffffffc0204bcc <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0204bf6:	e7b058e3          	blez	s11,ffffffffc0204a66 <vprintfmt+0x3a>
ffffffffc0204bfa:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204bfc:	85a6                	mv	a1,s1
ffffffffc0204bfe:	02000513          	li	a0,32
ffffffffc0204c02:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c04:	e60d81e3          	beqz	s11,ffffffffc0204a66 <vprintfmt+0x3a>
ffffffffc0204c08:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204c0a:	85a6                	mv	a1,s1
ffffffffc0204c0c:	02000513          	li	a0,32
ffffffffc0204c10:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c12:	fe0d94e3          	bnez	s11,ffffffffc0204bfa <vprintfmt+0x1ce>
ffffffffc0204c16:	bd81                	j	ffffffffc0204a66 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c18:	4705                	li	a4,1
ffffffffc0204c1a:	008a8593          	addi	a1,s5,8
ffffffffc0204c1e:	01074463          	blt	a4,a6,ffffffffc0204c26 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0204c22:	12080063          	beqz	a6,ffffffffc0204d42 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0204c26:	000ab603          	ld	a2,0(s5)
ffffffffc0204c2a:	46a9                	li	a3,10
ffffffffc0204c2c:	8aae                	mv	s5,a1
ffffffffc0204c2e:	b7bd                	j	ffffffffc0204b9c <vprintfmt+0x170>
ffffffffc0204c30:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0204c34:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c38:	846a                	mv	s0,s10
ffffffffc0204c3a:	b5ad                	j	ffffffffc0204aa4 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0204c3c:	85a6                	mv	a1,s1
ffffffffc0204c3e:	02500513          	li	a0,37
ffffffffc0204c42:	9902                	jalr	s2
            break;
ffffffffc0204c44:	b50d                	j	ffffffffc0204a66 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0204c46:	000aac83          	lw	s9,0(s5)
...
ffffffffc0204c50:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0204c52:	e40dd9e3          	bgez	s11,ffffffffc0204aa4 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0204c56:	8de6                	mv	s11,s9
ffffffffc0204c58:	5cfd                	li	s9,-1
ffffffffc0204c5a:	b5a9                	j	ffffffffc0204aa4 <vprintfmt+0x78>
            goto reswitch;
ffffffffc0204c5c:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0204c60:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c64:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c66:	bd3d                	j	ffffffffc0204aa4 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0204c68:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0204c6c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c70:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204c72:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204c76:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c7a:	fcd56ce3          	bltu	a0,a3,ffffffffc0204c52 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c7e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c80:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0204c84:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204c88:	0196873b          	addw	a4,a3,s9
ffffffffc0204c8c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204c90:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0204c94:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204c98:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204c9c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204ca0:	fcd57fe3          	bleu	a3,a0,ffffffffc0204c7e <vprintfmt+0x252>
ffffffffc0204ca4:	b77d                	j	ffffffffc0204c52 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204ca6:	fffdc693          	not	a3,s11
ffffffffc0204caa:	96fd                	srai	a3,a3,0x3f
ffffffffc0204cac:	00ddfdb3          	and	s11,s11,a3
ffffffffc0204cb0:	00144603          	lbu	a2,1(s0)
ffffffffc0204cb4:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cb6:	846a                	mv	s0,s10
ffffffffc0204cb8:	b3f5                	j	ffffffffc0204aa4 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204cba:	85a6                	mv	a1,s1
ffffffffc0204cbc:	02500513          	li	a0,37
ffffffffc0204cc0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204cc2:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204cc6:	02500793          	li	a5,37
ffffffffc0204cca:	8d22                	mv	s10,s0
ffffffffc0204ccc:	d8f70de3          	beq	a4,a5,ffffffffc0204a66 <vprintfmt+0x3a>
ffffffffc0204cd0:	02500713          	li	a4,37
ffffffffc0204cd4:	1d7d                	addi	s10,s10,-1
ffffffffc0204cd6:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204cda:	fee79de3          	bne	a5,a4,ffffffffc0204cd4 <vprintfmt+0x2a8>
ffffffffc0204cde:	b361                	j	ffffffffc0204a66 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204ce0:	00002617          	auipc	a2,0x2
ffffffffc0204ce4:	2c860613          	addi	a2,a2,712 # ffffffffc0206fa8 <error_string+0xd8>
ffffffffc0204ce8:	85a6                	mv	a1,s1
ffffffffc0204cea:	854a                	mv	a0,s2
ffffffffc0204cec:	0ac000ef          	jal	ra,ffffffffc0204d98 <printfmt>
ffffffffc0204cf0:	bb9d                	j	ffffffffc0204a66 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204cf2:	00002617          	auipc	a2,0x2
ffffffffc0204cf6:	2ae60613          	addi	a2,a2,686 # ffffffffc0206fa0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204cfa:	00002417          	auipc	s0,0x2
ffffffffc0204cfe:	2a740413          	addi	s0,s0,679 # ffffffffc0206fa1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d02:	8532                	mv	a0,a2
ffffffffc0204d04:	85e6                	mv	a1,s9
ffffffffc0204d06:	e032                	sd	a2,0(sp)
ffffffffc0204d08:	e43e                	sd	a5,8(sp)
ffffffffc0204d0a:	0cc000ef          	jal	ra,ffffffffc0204dd6 <strnlen>
ffffffffc0204d0e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d12:	6602                	ld	a2,0(sp)
ffffffffc0204d14:	01b05d63          	blez	s11,ffffffffc0204d2e <vprintfmt+0x302>
ffffffffc0204d18:	67a2                	ld	a5,8(sp)
ffffffffc0204d1a:	2781                	sext.w	a5,a5
ffffffffc0204d1c:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204d1e:	6522                	ld	a0,8(sp)
ffffffffc0204d20:	85a6                	mv	a1,s1
ffffffffc0204d22:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d24:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d26:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d28:	6602                	ld	a2,0(sp)
ffffffffc0204d2a:	fe0d9ae3          	bnez	s11,ffffffffc0204d1e <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d2e:	00064783          	lbu	a5,0(a2)
ffffffffc0204d32:	0007851b          	sext.w	a0,a5
ffffffffc0204d36:	e8051be3          	bnez	a0,ffffffffc0204bcc <vprintfmt+0x1a0>
ffffffffc0204d3a:	b335                	j	ffffffffc0204a66 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc0204d3c:	000aa403          	lw	s0,0(s5)
ffffffffc0204d40:	bbf1                	j	ffffffffc0204b1c <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc0204d42:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d46:	46a9                	li	a3,10
ffffffffc0204d48:	8aae                	mv	s5,a1
ffffffffc0204d4a:	bd89                	j	ffffffffc0204b9c <vprintfmt+0x170>
ffffffffc0204d4c:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d50:	46c1                	li	a3,16
ffffffffc0204d52:	8aae                	mv	s5,a1
ffffffffc0204d54:	b5a1                	j	ffffffffc0204b9c <vprintfmt+0x170>
ffffffffc0204d56:	000ae603          	lwu	a2,0(s5)
ffffffffc0204d5a:	46a1                	li	a3,8
ffffffffc0204d5c:	8aae                	mv	s5,a1
ffffffffc0204d5e:	bd3d                	j	ffffffffc0204b9c <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc0204d60:	9902                	jalr	s2
ffffffffc0204d62:	b559                	j	ffffffffc0204be8 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc0204d64:	85a6                	mv	a1,s1
ffffffffc0204d66:	02d00513          	li	a0,45
ffffffffc0204d6a:	e03e                	sd	a5,0(sp)
ffffffffc0204d6c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d6e:	8ace                	mv	s5,s3
ffffffffc0204d70:	40800633          	neg	a2,s0
ffffffffc0204d74:	46a9                	li	a3,10
ffffffffc0204d76:	6782                	ld	a5,0(sp)
ffffffffc0204d78:	b515                	j	ffffffffc0204b9c <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc0204d7a:	01b05663          	blez	s11,ffffffffc0204d86 <vprintfmt+0x35a>
ffffffffc0204d7e:	02d00693          	li	a3,45
ffffffffc0204d82:	f6d798e3          	bne	a5,a3,ffffffffc0204cf2 <vprintfmt+0x2c6>
ffffffffc0204d86:	00002417          	auipc	s0,0x2
ffffffffc0204d8a:	21b40413          	addi	s0,s0,539 # ffffffffc0206fa1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d8e:	02800513          	li	a0,40
ffffffffc0204d92:	02800793          	li	a5,40
ffffffffc0204d96:	bd1d                	j	ffffffffc0204bcc <vprintfmt+0x1a0>

ffffffffc0204d98 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d98:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204d9a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d9e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204da0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204da2:	ec06                	sd	ra,24(sp)
ffffffffc0204da4:	f83a                	sd	a4,48(sp)
ffffffffc0204da6:	fc3e                	sd	a5,56(sp)
ffffffffc0204da8:	e0c2                	sd	a6,64(sp)
ffffffffc0204daa:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204dac:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dae:	c7fff0ef          	jal	ra,ffffffffc0204a2c <vprintfmt>
}
ffffffffc0204db2:	60e2                	ld	ra,24(sp)
ffffffffc0204db4:	6161                	addi	sp,sp,80
ffffffffc0204db6:	8082                	ret

ffffffffc0204db8 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204db8:	00054783          	lbu	a5,0(a0)
ffffffffc0204dbc:	cb91                	beqz	a5,ffffffffc0204dd0 <strlen+0x18>
    size_t cnt = 0;
ffffffffc0204dbe:	4781                	li	a5,0
        cnt ++;
ffffffffc0204dc0:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0204dc2:	00f50733          	add	a4,a0,a5
ffffffffc0204dc6:	00074703          	lbu	a4,0(a4)
ffffffffc0204dca:	fb7d                	bnez	a4,ffffffffc0204dc0 <strlen+0x8>
    }
    return cnt;
}
ffffffffc0204dcc:	853e                	mv	a0,a5
ffffffffc0204dce:	8082                	ret
    size_t cnt = 0;
ffffffffc0204dd0:	4781                	li	a5,0
}
ffffffffc0204dd2:	853e                	mv	a0,a5
ffffffffc0204dd4:	8082                	ret

ffffffffc0204dd6 <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dd6:	c185                	beqz	a1,ffffffffc0204df6 <strnlen+0x20>
ffffffffc0204dd8:	00054783          	lbu	a5,0(a0)
ffffffffc0204ddc:	cf89                	beqz	a5,ffffffffc0204df6 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204dde:	4781                	li	a5,0
ffffffffc0204de0:	a021                	j	ffffffffc0204de8 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204de2:	00074703          	lbu	a4,0(a4)
ffffffffc0204de6:	c711                	beqz	a4,ffffffffc0204df2 <strnlen+0x1c>
        cnt ++;
ffffffffc0204de8:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dea:	00f50733          	add	a4,a0,a5
ffffffffc0204dee:	fef59ae3          	bne	a1,a5,ffffffffc0204de2 <strnlen+0xc>
    }
    return cnt;
}
ffffffffc0204df2:	853e                	mv	a0,a5
ffffffffc0204df4:	8082                	ret
    size_t cnt = 0;
ffffffffc0204df6:	4781                	li	a5,0
}
ffffffffc0204df8:	853e                	mv	a0,a5
ffffffffc0204dfa:	8082                	ret

ffffffffc0204dfc <strcpy>:
char *
...
ffffffffc0204e0a:	fb75                	bnez	a4,ffffffffc0204dfe <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e12:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e16:	cb91                	beqz	a5,ffffffffc0204e2a <strcmp+0x1c>
ffffffffc0204e18:	00e79c63          	bne	a5,a4,ffffffffc0204e30 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0204e1c:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e1e:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc0204e22:	0585                	addi	a1,a1,1
ffffffffc0204e24:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e28:	fbe5                	bnez	a5,ffffffffc0204e18 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e2a:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e2c:	9d19                	subw	a0,a0,a4
ffffffffc0204e2e:	8082                	ret
ffffffffc0204e30:	0007851b          	sext.w	a0,a5
ffffffffc0204e34:	9d19                	subw	a0,a0,a4
ffffffffc0204e36:	8082                	ret

ffffffffc0204e38 <strchr>:
...
ffffffffc0204e3c:	cb91                	beqz	a5,ffffffffc0204e50 <strchr+0x18>
        if (*s == c) {
ffffffffc0204e3e:	00b79563          	bne	a5,a1,ffffffffc0204e48 <strchr+0x10>
ffffffffc0204e42:	a809                	j	ffffffffc0204e54 <strchr+0x1c>
ffffffffc0204e44:	00b78763          	beq	a5,a1,ffffffffc0204e52 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc0204e48:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e4a:	00054783          	lbu	a5,0(a0)
ffffffffc0204e4e:	fbfd                	bnez	a5,ffffffffc0204e44 <strchr+0xc>
    }
    return NULL;
ffffffffc0204e50:	4501                	li	a0,0
}
ffffffffc0204e52:	8082                	ret
ffffffffc0204e54:	8082                	ret

ffffffffc0204e56 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e56:	ca01                	beqz	a2,ffffffffc0204e66 <memset+0x10>
ffffffffc0204e58:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e5a:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e5c:	0785                	addi	a5,a5,1
ffffffffc0204e5e:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e62:	fec79de3          	bne	a5,a2,ffffffffc0204e5c <memset+0x6>
    }
    return s;
...
ffffffffc0204e68 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e68:	ca19                	beqz	a2,ffffffffc0204e7e <memcpy+0x16>
ffffffffc0204e6a:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e6c:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e6e:	0585                	addi	a1,a1,1
ffffffffc0204e70:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0204e74:	0785                	addi	a5,a5,1
ffffffffc0204e76:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e7a:	fec59ae3          	bne	a1,a2,ffffffffc0204e6e <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e80:	c21d                	beqz	a2,ffffffffc0204ea6 <memcmp+0x26>
        if (*s1 != *s2) {
ffffffffc0204e82:	00054783          	lbu	a5,0(a0)
ffffffffc0204e86:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e8a:	962a                	add	a2,a2,a0
ffffffffc0204e8c:	00f70963          	beq	a4,a5,ffffffffc0204e9e <memcmp+0x1e>
ffffffffc0204e90:	a829                	j	ffffffffc0204eaa <memcmp+0x2a>
ffffffffc0204e92:	00054783          	lbu	a5,0(a0)
ffffffffc0204e96:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e9a:	00e79863          	bne	a5,a4,ffffffffc0204eaa <memcmp+0x2a>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204e9e:	0505                	addi	a0,a0,1
ffffffffc0204ea0:	0585                	addi	a1,a1,1
    while (n -- > 0) {
ffffffffc0204ea2:	fea618e3          	bne	a2,a0,ffffffffc0204e92 <memcmp+0x12>
    }
    return 0;
...
ffffffffc0204ea8:	8082                	ret
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eaa:	40e7853b          	subw	a0,a5,a4
